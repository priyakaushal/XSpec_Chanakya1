...
&lt;/jurisinfo:courtinfo&gt;
       ...
       attribute, refer the general markup <xref
        ...
        <section>
            ...
            <p>2014-01-30: <ph id="change_20150130_AS">Updated "The province codes with PGUID codes for Country" table when case:juris with country code "UK". Db issue #407 </ph></p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA02-Case_Summaries\CA02DC_DIGESTDOC_to_casedigest\case.juris.dita  -->
...
<!-- Vikas Rohilla : Created the Template for the case:juris    -->
 <xsl:template match="case:courtinfo/case:juris">
        ...
        <xsl:element name="jurisinfo:jurisdiction">
            <xsl:apply-templates select="parent::case:courtinfo/case:courtloc"/>
