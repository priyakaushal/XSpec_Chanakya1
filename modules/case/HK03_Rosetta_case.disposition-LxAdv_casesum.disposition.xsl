...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="HK03_Rosetta_case.disposition-LxAdv_casesum.disposition">
  <title>case:disposition <lnpid>id-HK03-37215</lnpid></title>
  <body>
...
&lt;/casesum:disposition&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-HK\HK03\HK03_Rosetta_case.disposition-LxAdv_casesum.disposition.dita  -->
	<!--<xsl:message>HK03_Rosetta_case.disposition-LxAdv_casesum.disposition.xsl requires manual development!</xsl:message> -->
