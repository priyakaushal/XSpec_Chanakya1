...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" 
  ...
  xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita case">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="HK09_Rosetta_case.filenum-LxAdv_caseinfo.docketnum">
	  <title>case:filenum <lnpid>id-HK09-39438</lnpid></title>
  <body>
    <section>
