...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="case:factsummary">
        <section>
            <xsl:attribute name="sectiontype">factsummary</xsl:attribute>
            <bodytext>
    ...
    <xsl:template match="case:decisionsummary">
        <section>
            <xsl:attribute name="sectiontype">decisionsummary</xsl:attribute>
            <bodytext>
                <xsl:apply-templates select="node()"/>
            </bodytext>
        </section>
    ...
    <xsl:template match="case:references">
        <section>
            <xsl:attribute name="sectiontype">references</xsl:attribute>
            <bodytext>
                <xsl:apply-templates select="node()"/>
            </bodytext>
        </section>
