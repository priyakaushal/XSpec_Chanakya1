...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:glp="http://www.lexis-nexis.com/glp" version="2.0" exclude-result-prefixes="dita case glp">
    ...
    <title>case:body/case:content/case:appendix <lnpid>id-NZ18-26007</lnpid></title>
    <body>
        <section>
            <ul>
                <li class="- topic/li ">
...
&lt;/courtorder:body&gt;                
                        ...
                        <li class="- topic/li ">
              <sourcexml class="+ topic/keyword xml-d/sourcexml ">case:appendix/link</sourcexml>
              becomes <targetxml class="+ topic/keyword xml-d/targetxml ">appendix/bodytext/p/text/ref:lnlink[@service="ATTACHMENT"]</targetxml>
              <note class="- topic/note ">Please refer to General Markup section for handling of
                children.</note>
            </li>
                        <li class="- topic/li ">
...
&lt;/courtorder:body&gt;                
        ...
        <section>
          ...
          <p>2013-08-12: <ph id="change_20130812_JCG">Changed instruction for
            <sourcexml>case:appendix/link</sourcexml>, it now becomes
            <targetxml>appendix/bodytext/p/text/ref:lnlink</targetxml>.</ph></p>
        </section>
    </body>
	</dita:topic>

	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ18_courtorder\case.body_case.content_case.appendix.dita  -->

	<xsl:template match="case:appendix">
		<xsl:apply-templates select="sigblock"/>
		<xsl:if test="node() except sigblock">
			<appendix>
				<bodytext>
					<xsl:apply-templates select="@* | node() except sigblock"/>
				</bodytext>
			</appendix>
		</xsl:if>
	</xsl:template>
