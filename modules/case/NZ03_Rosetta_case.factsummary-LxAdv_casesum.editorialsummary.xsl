...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:glp="http://www.lexis-nexis.com/glp" xmlns:casesum="http://www.lexisnexis.com/xmlschemas/content/legal/case-summary/1/" version="2.0" exclude-result-prefixes="dita case glp">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="NZ03_Rosetta_case.factsummary-LxAdv_casesum.editorialsummary">
  <title>case:factsummary <lnpid>id-NZ03-23019</lnpid></title>
  <body>
    ...
    <section>
      ...
      <note>Conversion should not create consecutive <targetxml>casesum:summaries</targetxml>
        ...
        ordering.</note>
      <note> Andrew: Editorially added content. </note>
    </section>
    <example>
      <codeblock>
&lt;case:factsummary&gt;
...
&lt;/casesum:editorialsummary&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ03_CaseLaw\NZ03_Rosetta_case.factsummary-LxAdv_casesum.editorialsummary.dita  -->
	<!--<xsl:message>NZ03_Rosetta_case.factsummary-LxAdv_casesum.editorialsummary.xsl requires manual development!</xsl:message>--> 
