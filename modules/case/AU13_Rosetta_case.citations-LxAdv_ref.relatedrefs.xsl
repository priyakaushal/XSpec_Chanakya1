...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" 
  ...
  version="2.0" exclude-result-prefixes="dita case">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="AU13_Rosetta_case.citations-LxAdv_ref.relatedrefs">
  <title>case:citations <lnpid>id-AU13-20412</lnpid></title>
  <body>
    <section>
      <ul>
        <li>
...
&lt;/ref:relatedrefs&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU13_composite_cases\AU13_Rosetta_case.citations-LxAdv_ref.relatedrefs.dita  -->
