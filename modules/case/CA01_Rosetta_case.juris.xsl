...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:guid="urn:x-lexisnexis:content:guid:global:1" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:globalentity="urn:x-lexisnexis:content:identified-entities:global:1" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" xmlns:ext="http://exslt.org/common" version="2.0" exclude-result-prefixes="#all">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="CA01_Rosetta_case.juris">
  <title>case:juris <lnpid>id-CA01-12225</lnpid></title>
  <body>
    <section><sourcexml>case:juris</sourcexml> can hold a code representing a Province or Country.
        <sectiondiv> We will convert the following codes from old to new ISO: <ul id="ul_and_cnl_kq">
          <li>For Canada: if input document contains <sourcexml>CD</sourcexml> or
              <sourcexml>Canada</sourcexml> within <sourcexml>leg:juris</sourcexml>, then convert it
...
&lt;/jurisinfo:courtinfo&gt;
    ...
    <section>
      ...
      <p>2015-01-22: <ph id="change_20150122_PS">Updated element mapping and <b>"The province codes
            with PGUID codes for Country"</b> table when <sourcexml>case:juris</sourcexml> with
          country code "UK". Applicable on CA01.</ph></p>
      <p>2014-12-15: <ph id="change_20141215_PS">Updated mapping. <b>Db R4.5 issue #2047, Applicable on CA01.</b></ph></p>
      <p>2014-11-26: <ph id="change_20141126_PS">Added instruction and example when
            <sourcexml>case:juris</sourcexml> with country code "UK". Applicable on CA01.</ph></p>
    </section>
  </body>
	</dita:topic>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA01-Cases\CA01_Rosetta_case.juris.dita  -->
	<xsl:template match="case:courtinfo/case:juris[@ln.user-displayed='false']">
