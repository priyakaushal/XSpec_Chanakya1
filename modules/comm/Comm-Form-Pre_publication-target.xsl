...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:comm="http://www.lexis-nexis.com/glp/comm" version="2.0" exclude-result-prefixes="dita comm">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Comm-Form-Pre_publication-target">
...
&lt;/doc:metadata&gt;
   ...
   <note><sourcexml>comm:info</sourcexml> omit in NewLexis conversion.</note>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY03_Commentary-From-Prece\Comm-Form-Pre_publication-target.dita  -->
	<xsl:message>Comm-Form-Pre_publication-target.xsl requires manual development!</xsl:message> 
