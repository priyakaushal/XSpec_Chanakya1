...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:legis="http://www.lexisnexis.com/xmlschemas/content/legal/legislation/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:dates <lnpid>id-MX01-34010</lnpid></title>
  <body>
    <section>
...
&lt;legis:body&gt;
    &lt;primlaw:level xml:id="02041303.UNC.7" leveltype="unclassified"&gt;
        &lt;primlaw:levelinfo&gt;
...
&lt;/legis:body&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\MX01-Legislation\leg.dates.dita  -->
	<xsl:message>MX01-Legislation_leg.dates.xsl requires manual development!</xsl:message> 
