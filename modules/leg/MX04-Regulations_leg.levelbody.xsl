...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
   ...
   <title>leg:levelbody <lnpid>id-MX04-33616</lnpid></title>
   <body>
      <section>
        <ul>
          <li class="- topic/li ">
...
<b>Become</b>
&lt;primlaw:level xml:id="02041506.UNC.1" includeintoc="true"
...
&lt;/primlaw:bodytext&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\MX04-Regulations\leg.levelbody.dita  -->
	<xsl:message>MX04-Regulations_leg.levelbody.xsl requires manual development!</xsl:message> 
