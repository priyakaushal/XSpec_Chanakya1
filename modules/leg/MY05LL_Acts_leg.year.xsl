...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlawinfo="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw-info/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:year <lnpid>id-MY05LL-17029</lnpid></title>
  <body>
    <section>
...
&lt;leg:year ln.user-displayed="false" searchtype="LEGISLATION"&gt;1961&lt;/leg:year&gt;
 ...
 <section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY05LL_Acts\leg.year.dita  -->
<!--	<xsl:message>MY05LL_Acts_leg.year.xsl requires manual development!</xsl:message> -->

<!-- Already Handeled in the common module-->
