...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="leg.dates">
		<title>leg:dates <lnpid>id-CA06-13812</lnpid></title>
		<body>
			<section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA06-Regulation\leg.dates.dita  -->
	<!--	<xsl:message>CA06-Regulation_leg.dates.xsl requires manual development!</xsl:message> -->

	<xsl:template match="leg:dates">
		<primlawinfo:dates>
			<xsl:apply-templates select="@* | node() except leg:currencydate"/>
		</primlawinfo:dates>
	</xsl:template>
