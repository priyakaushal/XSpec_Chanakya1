...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" xmlns:location="http://www.lexisnexis.com/xmlschemas/content/shared/location/1/" version="2.0" exclude-result-prefixes="dita leg">
    ...
    <title>leg:juris <lnpid>id-ST02-26417</lnpid></title>
    <body>
...
&lt;/doc:metadata&gt;
        ...
        <example>
            <title>AUSTRALIA SOURCE XML 2: Mapping of <sourcexml>leg:juris</sourcexml> with state code</title>
            <codeblock>
...
&lt;/leg:info&gt;
            ...
            <b>Becomes</b>
            <title>AUSTRALIA TARGET XML 2: Mapping of <sourcexml>leg:juris</sourcexml> with state code</title>
            <codeblock>
...
&lt;/doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Courtrule\leg.juris.dita  -->
	<xsl:message>Courtrule_leg.juris.xsl requires manual development!</xsl:message> 
