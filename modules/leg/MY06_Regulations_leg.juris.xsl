...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:location="http://www.lexisnexis.com/xmlschemas/content/shared/location/1/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:juris <lnpid>id-MY06-17216</lnpid></title>
  <body>
      <p>       
         <ul>
                <li>When <sourcexml>leg:juris</sourcexml> has Country code: <note>If the value of
                        ...
                        with attributes <targetxml>@codescheme="ISO-3166-1"</targetxml> and
                            <targetxml>@countrycode="MY"</targetxml>. </note>
                    <pre>
...
&lt;/dc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY06_Regulations\leg.juris.dita  -->
<!--	<xsl:message>MY06_Regulations_leg.juris.xsl requires manual development!</xsl:message> -->
