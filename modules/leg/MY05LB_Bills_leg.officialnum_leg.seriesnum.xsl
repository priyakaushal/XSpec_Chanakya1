...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlawinfo="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw-info/1/" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:officialnum/leg:seriesnum <lnpid>id-MY05LB-16819</lnpid></title>
  <body>
    <section>
...
&lt;leg:officialnum ln.user-displayed="false" searchtype="LEGISLATION"&gt;USM_B000147e
    &lt;leg:seriesnum ln.user-displayed="false" searchtype="LEGISLATION"&gt;B000147&lt;/leg:seriesnum&gt;
    ...
&lt;/leg:officialnum&gt;
...
&lt;primlaw:levelinfo&gt;
   &lt;primlawinfo:primlawinfo&gt;
      &lt;primlawinfo:identifier idtype="officialnum" source="editoriallyassigned"&gt;USM_A000001y1961e
          &lt;primlawinfo:identifier-component type="seriesnum"&gt;B000147&lt;/primlawinfo:identifier-component&gt;
...
&lt;/primlaw:levelinfo&gt;
 ...
 <section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY05LB_Bills\leg.officialnum_leg.seriesnum.dita  -->
<!--	<xsl:message>MY05LB_Bills_leg.officialnum_leg.seriesnum.xsl requires manual development!</xsl:message> -->
