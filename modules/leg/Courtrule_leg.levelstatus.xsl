...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:legisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/legislation-info/1/" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
 ...
 <title>leg:levelstatus <lnpid>id-ST02-26421</lnpid></title>
 <body>
  <section>
   <p>The conversion for <sourcexml>leg:levelstatus</sourcexml> is based on the following scenarios:
    <ul>
     <li>If <sourcexml>leg:level/leg:level-vrnt/leg:levelinfo/leg:levelstatus[@isrepealed="true"]</sourcexml> contains PCDATA it becomes <targetxml>primlaw:level/primlaw:levelinfo/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:statusgroup/legisinfo:status[@statuscode="repealed"]/legisinfo:statustext</targetxml>
...
&lt;leg:level id="ACLL.SCRN.SCCR70.PT77"&gt;
 &lt;leg:level-vrnt toccaption="Part 77 Procedure under various statutes" subdoc="true" searchtype="LEGISLATION PART" leveltype="part"&gt;
   &lt;leg:levelinfo&gt;
...
&lt;primlaw:level xml:id="ACLL.SCRN.SCCR70.PT77" alternatetoccaption="Part 77 Procedure under various statutes" leveltype="part"&gt;
 &lt;primlaw:levelinfo&gt;
...
&lt;/primlaw:level&gt;
  ...
  <example>
   <title>Source XML 2: Mapping for <sourcexml>leg:levelstatus</sourcexml> without text</title>
   <codeblock>
...
&lt;/primlaw:level&gt;
  ...
  <section>
   <p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Courtrule\leg.levelstatus.dita  -->
	<xsl:message>Courtrule_leg.levelstatus.xsl requires manual development!</xsl:message> 
