...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:globalentity="urn:x-lexisnexis:content:identified-entities:global:1" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" xmlns:primlawinfo="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw-info/1/" xmlns:guid="urn:x-lexisnexis:content:guid:global:1" version="2.0" exclude-result-prefixes="dita leg">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="leg.juris">
  <title>leg:juris <lnpid>id-CA08-14218</lnpid></title>
  <body>
    <section>
...
&lt;/jurisinfo:legisbodyinfo&gt;
      ...
      <example>
            <title>If <sourcexml>leg:juris</sourcexml> contains country name instead of country
                'code' :</title>
            <codeblock>

&lt;leg:info&gt;
    &lt;leg:juris ln.user-displayed="false"&gt;&lt;alias kw="CD"&gt;Canada&lt;/alias&gt;&lt;/leg:juris&gt;
&lt;/leg:info&gt;
...
&lt;/jurisinfo:legisbodyinfo&gt;
    ...
    <ul>
      <li>If <sourcexml>leg:juris</sourcexml> has child <sourcexml>alias</sourcexml> then drop <sourcexml>alias</sourcexml> markup and its attribute but retain its content.      
      </li>
    </ul>
    <example>
            <codeblock>
...
&lt;leg:info&gt;
    &lt;leg:juris ln.user-displayed="false"&gt;&lt;alias kw="AB"&gt;AB&lt;/alias&gt;&lt;/leg:juris&gt;
&lt;/leg:info&gt;
...
&lt;jurisinfo:legisbodyinfo&gt;
  &lt;jurisinfo:jurisdiction&gt;
       &lt;jurisinfo:system normshortname="AB"&gt;
                &lt;globalentity:entity&gt;
                    &lt;globalentity:entityReference role="urn:contentType:geography" guid:guid="urn:entity:geob-101865413"/&gt;
...
&lt;/jurisinfo:legisbodyinfo&gt;
      ...
      <ul>
          <li>If <sourcexml>leg:juris</sourcexml> has child <sourcexml>alias</sourcexml> and it's
                attribute contained [@kw="CA"] with text "Canada"  then drop
                    <sourcexml>alias</sourcexml> markup and its attribute but retain its country
                code. [i.e. "CA"]. </li>
      </ul>
      <example>
            <codeblock>
...
&lt;/jurisinfo:legisbodyinfo&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA08-Constitutions\leg.juris.dita  -->
