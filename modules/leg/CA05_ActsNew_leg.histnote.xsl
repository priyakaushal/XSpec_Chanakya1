...
<xsl:stylesheet xmlns="http://www.lexisnexis.com/xmlschemas/content/shared/base/1/"
  ...
  xmlns:leg="http://www.lexis-nexis.com/glp/leg" version="2.0" exclude-result-prefixes="#all">
...
&lt;/note&gt;
  ...
  <xsl:template match="leg:histnote" priority="2">
  ...
  <xsl:template match="leg:history/leg:histnote[descendant::text[starts-with(.,'REPEALED by') or starts-with(.,'ABROGÉ par') or starts-with(.,'ABROGÉE par')]][($dpsi != $vDpsiCodes//*:code/@key) or ($doc_id != $vDpsiCodes//*:code/@key)]" mode="repealed">
