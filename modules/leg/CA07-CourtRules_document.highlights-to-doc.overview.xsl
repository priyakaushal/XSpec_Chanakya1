...
<xsl:stylesheet xmlns="http://www.lexisnexis.com/xmlschemas/content/shared/base/1/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita leg">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="CA07_document.highlights">
    <title>Document Highlights become doc:overview <lnpid>id-CA07-14033</lnpid></title>
  <body>
    <section>
...
&lt;/doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA07-CourtRules\document.highlights-to-doc.overview.dita  -->
				...
				<p>
					<text>
						...
						<xsl:choose>
							...
							<xsl:when test="leg:info/leg:longtitle">
								<xsl:value-of select="descendant::leg:longtitle"/>
							</xsl:when>
							<xsl:otherwise>
