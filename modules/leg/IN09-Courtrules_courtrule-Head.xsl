...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:courtrule="http://www.lexisnexis.com/xmlschemas/content/legal/courtrule/1/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <body>
      ...
      <p>       
        <ul>
          <li>When <sourcexml>leg:juris</sourcexml> has Country code: <note>If value for
                <sourcexml>leg:juris</sourcexml> is "IN" then <sourcexml>leg:juris</sourcexml> will
              become
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN09-Courtrules\courtrule-Head.dita  -->
	<xsl:message>IN09-Courtrules_courtrule-Head.xsl requires manual development!</xsl:message> 
