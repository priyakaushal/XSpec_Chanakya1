...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:legis="http://www.lexisnexis.com/xmlschemas/content/legal/legislation/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>Body <lnpid>id-IN01-15407</lnpid></title>
  <body>
    <section>
...
<p><sourcexml>leg:body</sourcexml> becomes <targetxml>legis:body</targetxml> and child elements as described below:</p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\IN01_Legislation\Body.dita  -->
	<xsl:message>IN01_Legislation_Body.xsl requires manual development!</xsl:message> 
