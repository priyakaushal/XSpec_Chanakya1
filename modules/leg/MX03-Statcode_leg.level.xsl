...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:level <lnpid>id-MX03-34215</lnpid></title>
  <body>
    <section>
      ...
      <p>As per LBU recommend the rules are listed below for some unique
        [<targetxml>@leveltype</targetxml>] values in NewLexis conversion: <ul>
          <li>If input <sourcexml>[@leveltype="chapter"]</sourcexml> becomes
              <targetxml>primlaw:level[@leveltype="chapter"]</targetxml>
          </li>
          <li>If input <sourcexml>[@leveltype="part"]</sourcexml> becomes
              <targetxml>primlaw:level[@leveltype="part"]</targetxml>
          </li>
          <li>If input <sourcexml>[@leveltype="act"]</sourcexml> becomes
              <targetxml>primlaw:level[@leveltype="act"]</targetxml>
          </li>
          <li>If input <sourcexml>[@leveltype="section"]</sourcexml> becomes
              <targetxml>primlaw:level[@leveltype="section"]</targetxml>
          </li>
          <li>If input <sourcexml>[@leveltype="unclssified"]</sourcexml> becomes
              <targetxml>primlaw:level[@leveltype="unclssified"]</targetxml>
          </li>
        </ul></p>
...
&lt;leg:level id="leahcrpo.CHAP.1"&gt;
         &lt;leg:level-vrnt leveltype="chapter" subdoc="true" toc-caption="CAPITULO UNICO"&gt;
               &lt;leg:heading&gt;
                   &lt;title&gt;CAPITULO UNICO&lt;/title&gt;
               &lt;/leg:heading&gt;
                &lt;leg:levelbody&gt;
                    &lt;leg:bodytext&gt;
                      &lt;p&gt;
                        &lt;text&gt;Artículo 1o.- La presente Ley es de orden público, de interés social y observancia general en todo el
...
&lt;primlaw:level xml:id="leahcrpo.CHAP.1" leveltype="chapter" includeintoc="true" alternatetoccaption="CAPITULO UNICO"&gt;
    &lt;heading&gt;
      &lt;title&gt;CAPITULO UNICO&lt;/title&gt;
    &lt;/heading&gt;
    &lt;primlaw:body&gt;
...
&lt;/primlaw:level&gt;
 ...
 <section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\MX03-Statcode\leg.level.dita  -->
	<xsl:message>MX03-Statcode_leg.level.xsl requires manual development!</xsl:message> 
	...
	<xsl:template match="[@leveltype=&#34;chapter&#34;]">
	...
	<xsl:template match="[@leveltype=&#34;part&#34;]">
	...
	<xsl:template match="[@leveltype=&#34;act&#34;]">
	...
	<xsl:template match="[@leveltype=&#34;section&#34;]">
	...
	<xsl:template match="[@leveltype=&#34;unclssified&#34;]">

		<!--  Original Target XPath:  primlaw:level[@leveltype="unclssified"]   -->
		<primlaw:level>
			<xsl:apply-templates select="@* | node()"/>
		</primlaw:level>
