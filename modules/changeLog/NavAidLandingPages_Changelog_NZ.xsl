...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" 
  ...
  <body>
    ...
    <section>
      <title>navaid 2.2_BETA</title>
      <p>2013-08-09 - JCG:
        <ul>
          <li>
            <xref href="../../common_newest/Rosetta_remotelink-self-inter-document-link-LxAdv-intra-document-link.dita">2013-08-07 - remotelink (self inter-document link) to ref:crossreference (intra-document link): Added this common instruction to the CI.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2013-06-28 - JCG:
        <ol>
          <li>2013-06-28 - changes to all target XML examples that have
            the XPath <targetxml>index:locator/ref:lnlink</targetxml>. The change shows that the <targetxml>ref:lnlink</targetxml> element must be created with the attribute <targetxml>ref:lnlink/@service="DOCUMENT"</targetxml>. This attribute was missing from the previous version of the instructions and examples.
          </li>
          <li>
            <xref href="../../DITA-PAC/NZ14_navaid/navaid-combined-details_NZ.dita">2013-06-27 - Convert Combined remotelink Elements To navaid:list: changed instructions to specify that attribute <targetxml>ref:lnlink/@service="DOCUMENT"</targetxml> should be created in target XML</xref>
          </li>
          <li>
            <xref href="../../DITA-PAC/AU16_navaid/navaid-separate-details.dita">2013-06-27 - Convert One p Or entry To navaid:list/index:entry: changed instructions to specify that attribute <targetxml>ref:lnlink/@service="DOCUMENT"</targetxml> should be created in target XML</xref>
          </li>
          <li>
            <xref href="../../DITA-PAC/AU16_navaid/navaid-index.dita">2013-06-27 - in:lev1 Elements and Their Subelements: changed instructions to specify that attribute <targetxml>ref:lnlink/@service="DOCUMENT"</targetxml> should be created in target XML</xref>
          </li>
          <li>
            <xref href="../../DITA-PAC/AU16_navaid/navaid-separate-l.dita">2013-06-27 - Convert l to index:index: changed instructions to specify that attribute <targetxml>ref:lnlink/@service="DOCUMENT"</targetxml> should be created in target XML</xref>
          </li>
        </ol>
      </p>
    </section>
    <section>
      ...
      <p>2013-06-25 - JCG:
        <ol>
          <li>2013-06-25 - correction to some New Lexis target XML examples that contained the attribute "anchorrefid" on the <targetxml>ref:locator</targetxml> element; this has been corrected to "anchoridref". Note that all instructions were correct, only some examples had the incorrect attribute name.             
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_leg.comntry-LxAdv-annot.annotations-annot.annotation-grp.dita">2013-05-15 - leg:comntry to annot:annotations/annot:annotation-grp: Fixed typo: (extra semicolon in xpath
              expression)</xref>
          </li>
        </ol>
      </p>
    ...
    <section>
      ...
      <p>2013-05-10 - JCG:
        <ol>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita">2013-05-01 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink: Updated instructions and target example per latest Apollo markup.</xref>
          </li>
          <li>
    ...
    <section>
      <title>navaid 1.10_ALPHA</title>
      <p>2013-03-14 - JCG: <ol>
        <li>Extensive changes throughout the entire <xref href="../AU16_navaid/navaid-body.dita">Body</xref>
            topic, affecting almost all sections and examples. Although a great deal of the Body
            section has been affected, the change itself is very straightforward. The
              <targetxml>index:locator</targetxml> creation instructions have changed such that now
            a direct child <targetxml>ref:lnlink</targetxml> element is created within
              <targetxml>index:locator</targetxml> and the <targetxml>ref:marker</targetxml> and
              <targetxml>ref:locator</targetxml> elements are created within the
              <targetxml>ref:lnlink</targetxml> element.</li>
            <li>
        ...
        if it is in <targetxml>ref:lnlink@service=”URL”</targetxml>and the <targetxml>ref:key-value@value</targetxml> starts-with (., 'http://www.lexisnexis.com/au/legal/api') 
            ...
            <li>
               <xref href="../../common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita">2013-02-26 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink: Updated target example per project requirement.</xref>
            </li>
            <li>
            ...
            <li>
               <xref href="../../common_newest/Rosetta_figure-LxAdv-figure.dita">2013-02-18 - figure to figure: Created two sections, one for "Release 4.0 and after" and another for "Pre-Release 4.0".</xref>
            </li>
            <li>
            ...
            <li>
               <xref href="../../common_newest/Rosetta_case.decisiondate_ln.user-displayed-LxAdv-decision.dates.dita">2013-01-09 - case:decisiondate/@ln.user-displayed="false" to decision:dates: Instructions have been added with directions for
          populating the attribute <targetxml>decision:decisiondate/@normdate</targetxml>.</xref>
            </li>
            <li>
            ...
            <li>
               <xref href="../../common_newest/Rosetta_docinfo.custom-metafields-LxAdv-SUPPRESS.dita">2013-01-07 - docinfo:custom-metafields is SUPPRESSED: Updated the instruction of handling
    ...
    <section>
      <title>navaid 1.10_ALPHA</title>
      <p>2013-02-20 - JCG: <ol>
          <li>Changed subtopic 3.9 titled "Convert <sourcexml>l</sourcexml> to
              <targetxml>index:index</targetxml>": corrected instruction to include creation of
              <targetxml>index:item</targetxml>, and also corrected target XML example to show the
              <targetxml>index:item</targetxml> element.</li>
        </ol>
      </p>
    </section>
    ...
    <section>
      <title>navaid 1.10_ALPHA</title>
      <p>2013-02-12 - JCG:<ol>
      <li>Removed the substantive content of subtopic 3.7.1 titled "Convert <sourcexml>l</sourcexml>
        to <targetxml>navaid:list</targetxml>". This subtopic now contains only a stub paragraph to
        preserve numbering. </li>
      <li>Created a new subtopic 3.9 titled "Convert <sourcexml>l</sourcexml> to
          <targetxml>index:index</targetxml>". This subtopic provides new instructions for
        converting <sourcexml>l</sourcexml> elements. </li>
      <li>Changed subtopic 3.8 titled "<sourcexml>in:lev1</sourcexml> Elements and Their
        Subelements": added a note to handle the special scenario of an index where
          <b><u>all</u></b> of the <sourcexml>in:lev</sourcexml> elements contain
        ...
        In this case the <sourcexml>in:lev1</sourcexml> elements are dropped and
          ...
          <sourcexml>in:lev1</sourcexml> elements. Also added source and target examples for this
        scenario.</li>
      <li>Changed subtopic 3.8 titled "<sourcexml>in:lev1</sourcexml> Elements and Their
        Subelements": added "_HISTORICALVERSIONS_" to the list of indexes where the
          <targetxml>index:index/@indextype</targetxml> should be "descriptive". </li>
      </ol>
      </p>
    </section>
    ...
    <section>
      <title>navaid 1.10_ALPHA</title>
      <p>2013-01-22 - JCG:<ol>
      <li>Minor change to subtopic 3.6.2 titled "Convert p to navaid:list" to include the attribute
          <sourcexml>p/text/@align="center"</sourcexml> as one of the criteria for determining that
        a <sourcexml>p</sourcexml> with less than 3 <sourcexml>remotelink</sourcexml> elements
        should still be converted to a
          <targetxml>navaid:landingpagebody/navaid:list/[@style="banner"]</targetxml>. </li>
      </ol>
        </p>
    </section>
    ...
    <section>
      ...
      <p>For changes prior to 2013, please see the <xref href="NavAidLandingPages_Changes2012_NZ.dita">previous topic</xref>.</p>      
    </section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ14_navaid\NavAidLandingPages_Changelog_NZ.dita  -->
