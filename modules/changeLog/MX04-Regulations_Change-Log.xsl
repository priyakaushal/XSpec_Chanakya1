...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <body>
    <section>
      <title>Regulation 8.0_PROD</title>
      <p>2014-10-16
        <ul>
          <li>First release.</li>
        </ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\MX04-Regulations\Change-Log.dita  -->
	<xsl:message>MX04-Regulations_Change-Log.xsl requires manual development!</xsl:message> 
