  ...
  <body>
    <section>
      ...
      <ul>
        ...
        <li>
          <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita">2016-08-03 - Do not convert the content associated with &lt;h&gt;URL API&lt;/h&gt; id-CCCC-10209: Added Note about xml snippets that illustrate
        ...
        <li>
          <xref href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-bodytext_blockquote-LxAdv-bodytext_blockquote_p_figure_ref.inlineobject.dita">2016-08-03 - bodytext/blockquote/inlineobject to bodytext/blockquote/p/figure/ref:inlineobject id-CCCC-10355: Added Note about xml snippets that illustrate image
    ...
    <section>
      ...
      <p>2015-??-?? - JCG:
        <ol>
          <li>2015-02-25 - leg:levelstatus @ln.user-displayed="false" @isrepealed="true" id-CCCC-10382: removed this topic because its conversion instructions do not apply to this content stream. The removal of this topic should have absolutely no impact on existing conversion programs since actual delivered content never contained leg:levelstatus elements and thus the mapping described by this topic has never applied to this content stream.</li>
        </ol>
      </p>
    </section>
    ...
    <section>
      ...
      <p>2014-11-10 - MLV:
      <ol>
        <li> <xref href="../../../Rosetta/common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita">2014-11-04 - docinfo:overview to doc:overview id-CCCC-10303: Clarification only: added text to explicitly indicate that the child <targetxml>doc:overview/bodytext</targetxml> should be created. Not a change to instructions.</xref></li>
        <li>
          <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_Body.dita">2014-10-27 - body id-CCCC-10152: Added mapping for <sourcexml>level[@leveltype="practicearea"]</sourcexml> to <targetxml>seclaw:level[@leveltype="practicearea"]</targetxml>.</xref>
        </li>
      </ol>
      ...
      <p>2014-10-29 - MLV:
        <ol>
                <li>
                  <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-home-1">2014-10-29 - Added new instruction when <sourcexml>bodytext[@searchtype="Other Resources"]/p</sourcexml>
                    ...
                    and each <sourcexml>p</sourcexml> element becomes a <targetxml>seclaw:digest</targetxml>.</xref>
                </li>
                <li>
      ...
      <p>2014-09-25 - JCG:
        <ol>
          <li>
            <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_Guidance.dita#guidance_bodytext/guidance-gpl.note">2014-09-25 - bodytext id-CCCC-10183: Changed instructions and examples
              regarding the mapping of <sourcexml>glp:note[notetype="xref"]</sourcexml> such that a
              new <targetxml>text</targetxml> element is not created, instead the
              ...
              <sourcexml>text</sourcexml> source element. (R4.5 Content Issue List, #1781)</xref>
          </li>
          <li>
            <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_Guidance.dita#guidance_bodytext/guidance-gpl.note-chof-p">2014-09-24 - bodytext id-CCCC-10183: Added instructions and example relating to the XPath <sourcexml>p/glp:note[notetype="xref"]</sourcexml>. (R4.5 Content Issue List, #1781)</xref>
          </li>
          <li>
            <xref href="../../../Rosetta/common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita">2014-09-16 - docinfo:assoc-links to doc:related-content id-CCCC-10284: Added a note
              to create <targetxml>proc:param/@name="attachment-smi"</targetxml> and
                <targetxml>proc:param/@value</targetxml> as these were there in the snippet but were
              missing in the instruction; also added a note to simplify in output
                <targetxml>ref:key-value/@value</targetxml>.</xref></li>
          <li>
          ...
          <li>
            <xref href="../../../Rosetta/common_newest/Rosetta_table-LxAdv-table.dita">2014-07-08 -
              table to table id-CCCC-10475: Updated instruction, adding the following rarely
    ...
    <section>
      <title>seclaw 7.12 PROD</title>
      <p>2014-06-18 - JCG: 
        <ol>
          <li>2014-06-18 - Not a rule change, only a clarification. The references to the conversion of <sourcexml>lnlink</sourcexml> to <targetxml>ref:alternaterendition</targetxml> are <b>only</b> with respect to
            <sourcexml>lnlink/@service="ATTACHMENT"</sourcexml>. Some additional text was added to make this completely clear,
            since future Landing Page documents may contain other kinds of <sourcexml>lnlink</sourcexml> elements such as
            <sourcexml>lnlink/@service="QUERYLINK"</sourcexml> and these should be either suppressed or converted to <targetxml>ref:lnlink</targetxml>, as specified in the section "General Markup". The following subtopics of the instructions for <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita"/> where modified:<ul>
              <li><xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-altrendition"/></li>
              <li><xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-home-3"/></li>
              <li><xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-guidance-2"/></li>
              <li><xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-guidance-3"/></li>
              <li><xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-other-4"/></li>
            </ul>
          </li>
          <li>
            <xref href="../../../Rosetta/common_newest/LPA-PracticalGuidance_Guidance.dita#guidance_level/leveltype_when_not_an_excerpt">2014-06-18 - level id-CCCC-10180: Corrected an ambiguity in the instructions regarding <sourcexml>level/@leveltype</sourcexml> values and their conversion to corresponding <targetxml>seclaw:level/@leveltype</targetxml> values when <sourcexml>docinfo:selector</sourcexml> is not "Excerpts".</xref>
          </li>
          <li>
            <xref href="../../../Rosetta/common_newest/Rosetta_lnlink_service_QUERYLINK-LxAdv-ref.lnlink.dita">2014-06-15 - lnlink[@service="QUERYLINK"] to ref:lnlink: Created.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2014-03-04 - JCG: <ol>
        <li>
          <xref href="../../common_newest/Rosetta_NZ-consecutive-note-LxAdv-notes.dita">2014-03-04 - Consecutive note elements to notes: Added this instruction. (Webteam #252304)</xref>
        </li>        
          <li>
          ...
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_Body.dita">2014-02-05 - Body:
              Added mapping instructions for source content with levels <sourcexml>@leveltype =
                comm13, comm21, comm30 and comm45</sourcexml>. The mapping adds
                <targetxml>seclaw:leveinfo/meta/metaitem @name="rosettastyle" @value="comm13, ,
                comm21, comm30, comm45"</targetxml>.</xref>
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_Guidance.dita#guidance_bodytext/guidance-gpl.note-chof-l">2013-12-15 -
              bodytext: Added instructions relating to the XPath
                <sourcexml>l/glp:note[notetype="xref"]</sourcexml>. (Webteam #247755)</xref>
          </li>
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_rosetta_docinfo.lbu-meta.dita">2013-12-15 - docinfo:lbu-meta Topic mapping: Minor correction to the instructions
              regarding a value for attribute
                <targetxml>classify:classification-grp/@classscheme</targetxml>. The previously
              specified value of "ln.indexing.terms" was incorrect, the correct value is
              "ln.indexing-terms". Note that the example provided has always shown the correct
              value, only the instruction was incorrect.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2014-01-16 - MLV: <ol>
          <li>
            <xref href="../../common_newest/Rosetta_l-LxAdv-list.dita">Updated instruction for
              nested lists in source.</xref>
          </li>
        </ol>
      </p>
    </section>
    <section>
      <title>seclaw 7.5 PROD</title>
      <p>2013-10-18 - JCG: <ol>
          <li>
          ...
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_LandingPage.dita#pg-landing-do-not-convert-url-api">2013-10-15 - Do not convert the content associated with &lt;h&gt;URL API&lt;/h&gt;:
              Created this new topic. (Webteam #237967)</xref>
          </li>
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_Guidance.dita#guidance_bodytext/guidance-multiple-consecutive-bodytext_gpl.note">2013-10-15 - bodytext: Modified instructions relating to the scenario where there are
              multiple consecutive <sourcexml>bodytext/glp:note[notetype="xref"]</sourcexml>
              elements indicating that they will now be merged into a single
                <targetxml>marginnote</targetxml> target element. (Webteam #214480)</xref>
          </li>
          <li>
    ...
    <section>
      <title>seclaw 7.5 PROD</title>
      <p>2013-09-26 - MLV: <ul>
          <li><xref href="LPA-PracticalGuidance_edpnum-refpt-LxAdv-AU.dita">2013-09-26 - Added
              special case handling for <sourcexml>edpnum/refpt/text()</sourcexml>.</xref></li>
          <li>
    ...
    <section>
      ...
      <p>2013-09-16 - MLV: <ul>
          <li>
            <xref href="../../common_newest/LPA-PracticalGuidance_Guidance.dita">2013-09-16 - added
              instruction for handling of consecutive glp:note type=xref conversion into marginnotes
              in the same text element.</xref>
          </li>
          <li>
      ...
      <p>2013-08-09 - JCG: <ul>
          <li>
            <xref href="../../common_newest/Rosetta_remotelink-self-inter-document-link-LxAdv-intra-document-link.dita">2013-08-07 - remotelink (self inter-document link) to ref:crossreference
              (intra-document link): Added this common instruction to the CI.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2013-05-30 - JCG: <ol>
          <li>2013-05-29 - Added the following 3 new topics to the <i>Introduction</i> section: <ul>
              <li><xref href="../../common_newest/Rosetta_Elements-LxAdv-Empty_Elements.dita"/>.</li>
              <li><xref href="../../common_newest/Rosetta_identifier-LxAdv-ID_data_type-HandlingPatternRestrictions.dita"/>.</li>
              <li><xref href="../../common_newest/Rosetta_identifier-LxAdv-ID_data_type-HandlingDuplicates.dita"/>.</li>
            </ul></li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_inlineobject-Chof-bodytext_blockquote-LxAdv-bodytext_blockquote_p_figure_ref.inlineobject.dita">2013-05-21 - bodytext/blockquote/inlineobject to
              bodytext/blockquote/p/figure/ref:inlineobject: Created new module for handling of
                <sourcexml>bodytext/blockquote/inlineobject</sourcexml>.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2013-05-10 - JCG: <ol>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_inlineobject-Chof-glp.note-LxAdv-SUPPRESS.dita">2013-05-08 - glp:note/inlineobject to: Extended the list of allowable values for
              image handling.</xref>
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_inlineobject-Chof-glp.note-LxAdv-SUPPRESS.dita">2013-05-01 - glp:note/inlineobject to: Removed instructions for section "Pre-Release
              4.0" because according to latest Apollo markup, section "Release 4.0 and after" and
              section "Pre-Release 4.0" now have similar conversion markup.</xref>
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_inlineobject-Chof-glp.note-LxAdv-SUPPRESS.dita">2013-04-30 - glp:note/inlineobject to: Updated target sample according to latest
              Apollo markup.</xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2013-04-12 - JCG: <ol>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita">2013-03-26 - link to ref:lnlink/@service="ATTACHMENT": Updated instruction and target
          ...
          <li>
            <xref href="../../common_newest/Rosetta_pgrp-LxAdv-pgrp.dita">2013-03-14 - pgrp to pgrp: Add instruction and example
                <sourcexml>pgrp/@id</sourcexml>.</xref>
          </li>
          <li>
            <xref href="../../common_newest/Rosetta_p-LxAdv-p.dita">2013-03-14 -
              p to p: Add instruction and example <sourcexml>p/@style</sourcexml>.</xref>
          </li>
          <li>
            <xref href="../../common_newest/Rosetta_nl-LxAdv-proc.nl.dita">2013-03-14 - nl to proc:nl: Add instruction and example
    ...
    <section>
      ...
      <p>2013-03-12 - JCG: <ol>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_date-LxAdv-date.dita">2013-03-08 - date to date: Added instruction for @normdate attribute that falls on
              various NL date elements</xref>
          </li>
          <li>
            <xref href="../../common_newest/Rosetta_heading-LxAdv-heading.dita">2013-03-06 - heading to heading: Removed instructions/rules for exceptional desig
              scenario and deprecated attribute <targetxml>@followstitle</targetxml>.</xref>
          </li>
          <li>
            <xref href="../../common_newest/Rosetta_edpnum-LxAdv-desig.dita">2013-03-06 - edpnum to desig: Removed instructions/rules for exceptional desig
              scenario and deprecated attribute <targetxml>@followstitle</targetxml>. Added
              instructions for maintaining source document ordering.</xref>
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita">2013-02-26 - link to ref:lnlink/@service="ATTACHMENT": Updated target example per
          ...
          <li>
            <xref href="../../common_newest/Rosetta_blockquote-LxAdv-blockquote.dita">2013-02-18 - blockquote to blockquote: Created two sections, one for "Release 4.0 and
          ...
          <li>
            <xref href="../../common_newest/Rosetta_figure-LxAdv-figure.dita">2013-02-18 - figure to figure: Created two sections, one for "Release 4.0 and after"
          ...
          <li>
            <xref href="../../common_newest/Rosetta_footnote-LxAdv-footnote.dita">2013-01-09 - footnotegrp and footnote to footnotegrp and footnote: Added instruction
              note for handling of <sourcexml>footnote[@fntoken]</sourcexml> with value 0 for UK
              content types.</xref>
          </li>
          <li>
            <xref href="../../common_newest/Rosetta_emph-LxAdv-emph.dita">2013-01-08 - emph to emph: Added note for handling <targetxml>emph/emph</targetxml>
    ...
    <section>
      ...
      <p>For changes prior to 2013, please see the <xref href="LPA-PracticalGuidance_Changes2012-AU.dita">previous topic</xref>.</p>
    </section>

  </body>
	</dita:topic>

	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU10_LNPG_seclaw\LPA-PracticalGuidance_ChangeManagement-AU.dita  -->
