...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:frm="http://www.lexis-nexis.com/glp/frm" xmlns:glp="http://www.lexis-nexis.com/glp" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:source_lnci="http://www.lexis-nexis.com/lnci" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:form="http://www.lexisnexis.com/xmlschemas/content/shared/form/1/" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:person="http://www.lexisnexis.com/xmlschemas/content/shared/person/1/" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" xmlns:proc="http://www.lexisnexis.com/xmlschemas/content/shared/process-elements/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita ci docinfo frm glp leg lnci">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="NZ-Regs-Services-change-log">
  <title>Change Log</title>
  <body>
      <section>
          <title>Regulation (Version 8.3 : PROD )</title>
          <p>2016-08-22
          <ul>
              <li>
      ...
      <section>
          <title>Regulation (Version 7.4 : PROD)</title>
          <p>2014-04-04<ul>
              <li>
              ...
              <li>
                  <xref href="../../../Rosetta/common_newest/Rosetta_AU_NZ_docinfo.assoc-links-LxAdv-additional-rule.dita">2014-04-03 - (AU-NZ) docinfo:assoc-links with linking and text children: New module. Describes a special AU-NZ use
      ...
      <section>
          ...
          <p>2014-02-20<ul>
              <li>
                  <xref href="../../DITA-PAC/NZ10_Regulation_From_Services/NZ-Regs-Services-leg_level.dita">2014-02-20 - leg:level to primlaw:level: Updated the instruction and example for
                      handling <sourcexml>@inline</sourcexml> attribute when target conversion having
                      <targetxml>primlaw:level@leveltype</targetxml> element with attribute values
                      "clause, section and regulation".</xref>
              </li>
              <li>
      ...
      <section>
          <title>Regulation (Version 7.4 : PROD)</title>
          <p>2014-01-08<ul>
              <li><xref href="NZ-Regs-Services-leg_level.dita">2014-01-08 - leg:level to primlaw:level: Added the intruction for handling the input attribute value <sourcexml>@legtype="subreg"</sourcexml> and this atttribute value should be converted in NL target as <targetxml>@leveltype="subregulation"</targetxml>. WebTeam #248983 created for pacific content NZ10 Regulation from services.</xref></li>              
              <li>
          ...
          <p>2013-12-03<ul>
              <li>
                        <xref href="../../common_newest/Rosetta_NZ-consecutive-note-LxAdv-notes.dita">2013-11-21 - Consecutive note elements to notes: New. R4.5 PIT Issue
                            #246364. Streams this change immediately applies to (data exists for) --
      ...
      <section>
          ...
          <p>2013-11-15<ul>
              <li>
                        <xref href="NZ-Regs-Services-leg_level.dita">2013-11-15 - leg:level to
      ...
      <section>
          ...
          <p>2013-03-22<ul>
              <li>
                  <xref href="../../common_newest/Rosetta_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.dita">2013-03-20 - Add instruction and example for handling <sourcexml>inlineobject</sourcexml> Child of <sourcexml>ci.conent/remotelink</sourcexml>.</xref>
              </li>
              <li>
    ...
    <section>
      <title>Regulation (Version 4.16:PROD)</title>
      <p>2013-02-11<ul>
          <li><b>Introduction:</b> Remove the Conversion Instruction for handling
              [<sourcexml>LEGDOC@legtype="court-rules"</sourcexml>] content stream in Introduction
            part.</li>
          <li><b>Common:</b> Remove the Conversion Instruction for handling the
              <sourcexml>p/leg:histnote</sourcexml> in common module dita's
              "<b>Rosetta_leg.histnote-Chof-p-LxAdv-note.dita</b>".</li>
          <li><b>Common:</b> Remove the Conversion Instructions for handling the
              <sourcexml>blockquote/legfragment/leg:level</sourcexml> and
              <sourcexml>p/blockquote/legfragment/l</sourcexml> in common module dita's.</li>
        </ul></p>
    </section>
    <section>
      <title>Regulation (Version 4.16:PROD)</title>
      <p>2013-02-01<ul>
          <li><b>Introduction:</b> Update the Introduction Dita module for handling
              <b>NZ10-Court-Rule (from services)</b> content stream (i.e.
              <sourcexml>LEGDOC@legtype="court-rules"</sourcexml>).</li>
          <li><b>Common:</b> Added the new common module dita
              "<b>Rosetta_leg.histnote-Chof-p-LxAdv-note.dita</b>" for handling the
              <sourcexml>p/leg:histnote</sourcexml>.</li>
          <li><b>Common:</b> Added the common module dita's for handling
              <sourcexml>blockquote/legfragment/leg:level</sourcexml> and
              <sourcexml>p/blockquote/legfragment/l</sourcexml> markup in CI.</li>
          <li><b>Common:</b> Instruction modified for the scenario
            ...
            end-tags (but not their content) are dropped.</li>
        </ul></p>
    </section>
    <section>
      <title>Regulation (Version 4.12:PROD)</title>
      <p>2012-10-26<ul>
          <li><b>Common:</b> Instruction and example added when <sourcexml>insert-line</sourcexml>
            occurs as a child of a <sourcexml>blockquote</sourcexml>.</li>
          <li><b>Common:</b> Instructions and example updated for handling General Markup elements
          ...
          <li><b>Common: </b>Added two common modules in conversion instruction (i.e.
                <b><i>Rosetta_leg.officialname_ln.user-displayed-LxAdv-legisinfo.officialtitle.dita</i></b>
            and
                <i><b>Rosetta_leg.officialnum_ln.user-displayed-LxAdv-primlawinfo.identifier_source.dita</b></i>).</li>
        </ul></p>
    </section>
  </body>
	</dita:topic>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ10_Regulation_From_Services\NZ-Regs-Services-change-log.dita  -->
	<xsl:message>NZ-Regs-Services-change-log.xsl requires manual development!</xsl:message> 
