...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	exclude-result-prefixes="dita ci docinfo frm glp leg">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Regulation-change-log">
		<title>Change Log</title>
		<body>
			<section>
				<title>Regulation (Version 8.3_PROD)</title>
				<p>2016-08-10 <ul>
						<li>
							<xref
						...
						<li>
							<xref
								...
								>2016-08-05 - glp:note id-CCCC-10341: Added Note about xml snippets
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.dita"
								>2016-08-05 - ci:content/remotelink/inlineobject to
								lnci:content/ref:crossreference id-CCCC-10357: Added Note about xml
						...
						<li>
							<xref
								...
								dc:identifier[@lnmeta:identifier-scheme] id-CCCC-10550: Created the
								rule to, Check manifest file for DPSI value and create new element
						...
						<li>
							<xref
								...
								id-CCCC-10246: Added Note about xml snippets that illustrate image
						...
						<li>
							<xref
								...
								figure id-CCCC-10330: Added Note about xml snippets that illustrate
								image handling. Note summarizes move from Apollo to Blobstore
								application. UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_h-Chof-figure-glp.note-LxAdv-figure-note-bodytext-h.dita"
								>2016-08-03 - (Commentary &amp; Regulatroy) figure/glp:note/h to
								figure/note/bodytext/h id-CCCC-10346: Added Note about xml snippets
								that illustrate image handling. Note summarizes move from Apollo to
								Blobstore application. UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
							<xref
								...
								>2016-08-03 - p-limited/remotelink to p/text/lnlink id-CCCC-10423:
						...
						<li>
							<xref
								...
								id-CCCC-10359: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-sub-LxAdv-figure_ref.inlineobject.dita"
								>2016-08-01 - sub/inlineobject to figure/ref:inlineobject
								id-CCCC-10365: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
							<xref
								...
								>2016-08-01 - dispformula/inlineobject to formula/ref:inlineobject
								id-CCCC-10358: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita"
								>2016-08-01 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink
								id-CCCC-10248: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
						...
						<li>
							<xref
								...
								about xml snippets that illustrate image handling. Note summarizes
								move from Apollo to Blobstore application. UK is first LBU to move
								to Blobstore. VSTS 76146</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								...
								id-CCCC-10362: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore.</xref>
						</li>
						<li>
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-bodytext-LxAdv-bodytext_p_text_figure_ref.inlineobject.dita"
								>2016-07-29 - bodytext/inlineobject to
								bodytext/p/text/figure/ref:inlineobject id-CCCC-10354: Added Note
								about xml snippets that illustrate image handling. Note summarizes
								move from Apollo to Blobstore application. UK is first LBU to move
								to Blobstore. VSTS 76146</xref>
						</li>
						...
						<li>
							<xref
								...
								>2016-07-26 - p/blockquote/inlineobject to p/figure/ref:inlineobject
								id-CCCC-10363: Added Note about xml snippets that illustrate image
								handling. Note summarizes move from Apollo to Blobstore application.
								UK is first LBU to move to Blobstore. </xref>
						</li>
						<li>
							<xref
								...
								>2016-04-28 - refpt child of p/text to p/ref:anchor id-CCCC-10456:
								Added one more source and target example.</xref>
						</li>
					</ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 8.2: PROD)</title>
				<p>2016-04-22 <ul>
						<li>
							<xref
								href="../../../Rosetta/DITA-PAC/AU06_Regulation/Regulation-Body.dita"
								>2016-04-22 - Body id-AU06-19007: Added the new instruction with
								examples for handling some specific images (either 'au_inforce.png'
								and 'au_noforce.png'). (Webstar #6036111)</xref>
						</li>
						<li>
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_glp.note-Chof-text-LxAdv-inlinenote.dita"
								>2016-04-01 - text/glp:note to text/inlinenote id-CCCC-10339: Added
								instruction for child elements of <sourcexml>glp:note</sourcexml>
								element, Applicable on CA01.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_glp.note-Chof-emph-LxAdv-inlinenote.dita"
								>2016-04-01 - emph/glp:note to emph/inlinenote id-CCCC-10329: Added
								instruction for child elements of <sourcexml>glp:note</sourcexml>
								element, Applicable on CA01.</xref>
						</li>
						<li>
							<xref
								...
								>2016-03-15 - edpnum to desig id-CCCC-10308: Added rule for handling
								scenario when <sourcexml>pnum</sourcexml> and <sourcexml>edpnum
								</sourcexml> occur as siblings (applicable only for UK22CS). [RFA
								#2755]</xref>
						</li>
						<li>
							<xref
								...
								id-CCCC-10333: (AU04 only) Added new section for converting heading
								markup following <sourcexml>glp:note</sourcexml>. Addresses
								WS6034981.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-p_blockquote-LxAdv-p_figure_ref.inlineobject.dita"
								>2015-12-08 - p/blockquote/inlineobject to p/figure/ref:inlineobject
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-p_blockquote-LxAdv-p_figure_ref.inlineobject.dita"
								>2015-11-17 - p/blockquote/inlineobject to p/figure/ref:inlineobject
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita"
								>2015-09-08 - docinfo:overview to doc:overview id-CCCC-10303: Added
								the handling of new attribute value "abstract" inside the
									<targetxml>docinfo:overview@type</targetxml> markup for UK
								streams and it should be mapped with
									<targetxml>doc:overview@type="abstract"</targetxml>. R4.5
								Content Issue List #2391.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
								>2015-09-08 - link to ref:lnlink[@service="ATTACHMENT"]
								id-CCCC-10394: Minor XPATH correction in title to change
									<targetxml>ref:lnlink/@service="ATTACHMENT"</targetxml> to be
									<targetxml>ref:lnlink[@service="ATTACHMENT"]</targetxml>.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_lnlink_service_SEARCH-LxAdv-SUPPRESS.dita"
								>2015-09-08 - lnlink[@service='SEARCH'] is SUPPRESSED id-CCCC-10397:
								Minor XPATH correction in instruction title and body to change
									<sourcexml>lnlink/@service='SEARCH'</sourcexml> to be
									<sourcexml>lnlink[@service='SEARCH']</sourcexml>.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_lnlink_service_ATTACHMENT-LxAdv-ref.lnlink.dita"
								>2015-09-08 - lnlink[@service="ATTACHMENT"] to
								ref:lnlink[@service="ATTACHMENT"] id-CCCC-10396: Minor XPATH
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2015-08-12 - emph/inlineobject to figure/ref:inlineobject
								id-CCCC-10359: Added instruction and example for
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2015-07-24 - emph/inlineobject to figure/ref:inlineobject
								id-CCCC-10359: When Inlineobject is followed by two emph elements of
								same typestyle <sourcexml>sup/emph/emph/inlineobject</sourcexml>then
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_p-limited_remotelink-LxAdv-p_text_ref.lnlink.dita"
								>2015-07-24 - p-limited/remotelink to p/text/lnlink id-CCCC-10423:
								Corrected typo in title (was "<sourcexml>p-limited/emph</sourcexml>
								to <targetxml>p/text/emph</targetxml>", corrected to be
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2015-07-21 - emph/inlineobject to figure/ref:inlineobject
								id-CCCC-10359: When Inlineobject is followed by two emph elements of
								same typestyle then from Target we should drop the one emph element
								and the followed <sourcexml>emph/inlineobject</sourcexml> should
								mapped with <targetxml>figure/ref:inlineobject</targetxml> in
								Target.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_person-LxAdv-person.person.dita"
								>2015-07-16 - person to person:person id-CCCC-10428: Added
								instruction for <sourcexml>person/remotelink</sourcexml> mapping to
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2015-06-18 - emph/inlineobject to figure/ref:inlineobject
								id-CCCC-10359: When source is having emph followed by inlineobject
								inside base:h element <sourcexml>h/emph/inlineobject</sourcexml>
								than in Target it should Map it like
									<targetxml>emph/ref:inlineobject</targetxml> as emph containing
								text under it.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_levelinfo_classification-LxAdv-SUPPRESS.dita"
								>2015-06-01 - levelinfo/classification
								@ln.user-displayed="false"/classitem
								@ln.user-displayed="false"/classitem-identifier/classname is
								SUPPRESSED id-CCCC-10392: This temporary note is also applicable for
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
								>2015-05-22 - link to ref:lnlink[@service="ATTACHMENT"]
								id-CCCC-10394: Changed the instructions to indicate
									<sourcexml>link/@status</sourcexml> is always dropped and
								removed <targetxml>ref:lnlink/@status</targetxml> from target
								example. This is a very low-priority change and has been added for
								technical correctness, particularly with respect to new CIs.
								Existing scripts do not have to implement this change since
									<targetxml>ref:lnlink/@status</targetxml> is ignored by
								LexisAdvance if it is present.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_lnlink_service_ATTACHMENT-LxAdv-ref.lnlink.dita"
								>2015-05-22 - lnlink[@service="ATTACHMENT"] to
								ref:lnlink[@service="ATTACHMENT"] id-CCCC-10396: Added an
								instruction to explicitly indicate
									<sourcexml>lnlink/@status</sourcexml> is always dropped
								...
								since prior to the change <targetxml>lnlink/@status</targetxml>
						...
						<li>
							<xref
								...
								>2015-05-22 - url/remotelink to url id-CCCC-10464: Added an
								instruction to explicitly indicate
									<sourcexml>remotelink/@status</sourcexml> is always dropped
								(suppressed). This is a very low-priority change and has been added
								for technical correctness, particularly with respect to new CIs.
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_PAC-page-wAncestor-entry-LxAdv-ref.page.dita"
								>2015-05-05 - page with an ancestor of entry to ref:page
								id-CCCC-10425: Change to consolidate instructions, actual
								instructions have not changed. Removed redundant instructions
								pertaining to commas, periods, and spaces within
									<sourcexml>page/@count</sourcexml>, as well as instructions
								regarding the XPath <sourcexml>li/page</sourcexml>. Added note to
								refer to to topic "<sourcexml>page</sourcexml> to
									<targetxml>ref:page</targetxml> id-CCCC-10426" that contains the
								general instructions for <sourcexml>page</sourcexml> to
									<targetxml>ref:page</targetxml>, including the instructions
								removed from this topic.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_PAC-page-wAncestor-entry-LxAdv-ref.page.dita"
								>2015-04-24 - page with an ancestor of entry to ref:page
								id-CCCC-10425: Added a note and an example ("Source XML showing
								table with multiple page elements") to explicitly specify and
								demonstrate handling the scenario where there are multiple
									<sourcexml>page</sourcexml> elements in the same
									<sourcexml>table</sourcexml>. (Webstar #5771989 &amp;
								#5945128)</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_AU_legistlation_courtrule_inlineobject-Chof-remotelink-LxAdv-SUPPRESS.dita"
								>2015-03-31 - remotelink/inlineobject SUPPRESS id-CCCC-10235:
								Clarification added to specify that this rule does not apply when
								the grandparent of <sourcexml>inlineobject</sourcexml> is
									<sourcexml>ci:content</sourcexml>. (WebStar #5895292)</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_ci.cite-LxAdv-lnci.cite.dita"
								>2015-03-23 - ci.cite to lnci.cite id-CCCC-10268: Updated main
								instructions to clarify that descendants of ci:cite, and not just
								children, are to be processed.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_emp-Chof-heading_title-LxAdv-heading_title.dita"
								>2015-03-18 - heading/title/emph to heading/title id-CCCC-10313:
								When <sourcexml>heading\title</sourcexml> contains
									<sourcexml>emph</sourcexml> and <sourcexml>PCDATA</sourcexml>
								under it then from target the emph tags will dropped and it's
								content along with PCDATA content will be put directly under
									<targetxml>title</targetxml> element . Applicable to UK09
								only.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_pgrp-LxAdv-pgrp.dita"
								>2015-03-17 - pgrp to pgrp id-CCCC-10431: An attribute
									<targetxml>@inline</targetxml> get added with
									<targetxml>desig</targetxml> element even when the
									source<sourcexml>pnum</sourcexml> is not having that
									attribute<sourcexml>@inline</sourcexml> Applicable on CA12
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_pnum-LxAdv-desig.dita"
								>2015-03-17 - pnum to desig id-CCCC-10434: An attribute
									<targetxml>@inline</targetxml> get added with
									<targetxml>desig</targetxml> element even when the
									source<sourcexml>pnum</sourcexml> is not having that
									attribute<sourcexml>@inline</sourcexml> Applicable on CA12
						...
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_pgrp-LxAdv-pgrp.dita"
								>2015-02-24 - pgrp to pgrp id-CCCC-10431: Example updated as per new
								rule an attribute <targetxml>@inline</targetxml>get added with
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_pnum-LxAdv-desig.dita"
								>2015-02-24 - pnum to desig id-CCCC-10434: An attribute
									<targetxml>@inline</targetxml>get added with
									<targetxml>desig</targetxml>element even when the
									source<sourcexml>pnum</sourcexml>is not having that
									attribute<sourcexml>@inline</sourcexml>
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_person-LxAdv-person.person.dita"
								>2015-02-03 - person to person:person id-CCCC-10428: Added
								instruction for <sourcexml>name.detail/name.honorific</sourcexml>
								mapping to
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.hier-LxAdv-doc.hier.dita"
								>2015-01-13 - docinfo:hier to doc:hier id-CCCC-10297: Added a note
								to repalce <sourcexml>nl</sourcexml> to a white space when
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_remotelink-Chof-url-LxAdv-url.dita"
								>2015-01-09 - url/remotelink to url id-CCCC-10464: Within use case
								that maps to <targetxml>ref:lnlink</targetxml>, added exceptional
								rule to not concatenate values when
									<sourcexml>@hrefclass</sourcexml> content is already present in
									<sourcexml>@href</sourcexml>. Expanded example to illustrate the
								scenario. Responds to data for UK10 Dictionaries but applies in
								general. R4.5 Content Issue 2120.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_page-LxAdv-ref.page.dita"
								>2015-01-05 - page to ref:page id-CCCC-10426: Defined handling for
								page/@count if period (.) occurs in the value.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita"
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_ci.cite-LxAdv-lnci.cite.dita"
								>2014-12-08 - ci.cite to lnci.cite id-CCCC-10268: Addition of
								mapping for <sourcexml>ci:pinpoint</sourcexml> to
									<targetxml>lnci:pinpoint</targetxml> and example from US LPA
								content.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_link_refpt-LxAdv-ref.lnlink-ref.locator_anchoridref.dita"
								>2014-11-24 - link/@refpt to ref:lnlink/ref.locator/@anchoridref
								id-CCCC-10395: Updated instruction for CA02-CC to drop
									<sourcexml>emph</sourcexml> in
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita"
								>2014-11-04 - docinfo:overview to doc:overview id-CCCC-10303:
								Clarification only: added text to explicitly indicate that the child
									<targetxml>doc:overview/bodytext</targetxml> should be created.
								Not a change to instructions.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_figure-LxAdv-figure.dita"
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_emp-Chof-heading_title-LxAdv-heading_title.dita"
								>2014-10-22 - heading/title/emph to heading/title id-CCCC-10313:
								Added an example to explicitly show child elements of
									<sourcexml>emph</sourcexml> being retained. (R4.5 Content Issue
								List #1998)</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita"
								>2014-10-21 - docinfo:overview to doc:overview id-CCCC-10303: added
								to UK09 ditamap.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_lnlink_service_ATTACHMENT-LxAdv-ref.lnlink.dita"
								>2014-10-15 - lnlink[@service="ATTACHMENT"] to
								ref:lnlink[@service="ATTACHMENT"] id-CCCC-10396: Rewrote
								instructions, including the correction of a typographic error, and
						...
						<li>
							<xref
								...
								id-CCCC-10301: Added a special scenario for all Canada streams to
								handle <sourcexml>docinfo:lbu-juris</sourcexml> to
			...
			<section>
				<title>Regulation (Version 7.7: PROD)</title>
				<p>2014-08-05 <ul>
						<li>
							<xref
								href="../../../Rosetta/DITA-PAC/AU06_Regulation/Regulation-Body.dita"
								>2014-08-05 - Body id-AU06-19007: Updated the examples (input and
								target) with rule for suppressed the both attributes
									<targetxml>@anchoridref</targetxml> and
									<targetxml>@ref:locatorkeyprotocol="DOC-ID"</targetxml> inside
									<targetxml>toc-entry</targetxml> because its generating Inactive
								(dead) links on LexisAdvance Platform.</xref>
						</li>
					</ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 7.6: PROD)</title>
				<p>2014-07-28 <ul>
						<li>
							<xref
								href="../../../Rosetta/DITA-PAC/AU06_Regulation/Regulation-Body.dita"
								>2014-07-28 - Body id-AU06-19007: Added a rule for suppressed the
								both attributes <targetxml>@anchoridref</targetxml> and
									<targetxml>@ref:locatorkeyprotocol="DOC-ID"</targetxml> inside
									<targetxml>toc-entry</targetxml> because its generating Inactive
								(dead) links on LexisAdvance Platform.</xref>
						</li>
			...
			<section>
				...
				<p>2014-07-08 <ul>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_table-LxAdv-table.dita"
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_emp-Chof-heading_title-LxAdv-heading_title.dita"
								>2014-06-04 - heading/title/emph to heading/title id-CCCC-10313:
								Clarified instructions and added an example to show multiple
						...
						<li>
							<xref
								...
								minor questions on message boards that have been asked and answered
								over the past two years. These instructions should not trigger
								changes to existing conversion programs, as the programs have
								already been changed in response to previous message board answers.
								These instructions have been added so this topic is up-to-date with
								respect to current conversion program behavior for these rarely
								occuring attributes.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_page-LxAdv-ref.page.dita"
								>2014-06-03 - page to ref:page id-CCCC-10426: Added instruction and
								example to generate
									<targetxml>doc:pagination/doc:pagination-scheme</targetxml> in
								target and this immediately applies to all LNI streams.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_footnote-LxAdv-footnote.dita"
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.doc-id-LxAdv-dcidentifier_lnmetaidentifier-scheme.dita"
								>2014-05-21 - docinfo:doc-id to
								dc:identifier[@lnmeta:identifier-scheme] id-CCCC-10293: For CA05
								Acts and Bills- Mapping in dc:identifier for act-no and chunk-no..
								Db issue #1464 </xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita"
								>2014-04-28 - docinfo:assoc-links to doc:related-content
								id-CCCC-10284: Clarified instructions regarding
									<sourcexml>link</sourcexml> elements and added an example (#4)
								illustrating the special <sourcexml>text/link</sourcexml>
								conversion. No mapping rules where changed or added.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita"
								>2014-04-21 - docinfo:assoc-links to doc:related-content
								id-CCCC-10284: Added an instruction to handle
									<sourcexml>link</sourcexml> elements. These can potentially
								occur in any future UK data and will be present in stream UK21fl
								when those documents become available later in 2014.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_footnote-LxAdv-footnote.dita"
								>2014-04-17 - footnotegrp and footnote to footnotegrp and footnote
								id-CCCC-10322: Added instruction for
									<sourcexml>footnotegrp</sourcexml> within
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.versioninfo-LxAdv-doc.versioninfo-scheme.dita"
								>2014-04-15 - docinfo:versioninfo to doc:versioninfo id-CCCC-10307:
								Added the content stream code "CA08 Constitutions" inside the Note
								for handling empty use cases of
									<sourcexml>docinfo:versioninfo</sourcexml> for Canada
								streams.</xref>
						</li>
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_p-LxAdv-p.dita"
								>2014-04-14 - p to p id-CCCC-10424: Removed Colons from Labels.. DB
								item #1255</xref>
						</li>
						<li>
							<xref
								...
								id-CCCC-10284: Illustrative changes. Examples modified. Mapping for
						...
						<li>
							<xref
								...
								children id-CCCC-10243: New module. Describes a special AU-NZ use
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita"
								>2014-03-25 - docinfo:assoc-links to doc:related-content
								id-CCCC-10284: Added rule and example for
									<sourcexml>docinfo:assoc-links/docinfo:assoc-links-grp/ci:cite</sourcexml>.
								R4.5 Content issue #1125</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_deflist-LxAdv-deflist.dita"
								>2014-03-21 - deflist to deflist id-CCCC-10277: Added instruction to
								handle <sourcexml>defitem/@id</sourcexml> and
									<sourcexml>defterm/@id</sourcexml> only for GPL IN content
								Streams.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_leg.comntry-LxAdv-annot.annotations-annot.annotation-grp.dita"
								>2014-03-21 - leg:comntry to annot:annotations/annot:annotation-grp
								id-CCCC-10378: Added instruction to handle
									<sourcexml>leg:comntry/@searchtype</sourcexml> For GPL IN
								Content Streams</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_figure-LxAdv-figure.dita"
								>2014-03-20 - figure to figure id-CCCC-10320: Illustrative change.
								Added example to explicitly show standard conversion of child link
								to ref:lnlink. Prompted by Phase 6 UK Discussion Item 77. Webteam
								252434.</xref>
						</li>
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_toc-LxAdv-toc.dita"
								>2014-03-20 - toc to toc id-CCCC-10480: New rule. Added mapping for
									<sourcexml>entry-pageref</sourcexml> to
									<targetxml>toc-pageref</targetxml>. Initially for UK12 but will
								apply for any stream if the use case occurs. Responds to data added
								in UK12 delivery Mar 2014; known to occur in dpsi 02FL and 03VY.
								Phase 6 UK Discussion Item 79. Webteam 252434.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_remotelink-LxAdv-ref.crossreference.dita"
								>2014-02-25 - remotelink to ref:crossreference id-CCCC-10465:
								Updated instruction and created new example (#16) for handling
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.doc-heading-LxAdv-dc.title.dita"
								>2014-02-11 - docinfo:doc-heading to dc:title id-CCCC-10292: Updated
								note when <sourcexml>emph</sourcexml> is child of
						...
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_pgrp-LxAdv-pgrp.dita"
								>2014-02-11 - pgrp to pgrp id-CCCC-10431: Add instruction and
								example <sourcexml>pgrp/@subdoc</sourcexml> and
						...
						<li>
							<xref
								...
								id-CCCC-10306: Added a special rule for UK07 contents, When element
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_remotelink-LxAdv-ref.crossreference.dita"
								>2014-02-03 - remotelink to ref:crossreference id-CCCC-10465:
								Instruction updated if <sourcexml>remotelink</sourcexml> occurs as
								multiple, immediate siblings and without intermediary text within
									<sourcexml>title</sourcexml>. Also added a example for the same
								scenario. Phase 5 UK discussion-defect tracking issue #161</xref>
						</li>
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_text-LxAdv-text.dita"
								>2014-01-31 - text to text id-CCCC-10477: Updated instruction,
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.lbu.juris-LxAdv-classify.classification_classscheme_docinfolbu-juris.dita"
								>2014-01-19 - docinfo:lbu-juris to
								classify:classification[@classscheme="docinfo:lbu-juris"]
								id-CCCC-10301: Added a special scenario for handling
									<sourcexml>docinfo:lbu-juris</sourcexml> along with input and
								output examples for CANADA CA02 contents ONLY.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_Elements-LxAdv-Empty_Elements.dita"
								>2014-01-16 - Suppress each empty element unless otherwise stated
								id-CCCC-10310: Added list of elements to suppress if empty.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_date-Chof-docinfo.load-date-LxAdv-dc.date_lnmeta.datetype_load-date-scheme.dita"
								>2014-01-07 - docinfo:load-date/date to
								dc:date[@lnmeta:datetype="load-date"] id-CCCC-10274: Added a note
								along with example which contains "00" value in
						...
						<li>
							<xref
								...
								id-CCCC-10322: Updated target example for applying the rule of
								"deleting extraneous instances of @morerows, @colsep and @rowsep" in
								sample documents.</xref>
						</li>
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_l-LxAdv-list.dita"
								>2014-01-06 - l to list id-CCCC-10372: Added mapping instruction for
								nested lists.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_Topic_Identifiers.dita"
								>2014--0-5- - Topic Identifiers id-CCCC-10481: Created.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_ci.cite-LxAdv-lnci.cite.dita"
								>2013-12-30 - ci.cite to lnci.cite id-CCCC-10268: Minor illustrative
								change. Added "(AU Journals/Newsitem)" to headings for last example
								to clarify that retention of
									<sourcexml>@type="cite4thisdoc"</sourcexml> is an exception for
								that content, as already described in narrative rules.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_deflist-LxAdv-deflist.dita"
								>2013-12-20 - deflist to deflist id-CCCC-10277: Added note to place
								a <sourcexml>footnote</sourcexml> or <sourcexml>fnr</sourcexml> that
								is a child of <sourcexml>defitem</sourcexml> into one of its
								children. WebTeam #5158742 - AU04.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_glp.note_blockquote_p_text_inlineobject-LxAdv-note_bodytext_p_text.dita"
								>2013-12-20 - glp:note id-CCCC-10341: Corrected the target example
								(added ref:corssreference). WebTeam #5158742 - AU04. Applies
								generally to all LBUs and streams.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_endnote-LxAdv-endnote.dita"
								>2013-12-18 - endnote to endnote id-CCCC-10317: Instruction added to
								convert <sourcexml>remotelink/@refpt</sourcexml> to
									<targetxml>footnote-ref/@anchoridref</targetxml>. WebTeam
								#5158742 - AU04. Applies generally to all LBUs and streams.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.alt-renditions-LxAdv-doc.alt-renditions.dita"
								>2013-12-17 - docinfo:alt-renditions/docinfo:alt-rendition to
								doc:alt-renditions/doc:alt-rendition id-CCCC-10283: Added
						...
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_p-LxAdv-p.dita"
								>2013-12-04 - p to p id-CCCC-10424: Updated target example when
						...
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_p-LxAdv-p.dita"
								>2013-11-21 - p to p id-CCCC-10424: Updated instruction and example
									<sourcexml>p</sourcexml> or <sourcexml>p/@nl="0"</sourcexml>
								comes in <sourcexml>references</sourcexml>, this change directly
								affects NZ07.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_AU_NZ_copyright-LxAdv-copyright.dita"
								>2013-11-12 - (AU/NZ) copyright to copyright id-CCCC-10242: Added
								example for AU Cases. Webstar #: 5093906. This change immediately
								applies to AU01 Caselaw.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_glp.note-Chof-li-LxAdv-listitem-note.dita"
								>2013-11-07 - l/glp:note to list/note id-CCCC-10336: Fixed title to
								correctly indicate mapping described. Not a rule change.</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.alt-renditions-LxAdv-doc.alt-renditions.dita"
								...
								doc:alt-renditions/doc:alt-rendition id-CCCC-10283: Added
								instruction and example for UK06 Laws/Acts/Bills/Measures and UK07
								Regulation place the text of <sourcexml>leg:officialname</sourcexml>
								in
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.currencystatement-LxAdv-currencystatement.dita"
								>2013-10-29 - docinfo:currencystatement to
								doc:docinfo/currencystatement id-CCCC-10289: WebTeam #233318 created
								for pacific content stream inorder to suppress
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita"
								>2013-10-29 - docinfo:overview to doc:overview id-CCCC-10303:
								WebTeam #233318 created for pacific content stream inorder to
								suppress <sourcexml>docinfo:overview</sourcexml> with in
									<sourcexml>leg:levelinfo</sourcexml> and
									<sourcexml>levelinfo</sourcexml>.</xref>
						</li>
						<li>
							<xref href="../../../Rosetta/common_newest/Rosetta_p-LxAdv-p.dita"
								>2013-10-25 - p to p id-CCCC-10424: Added instruction and example
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_figure-LxAdv-figure.dita"
								>2013-10-23 - figure to figure id-CCCC-10320: Added instruction for
								handling figure/p/text/inlineobject Webteam # 239816</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_remotelink-LxAdv-ref.crossreference.dita"
								>2013-10-23 - remotelink to ref:crossreference id-CCCC-10465: Added
								Example when <sourcexml>remotelink</sourcexml> having child
									<sourcexml>emph</sourcexml>. Webteam # 239816</xref>
						</li>
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_edpnum-LxAdv-desig.dita"
								>2013-10-22 - edpnum to desig id-CCCC-10308: Not a rule change.
								Modified 2nd example for clarity. Removed
									<sourcexml>refpt</sourcexml> from source markup. Not pertinent
						...
						<li>
							<xref
								href="../../../Rosetta/common_newest/Rosetta_docinfo.doc-heading-LxAdv-dc.title.dita"
								>2013-10-18 - docinfo:doc-heading to dc:title id-CCCC-10292: Updated
								Instruction when <sourcexml>docinfo:doc-heading</sourcexml> contains
								word RULE: " or STATUTE: .</xref>
						</li>
					</ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 7.3: PROD)</title>
				<p>2013-10-15 <ul>
						<li>
							<xref
						...
						<li>
							<xref href="../../common_newest/Rosetta_deflist-LxAdv-deflist.dita"
								>2013-10-14 - deflist to deflist: Added new rule to create a blank
								defitem/defdesc element after the defterm element. WebTeam #
								241018.</xref>
						</li>
					</ul>
				</p>
			...
			<section>
				<title>Regulation (Version 7.3: PROD)</title>
				<p>2013-10-14 <ul>
						<li><xref href="Regulation-Body.dita">2013-10-14 - leg:sectionlist to
								primlaw:level[@leveltype="table-of-contents"]: Target example
								updated for all remotelinks handling within entry markup in all
								tables for <sourcexml>leg:sectionlist</sourcexml> handling when it
								contains @id in order to match the rule(verbiage) and the actual
								conversion code and Webteam number is "<b>#239068</b>".</xref></li> <li>
							<xref
								...
								Instruction added when <sourcexml>remotelink</sourcexml> as a child
								of <sourcexml>docinfo:authorattribution/contrib</sourcexml>. WebTeam
								# is 240252.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_refpt-Chof-p_text-LxAdv-p_ref.anchor.dita"
								>2013-10-11 - refpt child of p/text to p/ref:anchor: Added a note
								and update the target examples when refpt comes without attribute
						...
						<li>
							<xref
								...
								>2013-10-11 - refpt child of p/text/emph to p/ref:anchor: Added a
						...
						<li>
							<xref
								...
								having a running text. Affects all Pacific content streams. WebTeam
								# is 238798.</xref>
						</li>
						<li>
							<xref href="../../common_newest/Rosetta_endnote-LxAdv-endnote.dita"
								>2013-10-07 - endnote to endnote: Instruction and example for added
								for the Xpath <sourcexml>leg:bodytext/glp:note/l/li</sourcexml>
								related to <targetxml>endnote</targetxml> handling. WebTeam # is
								238790.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref href="../../common_newest/Rosetta_footnote-LxAdv-footnote.dita"
								...
								directions clearer.</xref></li></ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 7.3: PROD)</title>
				<p>2013-09-27 <ul>
						<li>Added <targetxml>footnote-ref</targetxml> to the content model of
								<targetxml>lnci:content</targetxml>. WebTeam is # 235099</li>
						<li>
							<xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
								>2013-09-24 - link to ref:lnlink/@service="ATTACHMENT": Not a rule
								change. Modified examples to illustrate when
						...
						<li>
							<xref
								...
								Instruction added for suppressing
									<sourcexml>docinfo:authorattribution/contrib</sourcexml> when it
								is child of <sourcexml>leg:levelinfo</sourcexml> and
						...
						<li>
							<xref
								...
								>2013-09-16 - docinfo:overview to doc:overview: Instruction added
								for suppressing <sourcexml>docinfo:overview</sourcexml> when it is
								child of <sourcexml>leg:levelinfo</sourcexml> and
									<sourcexml>levelinfo</sourcexml>.Affects all Pacific content
								streams. WebTeam # is 234193.</xref>
						</li>
			...
			<section>
				<title>Regulation (Version 7.2: PROD)</title>
				<p>2013-09-12 <ul>
						<li><xref href="Regulation-Body.dita">2013-09-12 - leg:longtitle to
								primlaw:prelim/primlaw:synopsis: Added the instruction and example
								for handling the sourcemarkup
								<sourcexml>leg:longtitle</sourcexml>.</xref>
						</li>
						<li><xref href="Regulation-Body.dita">2013-09-12 - leg:companion to
								primlaw:level[@leveltype="companion"]: Added the instruction and
								example for handling the sourcemarkup
									<sourcexml>leg:companion</sourcexml>.</xref>
						</li>
						<li>
						...
						<li>
							<xref
								...
								>2013-08-29 - Converting text When it Contains Only Whitespace or
								NBSP Entity: Created per WebStar: WebTeam #223114</xref>
						</li>
					</ul></p>
			</section>
			<section>
				<title>Regulation (Version 7.2: PROD)</title>
				<p>2013-08-23 <ul>
						<li><xref href="Regulation-Body.dita">2013-08-23 - leg:sectionlist to
								primlaw:level[@leveltype="unclassified"]: Added the instruction and
								example for nesting the
									<targetxml>toc@toctype="sectionlist"</targetxml> based on the
								source markup <sourcexml>leg:sectionlist</sourcexml> and Webteam
								number is "<b>225654</b>".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.authorattribution-LxAdv-dc.contributor.dita"
								>2013-08-13 - docinfo:authorattribution to dc:contributor: Added
								instruction and example when <sourcexml>person</sourcexml> is an
								child of <sourcexml>docinfo:authorattribution/contrib</sourcexml>
								and CR# DAAM2013080706295200 has been created to add
									<targetxml>person:person</targetxml> to the content model of
				...
				<p>2013-08-12 <ul>
						...
						<li>
							<xref
								...
								ref:crossreference (intra-document link): Changed target to
			...
			<section>
				<title>Regulation (Version 7.1: PROD)</title>
				<p>2013-07-24 <ul> <li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.authorattribution-LxAdv-dc.contributor.dita"
								>2013-06-25 - docinfo:authorattribution to dc:contributor: added to
								AU and NZ ditamap for content enrichment</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.currencystatement-LxAdv-currencystatement.dita"
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.overview-LxAdv-docinfo.overview.dita"
								>2013-06-25 - docinfo:overview to doc:overview: added to AU and NZ
								ditamap for content enrichment</xref>
						</li>
					</ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 7.0: PROD)</title>
				<p>2013-06-24 <ul> <li><xref href="Regulation-Body.dita">2013-06-24 - Added the
								attribute value '<b>definedTerms</b>' within
									<targetxml>index:index@indextype</targetxml> for handling the
								scenario <sourcexml>index[@id="XXXX_DEFLIST"]</sourcexml>.</xref>
						</li>
						<li>
							<xref href="../../common_newest/Rosetta_copyright-LxAdv-copyright.dita"
								>2013-06-17 - copyright to copyright: Added an example when
									<sourcexml>copyright-holder</sourcexml> is not present in the
								source.</xref>
						</li>
						<li>
							<xref
			...
			<section>
				<title>Regulation (Version 6.2: PROD)</title>
				<p>2013-05-29 <ul>
						<li>
							<xref
						...
						<li>
							<xref
								...
								>2013-05-24 - docinfo:versioninfo to doc:versioninfo: Instructions
								added for handling empty use cases of
						...
						<li>
							<xref
								...
								>2013-05-24 - inlineobject to ref:inlineobject: Updated instruction
								for handling of inlineobject when smi is present and some of the
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_leg.comntry-LxAdv-annot.annotations-annot.annotation-grp.dita"
								>2013-05-15 - leg:comntry to annot:annotations/annot:annotation-grp:
								Fixed typo: (extra semicolon in xpath expression)</xref>
						</li>
					</ul>
				</p>
			</section>
				...
				<p>2013-05-13 <ul>
						...
						<li>
							<xref
								...
								figure/note/bodytext/h: Extended the list of allowable values for
								image handling.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								...
								>2013-05-08 - h/inlineobject to figure/ref:inlineobject: Extended
						...
						<li>
							<xref
								...
								>2013-05-08 - emph/inlineobject to figure/ref:inlineobject: Extended
								the list of allowable values for image handling.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-sub-LxAdv-figure_ref.inlineobject.dita"
								>2013-05-08 - sub/inlineobject to figure/ref:inlineobject: Extended
								the list of allowable values for image handling.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								...
								>2013-05-08 - dispformula/inlineobject to formula/ref:inlineobject:
						...
						<li>
							<xref
								...
								p/figure/ref:inlineobject: Extended the list of allowable values for
								image handling.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-bodytext-LxAdv-bodytext_p_text_figure_ref.inlineobject.dita"
								>2013-05-08 - bodytext/inlineobject to
								bodytext/p/text/figure/ref:inlineobject: Extended the list of
								allowable values for image handling.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_p-limited_remotelink-LxAdv-p_text_ref.lnlink.dita"
								>2013-05-08 - p-limited/emph to p/text/emph: Extended the list of
								allowable values for image handling.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
								>2013-05-02 - link to ref:lnlink/@service="ATTACHMENT": Some of the
								verbiage is changed and updated target example to if the SMI is
								present then a <targetxml>ref:lnlink/@status</targetxml> attribute
						...
						<li>
							<xref
								...
								section "Release 4.0 and after" and section "Pre-Release 4.0" now
								have similar conversion markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_blockquote-link-LxAdv-blockquote-p-text-ref.lnlink.dita"
								>2013-05-01 - blockquote/link to blockquote/p/text/ref:lnlink:
								Updated instructions and target example per latest Apollo
								markup.</xref>
						</li>
						<li>
						...
						<li>
							<xref
								...
								figure/note/bodytext/h: Removed instructions for section
								"Pre-Release 4.0" because according to latest Apollo markup, section
								"Release 4.0 and after" and section "Pre-Release 4.0" now have
								similar conversion markup.</xref>
						</li>
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2013-05-01 - emph/inlineobject to figure/ref:inlineobject: Removed
								instructions for section "Pre-Release 4.0" because according to
								latest Apollo markup, section "Release 4.0 and after" and section
								"Pre-Release 4.0" now have similar conversion markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-sub-LxAdv-figure_ref.inlineobject.dita"
								>2013-05-01 - sub/inlineobject to figure/ref:inlineobject: Removed
								instructions for section "Pre-Release 4.0" because according to
								latest Apollo markup, section "Release 4.0 and after" and section
								"Pre-Release 4.0" now have similar conversion markup.</xref>
						</li>
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-dispformula-LxAdv-formula_ref.inlineobject.dita"
								>2013-05-01 - dispformula/inlineobject to formula/ref:inlineobject:
								Removed instructions for section "Pre-Release 4.0" because according
								to latest Apollo markup, section "Release 4.0 and after" and section
								"Pre-Release 4.0" now have similar conversion markup.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-bodytext-LxAdv-bodytext_p_text_figure_ref.inlineobject.dita"
								>2013-05-01 - bodytext/inlineobject to
								bodytext/p/text/figure/ref:inlineobject: Removed instructions for
								section "Pre-Release 4.0" because according to latest Apollo markup,
								section "Release 4.0 and after" and section "Pre-Release 4.0" now
								have similar conversion markup.</xref>
						</li>
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita"
								>2013-05-01 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink:
								Updated instructions and target example per latest Apollo
								markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_p-limited_remotelink-LxAdv-p_text_ref.lnlink.dita"
								>2013-05-01 - p-limited/emph to p/text/emph: Removed instructions
						...
						<li>
							<xref
								...
								figure/note/bodytext/h: Updated target sample according to latest
								Apollo markup.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2013-04-30 - emph/inlineobject to figure/ref:inlineobject: Updated
								target sample according to latest Apollo markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-sub-LxAdv-figure_ref.inlineobject.dita"
								>2013-04-30 - sub/inlineobject to figure/ref:inlineobject: Updated
								target sample according to latest Apollo markup.</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-dispformula-LxAdv-formula_ref.inlineobject.dita"
								>2013-04-30 - dispformula/inlineobject to formula/ref:inlineobject:
						...
						<li>
							<xref
								...
								p/figure/ref:inlineobject: Updated target sample according to latest
								Apollo markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-bodytext-LxAdv-bodytext_p_text_figure_ref.inlineobject.dita"
								>2013-04-30 - bodytext/inlineobject to
								bodytext/p/text/figure/ref:inlineobject: Updated target sample
								according to latest Apollo markup.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_p-limited_remotelink-LxAdv-p_text_ref.lnlink.dita"
								>2013-04-30 - p-limited/emph to p/text/emph: Updated target sample
								according to latest Apollo markup.</xref>
						</li>
						<li>
							<xref
			...
			<section>
				<title>Regulation (Version 5.0: PROD)</title>
				<p>2013-04-12 <ul>
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.assoc-links-LxAdv-doc.related-content.dita"
								>2013-04-12 - docinfo:assoc-links to doc:related-content: This
								module was changed from UKspecific to applicable to all LBUs</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_levelinfo_classification-LxAdv-SUPPRESS.dita"
								>2013-04-12 - levelinfo/classification
								@ln.user-displayed="false"/classitem
								@ln.user-displayed="false"/classitem-identifier/classname is
								SUPPRESSED: Temporary Note on Suppression inserted from Andrew
								Martin</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.authorattribution-LxAdv-dc.contributor.dita"
								>2013-04-10 - docinfo:authorattribution to dc:contributor:
								Created</xref>
						</li>
						<li>
							<xref
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.currencystatement-LxAdv-currencystatement.dita"
								>2013-04-09 - docinfo:currencystatement to
								doc:docinfo/currencystatement: Created</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_docinfo.lbu-meta-LxAdv-doc.legacy-metadata_metadatasource_lbu-meta-scheme.dita"
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_AU_NZ_docinfo.assoc-links-LxAdv-additional-rule.dita"
								>2013-04-03 - (AU-NZ) docinfo:assoc-links to doc:related-content:
								New module. Describes a special AU-NZ use case. Applies when a
								linking element is immediately followed by
									<sourcexml>text</sourcexml>. The pair map to a single
									<targetxml>doc:related-content-item</targetxml>. R4.5 Content
								issue #1125.</xref>
						</li>
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_blockquote-link-LxAdv-blockquote-p-text-ref.lnlink.dita"
								>2013-03-26 - blockquote/link to blockquote/p/text/ref:lnlink:
						...
						<li>
							<xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
								>2013-03-26 - link to ref:lnlink/@service="ATTACHMENT": Updated
								instruction and target example
									(<targetxml>proc:param/@value="pdf"</targetxml>) per project
								requirement.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita"
								>2013-03-26 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink:
								Updated target example
									(<targetxml>proc:param/@value="pdf"</targetxml>) per project
								requirement.</xref>
						</li>
				...
				<p>2013-03-14: <ul>
						...
						<li>
							<xref href="../../common_newest/Rosetta_date-LxAdv-date.dita">2013-03-08
								- date to date: Added instruction for @normdate attribute that falls
								on various NL date elements</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_remotelink-Chof-p-LxAdv-p_text_ref.crossreference.dita"
								>2013-03-07 - p/remotelink to p/text/ref:crossreference:
								Created.</xref>
						</li>
						<li>
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_blockquote-link-LxAdv-blockquote-p-text-ref.lnlink.dita"
								>2013-02-26 - blockquote/link to blockquote/p/text/ref:lnlink:
								Updated target example per project requirement.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_emp-Chof-heading_title-LxAdv-heading_title.dita"
								>2013-02-26 - heading/title/emph to heading/title: Created.</xref>
						</li>
						<li>
							<xref href="../../common_newest/Rosetta_link-LxAdv-ref.lnlink.dita"
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_bodytext-link-LxAdv-seclaw.bodytext-p-text-ref.lnlink.dita"
								>2013-02-26 - bodytext/link to seclaw:bodytext/p/text/ref:lnlink:
								Updated target example per project requirement.</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_blockquote-LxAdv-blockquote.dita"
								>2013-02-18 - blockquote to blockquote: Created two sections, one
								for "Release 4.0 and after" and another for "Pre-Release
								4.0".</xref>
						</li>
						<li>
							<xref href="../../common_newest/Rosetta_figure-LxAdv-figure.dita"
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_h-Chof-figure-glp.note-LxAdv-figure-note-bodytext-h.dita"
								>2013-02-18 - (Commentary &amp; Regulatroy) figure/glp:note/h to
								figure/note/bodytext/h: Created two sections, one for "Release 4.0
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-h-LxAdv-figure_ref.inlineobject.dita"
								>2013-02-18 - h/inlineobject to figure/ref:inlineobject: Created two
								sections, one for "Release 4.0 and after" and another for
								"Pre-Release 4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-emph-LxAdv-figure_ref.inlinobject.dita"
								>2013-02-18 - emph/inlineobject to figure/ref:inlineobject: Created
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-sub-LxAdv-figure_ref.inlineobject.dita"
								>2013-02-18 - sub/inlineobject to figure/ref:inlineobject: Created
								two sections, one for "Release 4.0 and after" and another for
								"Pre-Release 4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-glp.note-LxAdv-SUPPRESS.dita"
								>2013-02-18 - glp:note/inlineobject to: Created two sections, one
								for "Release 4.0 and after" and another for "Pre-Release
								4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-dispformula-LxAdv-formula_ref.inlineobject.dita"
								>2013-02-18 - dispformula/inlineobject to formula/ref:inlineobject:
								Created two sections, one for "Release 4.0 and after" and another
								for "Pre-Release 4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-p_blockquote-LxAdv-p_figure_ref.inlineobject.dita"
								>2013-02-18 - p/blockquote/inlineobject to
								p/figure/ref:inlineobject: Created two sections, one for "Release
								4.0 and after" and another for "Pre-Release 4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_inlineobject-Chof-bodytext-LxAdv-bodytext_p_text_figure_ref.inlineobject.dita"
								>2013-02-18 - bodytext/inlineobject to
								bodytext/p/text/figure/ref:inlineobject: Created two sections, one
								for "Release 4.0 and after" and another for "Pre-Release
								4.0".</xref>
						</li>
						<li>
							<xref
								href="../../common_newest/Rosetta_p-limited_remotelink-LxAdv-p_text_ref.lnlink.dita"
								>2013-02-18 - p-limited/emph to p/text/emph: Created two sections,
						...
						<li>
							<xref
								...
								mapping of <sourcexml>char-line[@character=" "]</sourcexml> to
									<targetxml>proc:formchars[@formchar="invisible"]</targetxml> so
								that the source element properly displays as
									<sourcexml>char-line[@character="&amp;nbsp;"]</sourcexml>.</xref>
						</li>
						<li>
							<xref href="../../common_newest/Rosetta_form-chars-LxAdv-formchars.dita"
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_refpt-Chof-level_heading_title-LxAdv-primlaw.level_OR_seclaw.level_ref.anchor.dita"
								>2012-12-07 - refpt child of level/heading/title to
								seclaw:level/ref:anchor, primlaw:level/ref:anchor and
								section/ref:anchor: Instruction and Example added:
						...
						<li>
							<xref
								href="../../common_newest/Rosetta_refpt-Chof-level_heading_title-LxAdv-primlaw.level_OR_seclaw.level_ref.anchor.dita"
								>2012-08-30 - refpt child of level/heading/title to
								seclaw:level/ref:anchor, primlaw:level/ref:anchor and
								section/ref:anchor: Created</xref>
						</li>
					</ul>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.17:PROD)</title>
				<p>2013-03-08:</p>
				<ul>
					<li>
						<xref
							href="../../common_newest/Rosetta_remotelink-Chof-p-LxAdv-p_text_ref.crossreference.dita"
							>2013-03-07 - p/remotelink to p/text/ref:crossreference: Created.</xref>
					</li>
					<li>
						<xref href="../../common_newest/Rosetta_edpnum-LxAdv-desig.dita">2013-03-06
							- edpnum to desig: Removed instructions/rules for exceptional desig
							scenario and deprecated attribute <targetxml>@followstitle</targetxml>.
							Added instructions for maintaining source document ordering.</xref>
					</li>
					<li>
						<xref href="../../common_newest/Rosetta_heading-LxAdv-heading.dita"
							>2013-03-06 - heading to heading: Removed instructions/rules for
					...
					<li><xref href="../../common_newest/Rosetta_date-LxAdv-date.dita">2013-03-08 -
							Added instruction for @normdate attribute that falls on various NL date
							elements</xref>.</li>
					<li>
						<xref href="Regulation-Body.dita">2013-03-08 - <sourcexml>index</sourcexml>
							instructions changed such that now a direct child
								<targetxml>ref:lnlink</targetxml> element is created within
								<targetxml>index:locator</targetxml> and the
								<targetxml>ref:marker</targetxml> and
								<targetxml>ref:locator</targetxml> are created within
								<targetxml>ref:lnlink</targetxml>.</xref>
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<p>2013-02-27: <ol>
						<li>BODY topic - Addition of conversion Instructions for handling
								<sourcexml>leg:status@statuscode</sourcexml>.</li>
						<li>COMMON topic - Addition of conversion Instructions for handling
								<sourcexml>heading/title/emph</sourcexml> (Refer
							Rosetta_emp-Chof-heading_title-LxAdv-heading_title.dita).</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.14:PROD)</title>
				<p>2012-12-05: <ol>
						<li>Added the section "Mapping to ID Data Type"</li>
						<li>Added rules for <targetxml>ref:returnreference</targetxml> in the
							footnote instructions.</li>
						<li>Added information about intra-document links to the General Markup
							instructions for <sourcexml>remotelink</sourcexml>.</li>
						<li>Instruction and example added for
								<sourcexml>leg:sectionlist/@id</sourcexml> when @id contains value
							"xxxxx_PROVLIST".</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.11:PROD)</title>
				<p>2012-09-25: <ol>
						<li>Instructions and example updated for handling General Markup elements
							like <sourcexml>remotelink</sourcexml>, <sourcexml>ci:cite</sourcexml>,
								<sourcexml>endnote</sourcexml> based on Project Kraken updates.</li>
						<li>Added attribute value
								<targetxml>navaid:navigationaid[@type="links"]</targetxml> for
							handling <sourcexml>leg:sectionlist</sourcexml> when it has information
							about "LawNow Home Page" and "Government Website". Instruction and
							example updated.</li>
					</ol>
				</p>
			</section>
			...
			<section>
				<title>Regulation (Version 4.9:PROD)</title>
				<p>2012-08-14 <ol>
						<li><b>Common</b>: Added <targetxml>footnotegroup</targetxml> element to
							content model for handling of <sourcexml>footnotes</sourcexml> markup.
							Refer <xref
								href="../../common_newest/Rosetta_footnote-LxAdv-footnote.dita"
								>footnotegrp &amp; footnote</xref>.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.8:PROD)</title>
				<p>2012-08-06 <ol>
						<li><b>Common</b>: Updated the instruction and example for handling of
								<sourcexml>footnote</sourcexml> markup.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.8:PROD)</title>
				<p>2012-07-30: <ol>
						<li><b>Body</b>: - Added a note and example for handling of
								<sourcexml>leg:histnote/leg:histnote</sourcexml> scenario.</li>
						<li><b>Body</b>: - Added a example for handling of
								<sourcexml>leg:preamble/leg:bodytext</sourcexml> scenario.</li>
						<li><b>Common</b>: Updated the instruction and example for handling of
								<sourcexml>leg:endmatter/index/heading/title/refpt</sourcexml>
							scenario.</li>
						<li><b>Common</b>: Added instruction regarding adding sibling
								<sourcexml>classify:classcode</sourcexml> elements.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.7:PROD)</title>
				<p>2012-07-13: <ol>
						<li><b>Body</b>: - Updated the instruction and example for handling of
								<sourcexml>leg:endmatter/index/heading/title/refpt</sourcexml>
							scenario.</li>
						<li><b>Common</b>: - Modified instruction for
								<sourcexml>glp:note/remotelink</sourcexml> handling when
								<sourcexml>remotelink@service="DOC-ID"</sourcexml>.</li>
						<li><b>Common</b>: - Added instructions to merge data into a single heading
							element when 2 or more consecutive sibling source elements map to
							heading.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.6:PROD)</title>
				<p>2012-06-21: <ol>
						<li><b>Body</b>: - Added note for handling of
								<sourcexml>leg:officialname/@ln.user-displayed="false"</sourcexml>
							and
							<sourcexml>leg:officialnum/@ln.user-displayed="false"</sourcexml>.</li>
						<li><b>Common</b>: - Added instruction and example for handling
								<sourcexml>leg:officialname[@ln.user-displayed="false"]</sourcexml>
							and
							<sourcexml>leg:officialnum[@ln.user-displayed="false"]</sourcexml>.</li>
						<li><b>Common:</b> - Added Instructions and example for handling of
								<sourcexml>leg:comntry</sourcexml>.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.5:PROD)</title>
				<p>2012-06-19: <ol>
						<li><b>Common</b>: - Updated the Instructions and examples for
								<sourcexml>endnotes</sourcexml> handling as per link
							resolution.</li>
						<li><b>Common</b>: - Added a rule for handling of
								<sourcexml>remotelink/sub</sourcexml>.</li>
						<li><b>Body:</b> - Update Instructions and example for handling of
								<sourcexml>leg:relatedleg[@type="parent"]</sourcexml>.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.4:PROD)</title>
				<p>2012-05-28: <ol>
						<li><b>Body:</b> - Added a note for handling the
			...
			<section>
				<title>Regulation (Version 4.4:PROD)</title>
				<p>2012-05-25: <ol>
						<li><b>Head:</b> - Update Instruction and Added a note if the input
							documents is having no <sourcexml>leg:juris</sourcexml>.</li>
						<li><b>Body:</b> - Update the Instruction and example for handling
								"<sourcexml>@ln.user-displayed</sourcexml>".</li>
						<li><b>Body:</b> - Added a Instruction and Example of handling
								<sourcexml>leg:levelprelim</sourcexml>.</li>
						<li><b>Body:</b> - Added '<b>agreement</b>', '<b>procedural-guide</b>',
								'<b>regulatory-code</b>' to list of attribute values in
								<targetxml>primlaw:level[@leveltype]</targetxml> for AU.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.3:PROD)</title>
				<p>2012-05-14: <ol>
						<li>GENERAL Markup - added instruction for handling currency statements in
								<sourcexml>bodytext</sourcexml></li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.3:PROD)</title>
				<p>2012-05-11: <ol>
						<li>Introduction topic - Update the Instruction of root element.</li>
						<li>Introduction topic - Added a note for handling of NZ Content stream in
							AU Regulation CI.</li>
						<li>BODY topic - fixed the note regarding handling
								<sourcexml>table</sourcexml> with one <sourcexml>entry</sourcexml>
							under the rule for <sourcexml>leg:sectionlist</sourcexml> having
							@id.</li>
					</ol>
				</p>
			</section>
			...
			<section>
				<title>Regulation (Version 4.3:PROD)</title>
				<p>2012-05-07: <ol>
						<li>BODY topic - Added <targetxml>ref:anchor</targetxml> to the content
							model of <targetxml>primlawhist:primlawhist</targetxml>.Instructions
							added for the same. Refer <xref
								href="../../common_newest/Rosetta_refpt-Chof-leg.history_heading_title-LxAdv-primlawhist.primlawhist_ref.anchor.dita"
								>refpt</xref>.</li>
						<li>BODY topic - Updation of Conversion Instruction for
								<sourcexml>leg:prelim/leg:comntry</sourcexml>.</li>
						<li>BODY topic - Updation of Conversion Instruction for
								<sourcexml>leg:prelim/leg:history</sourcexml>.</li>
						<li>BODY topic - Added example for handling of
								<sourcexml>leg:sectionlist</sourcexml> having multiple tables.</li>
						<li>BODY topic - Fixed target example as per remotelink instructions to use
								<targetxml>ref:crossreference</targetxml>. Refer <xref
								href="../../common_newest/Rosetta_remotelink-LxAdv-ref.crossreference.dita"
								>remotelink</xref>.</li> <li>METDATA - Made
								<targetxml>doc:sourcedocinfo</targetxml> as optional child.</li>
						<li>GENERAL Markup - Instruction and example updated for handling
								<targetxml>url</targetxml>. Refer <xref
								href="../../common_newest/Rosetta_remotelink-LxAdv-ref.crossreference.dita"
								>remotelink</xref>.</li>
						<li>GENERAL Markup - Updated the instruction and example for handling of
								"<b>fnr appears without footnote</b>". Refer <xref
								href="../../common_newest/Rosetta_footnote-LxAdv-footnote.dita"
								>footnotegrp &amp; footnote</xref>.</li>
						<li>GENERAL Markup - Added General instructions for handling of
								<sourcexml>leg:officialname/@ln.user-displayed="false"</sourcexml>
							and
							<sourcexml>leg:officialnum/@ln.user-displayed="false"</sourcexml>.</li>
					</ol>
			...
			<section>
				<title>Regulation (Version 4.2:PROD)</title>
				<p>2012-04-23: <ol>
						<li>BODY topic - Added Conversion Instructions for handling
								<sourcexml>leg:info</sourcexml>.</li>
						<li>HEAD topic - Removed Conversion Instructions for handling
								<sourcexml>leg:info</sourcexml>.</li>
						<li>BODY topic - Updation of Conversion Instructions for
								<sourcexml>leg:comntry</sourcexml>.</li>
						<li>BODY topic - Added <targetxml>ref:anchor</targetxml> to the content
							model of <targetxml>primlaw:subordinatelaw</targetxml>.</li>
						<li>GENERAL MARKUP- Added a note for handling
								<targetxml>ref:anchor</targetxml> if the <sourcexml>id</sourcexml>
							value of same matches with <targetxml>@xml:id</targetxml>.(Refer
							refpt)</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 4.1:PROD)</title>
				<p>2012-04-09: <ol>
						<li>Body: Instruction updated for handling <sourcexml>leg:empleg</sourcexml>
							element.</li>
						<li>Instruction added in inlineobject for the conversion of icon
								<sourcexml>au_noforce.gif</sourcexml>.</li>
					</ol>
				</p>
			</section>

			<section>
				<title>Regulation (Version 4.0:PROD)</title>
				<p>2012-04-02: <ol>
						<li>Added <targetxml>deflist</targetxml> within <targetxml>entry</targetxml>
							element.</li>
						<li>Make <targetxml>regulation:prelim</targetxml> optional within
								<targetxml>regulation:body</targetxml>.</li>
						<li>Instruction and example updated for handling
								<sourcexml>leg:bodytext</sourcexml>.</li>
						<li>Instruction updated for handling <sourcexml>leg:juris</sourcexml>.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 3.1:PROD)</title>
				<p>2012-03-21<ol>
						<li>Added multiple <targetxml>defterm</targetxml> and
								<targetxml>defdesc</targetxml>.</li>
						<li>Added <targetxml>h</targetxml> within <targetxml>entry</targetxml> and
							also intruction updated.</li>
						<li>Added <targetxml>label</targetxml> within
								<targetxml>footnote</targetxml> and
								<targetxml>footnoteref</targetxml>.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 3.0:PROD)</title>
				<p>2012-03-12: <ol>
						<li>Added: Instruction and example added to handle
								<sourcexml>alttitle</sourcexml>.</li>
						<li>Updated: Update the instruction and example for handling of
								<sourcexml>index</sourcexml> markup.</li>
						<li>Updated: Updated instruction and example for handling of
								<sourcexml>leg:sectionlist</sourcexml> when
								<sourcexml>id="XXXX_PROVLIST"</sourcexml>.</li>
						<li>Added: <targetxml>ref:crossreference</targetxml> to the content model of
			...
			<section>
				<title>Regulation (Version 2.3:PROD)</title>
				<p>2012-03-02<ol> <li>Added: <targetxml>note</targetxml> to the content model of
			...
			<section>
				...
				<title>Regulation (Version 2.2:PROD)</title>
				<p>2012-03-01<ol>
						<li>Added: <targetxml>@includeintoc</targetxml>,
								<targetxml>@alternatetoccaption</targetxml> in elements
							primlaw:level, annot:annotations, annot:annotationgrp, annot:annotation,
							annot:annotation-level and primlaw:prelim. And update the CI's
							examples.</li>
						<li>Added: <targetxml>ref:anchor</targetxml> to the content model of
								<b>listitem</b> and <b>entry</b>.</li>
						<li>Added: <targetxml>@reftype</targetxml> attribute in
								<targetxml>footnote-ref</targetxml> element.</li>
						<li>Added: <targetxml>@leveltype="campanion"</targetxml> attribute value in
								<targetxml>primlaw:level</targetxml> element.</li>
						<li>Added: The Conversion Instruction of
								<targetxml>primlawinfo:dates</targetxml> and
								<targetxml>primlawinfo:effdate</targetxml> elements.</li>
						<li>Added: <targetxml>endnotes</targetxml> as an optional child of
								<targetxml>primlaw:level</targetxml>.</li>
						<li>Added: Instruction and example added for handling
								<targetxml>endnote</targetxml> stuff i.e when
								<sourcexml>refpt</sourcexml> and <sourcexml>remotelink</sourcexml>
							occurs as adjacent sibling (Refer endnote).</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 2.1:PROD)</title>
				<p>2012-02-07<ol>
						<li>Updated: Change/Updated the Examples, conversion instruction for
								<sourcexml>leg:sectionlist</sourcexml> and its child element.</li>
						<li>Added: <targetxml>navaid:navigationaid</targetxml> to the content model
							of <targetxml>primlaw:level</targetxml> for mapping input element
								<sourcexml>index</sourcexml> and its child. Example and instruction
							added.</li>
						<li>Added: <targetxml>annot:annotations</targetxml> and
								<targetxml>note</targetxml> to the content model of
								<targetxml>defitem</targetxml>.</li>
						<li>Added: <targetxml>figure</targetxml> element added to the content model
							of <targetxml>p</targetxml> for mapping input xpath
								<sourcexml>p/figure</sourcexml>.</li>
						<li>Added: <targetxml>proc:nl</targetxml> added as an optional child element
							of <targetxml>title</targetxml> and
							<targetxml>subtitle</targetxml>.</li>
						<li>Added: Allow <targetxml>desig</targetxml> and
								<targetxml>altdesig</targetxml> to appear in any order and either
							before or after the <targetxml>title</targetxml> wihin
								<targetxml>heading</targetxml> element.</li>
						<li>Added: <targetxml>@align</targetxml> attribute added as a optional in
								<targetxml>figure</targetxml> for alignment.</li>
						<li>Added: <targetxml>ref:inlineobject</targetxml> and
								<targetxml>ref:lnlink</targetxml> elements added as a optional to
							the content model <targetxml>formula</targetxml>.</li>
						<li>Updated: Attribute <targetxml>@ln.userdisplayed="false"</targetxml>
							handling conversion instruction has been updated.</li>
					</ol>
				</p>
			</section>
			<section>
				<title>Regulation (Version 2.0:PROD)</title>
				<p>2012-01-30: <ol>
						<li>Updated: Example and instruction for
								<sourcexml>leg:levelinfo/leg:levelstatus</sourcexml> which maps to
								<targetxml>legisinfo:statusgroup</targetxml> and its child
							element.</li>
						<li>Added: <targetxml>ref:crossreferencegroup</targetxml> and its child to
							the content model. Example and instruction included to map
								<sourcexml>remotelink[@service="DOC-ID"]</sourcexml> and also for
								<sourcexml>remotelink/sup</sourcexml>.</li>
						<li>Added: <targetxml>ref:anchor</targetxml> to the content model of
								<targetxml>defterm</targetxml></li>
						<li>Added: ref:anchor to the content model of
								<targetxml>annot:annotation</targetxml> and
								<targetxml>annot:annotationlevel</targetxml></li>
						<li>Added: <targetxml>leveltype</targetxml> values 'order', 'dictionary',
							'introduction', 'instrument', 'subregulation', 'subschedule' to
								<targetxml>primlaw:level</targetxml>.</li>
						<li>Added: instruction for handling of
								<sourcexml>leg:officialname/refpt</sourcexml> scenario.</li>
						<li>Added: <targetxml>note</targetxml> and <targetxml>list</targetxml> to
							the content model of <targetxml>entry</targetxml>.</li>
						<li>Added: connector to the content model of
							<targetxml>defitem</targetxml>.</li>
						<li>Added: <targetxml>figure</targetxml> to the content model of
								<targetxml>text</targetxml> and <targetxml>entry</targetxml>.</li>
						<li>Bug fix change, <targetxml>ref:content</targetxml> allows PCDATA.</li>
						<li>Added: <targetxml>index:index</targetxml> to the content model of
								<targetxml>primlaw:level</targetxml> for mapping input element
								<sourcexml>index</sourcexml> and its child. Example and instruction
							added.</li>
					</ol>
				</p>
			...
			<section>
				<title/>
				<p>2012-01-17: <ol>
						<li>Head/Body - Deleted the change request (CR) numbers which are
							impleamented in 13/01/2011 NL Regulation schema release.</li>
						<li>Head - Updated the instruction and examples of 'leg:status' element in
							CI.</li>
						<li>Head - 'leg:juris' will be suppressed from conversion because GNCODE
							will populate this data as required.</li>
						<li>Body - Upadted and deleted the attributes '@toc-caption' and '@subdoc'
							of primlaw:level element in CI.</li>
						<li>Body - Updated instruction and example for handling
							'leg:levelinfo/leg:levelstatus' in CI.</li>
						<li>Body - Updated NL example for leg:histcite, leg:tableofamend and
							leg:sectionlist based on latest schema for handling remotelink
							element.</li>
					</ol>
				</p>
			</section>
			<section>
				<title/>
				<p>2011-12-28: <ol>
						<li>Common topic - Added the phrase ["common elements"] to the instructions
							for all of the common elements.</li>
					</ol>
				</p>
			</section>
			<section>
				<title/>
				<p>2011-12-22: <ol>
						<li>Body topic - Update the example for 'leg:history' element.</li>
					</ol>
				</p>
			</section>
			<section>
				<title/>
				<p>2011-12-21: <ol>
						<li>Body topic - Update the conversion instruction for
							'leg:sectionlist'.</li>
						<li>Body topic - Update the conversion instruction for
							'leg:relatedleg'.</li>
						<li>Body topic - Update the conversion instruction for
			...
			<section>
				<title/>
				<p>2011-12-19: <ol>
						<li>Body topic - Update the conversion instruction for handling
							'legfragment/blockquote' element.</li>
						<li>Body topic - Update the conversion instruction for handling
							'leg:levelstatus'.</li>
						<li>Body topic - Update the conversion instruction for 'tableofamend'.</li>
					</ol>
				</p>
			</section>
			<section>
				<title/>
				<p>2011-12-06: <ol>
						<li>HEAD topic - Addition of Example for "location: territory" in CI's and
							correct typo's mistakes in CI's.</li>
						<li>HEAD topic - Update the Conversion Instruction of Introduction
							part.</li>
					</ol>
				</p>
			</section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU06_Regulation\Regulation-change-log.dita  -->
