...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" 
  ...
  xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:frm="http://www.lexis-nexis.com/glp/frm" xmlns:glp="http://www.lexis-nexis.com/glp" xmlns:source_lnci="http://www.lexis-nexis.com/lnci" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:decision="http://www.lexisnexis.com/xmlschemas/content/legal/decision/1/" xmlns:form="http://www.lexisnexis.com/xmlschemas/content/shared/form/1/" xmlns:proc="http://www.lexisnexis.com/xmlschemas/content/shared/process-elements/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita ci docinfo frm glp lnci">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="commentary_from_acts-change-log">
  <title>Change Log for Commentary From Acts</title>
  <body>
    <section>
    ...
    <section>
      <title>Legislation 8.2_PROD</title>
      <p>2013-08-09 BRT: <ul>
          <li>
            <xref href="../../common_newest/Rosetta_docinfo-LxAdv-doc.metadata_doc.docinfo.dita">2013-08-09 - docinfo to doc:metadata/doc:docinfo: Added instruction for creating
                <targetxml>dc:date[@lnmeta:datetype="conversion-date"]</targetxml>. This element
              will be added to deliveries going forward, as of inclusion in the CI. It is not
              necessary to add the element retroactively.</xref>
          </li>
          <li>
          ...
          <li>
            <xref href="../../common_newest/Rosetta_remotelink-self-inter-document-link-LxAdv-intra-document-link.dita">2013-08-08 Added General mapping instruction for the conversion of intra-document
              links that are delivered as inter-document links. </xref>
          </li>
          <li>
    ...
    <section>
      ...
      <p>2013-03-22 <ol>
          <li>
            <xref href="../../common_newest/Rosetta_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.dita">2013-03-21 - ci:content/remotelink/inlineobject to lnci:content/ref:crossreference:
              Created.</xref>
          </li>
          <li>
    ...
    <section>
      <p>2012-08-09<ul>
          <li>No changes were made directly to NZ Comm. This PDF is being produced to incorporate
            changes to the common modules.</li>
        </ul></p>
    </section>
    <section>
      <p>2012-06-04<ul>
          <li>Updated the values for level[@leveltype=”xxx”] adding group </li>
          <li>Updated instruction for comm:body/level/bodytext/p/text/ci:cite/ci:content to include
            the primlaw:bodytext level in xpath</li>
        </ul></p>
    </section>
    <section>
      <p>2012-05-11<ul>
    ...
    <section>
      <p>2012-04-09<ul>
          <li>Added rules for list occuring within listitem</li>
          <li>Added special example for NZ Comm for "{target.root.element}".</li>
          <li>Added rule for and example for legis:head/jurisinfo:legisbodyinfo.</li>
          <li>Updated general rule level/heading/title/refpt to include primlaw:level</li>
        </ul></p>
    </section>
    <section>
      <p>2012-03-14<ul>
          <li>Commentary From Acts Conversion Instructions Created</li>
        </ul></p>
    </section>
  </body>
	</dita:topic>
