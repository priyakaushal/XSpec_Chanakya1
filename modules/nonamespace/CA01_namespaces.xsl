...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-CA01-12209</lnpid></title>
  <body>
    <ul>      
      <li>xmlns:ext="http://exslt.org/common"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA01-Cases\CA01_namespaces.dita  -->
  <xsl:variable name="lexisAdvNamespaces" as=" element() ">
    <lexisAdvNamespaces>
      ...
      <lexisAdvNamespace>xmlns:legisoutlook="urn:x-lexisnexis:content:legislative-outlook:sharedservices:1"</lexisAdvNamespace>  
