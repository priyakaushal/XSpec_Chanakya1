...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" version="2.0" exclude-result-prefixes="dita case">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Rosetta_case.disposition_ln.user-displayed">
  <title><sourcexml>case:disposition/@ln.user-displayed="false"</sourcexml> <lnpid>id-CCCC-10260</lnpid></title>
  <body>
    <section>
      ...
      <p>If <sourcexml>case:disposition</sourcexml> has attribute <sourcexml>@ln.user-displayed="false"</sourcexml> then suppress it.</p>
