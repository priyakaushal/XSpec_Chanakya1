...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <body>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN09-Courtrules\courtrule_Namespaces.dita  -->
	<xsl:message>IN09-Courtrules_courtrule_Namespaces.xsl requires manual development!</xsl:message> 
