...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:dict="urn:x-lexisnexis:content:dict:sharedservices:1" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita">
    ...
    <title>Introduction <lnpid>id-MY09-17809</lnpid></title>
    <shortdesc>This document describes the conversion of Malaysian dictionary
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY09_Dictionary\dictionary-Introduction.dita  -->
	<xsl:message>MY09_Dictionary_dictionary-Introduction.xsl requires manual development!</xsl:message> 
