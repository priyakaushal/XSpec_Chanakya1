...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita docinfo">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK12_Treatise_alt.rendition-ref.marker">
	    <title><sourcexml>docinfo:alt-rendition/link or lnlink</sourcexml> <lnpid>id-UK12-29824</lnpid></title>
    <body>
...
&lt;/doc:metadata>      
        ...
        <section>
            ...
            <p>2016-12-14: <ph id="change_20161214_JM">Not a rule change directly to this module. Modified Example Target
                to reflect blobstore markup for ref:lnlink; changed casing at value="BlobStore", making S upper case.</ph></p>
            <p>2016-08-01: <ph id="change_20160801_JM">Not a rule change directly to this module. Modified Example Target
                to reflect blobstore markup.</ph></p>
            <p>2014-09-03: <ph id="change_20140903_jm">New rule. Handles
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK12-Treatise\UK12_Treatise_alt.rendition-ref.marker.dita  -->
<!--	<xsl:message>UK12_Treatise_alt.rendition-ref.marker.xsl requires manual development!</xsl:message> -->
