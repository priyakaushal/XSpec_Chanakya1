...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" 
	...
	version="2.0" exclude-result-prefixes="dita comm ci xsi">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Comm-Form-Pre_Introduction">
    <title>Introduction <lnpid>id-AU05-18812</lnpid></title>
    <body>
        ...
        <section>
            <title>Changes</title>
            <p>2016-08-04: <ph id="change_20160804_RS">Update schema to 8.14 Prod.</ph></p>
        </section>
    </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU05_Comm_Form_Prec\Comm-Form-Pre_Introduction.dita  -->
