...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Rosetta_NZ-Newsitem_title_ci.cite_nl-LxAdv-title_lnci-cite">
    <title><sourcexml>title/ci:cite/nl</sourcexml> to <targetxml>title/lnci:cite</targetxml> <lnpid>id-CCCC-10409</lnpid></title>
    <body>
        <section>
            ...
            <p>If the source document is having <sourcexml>heading/title/ci:cite/nl</sourcexml> within <sourcexml>level</sourcexml>. This is a <b>Data Error</b>. LBU is correcting this Rosetta markup and will have updated content in time for the full content conversion load. In this mean time, <sourcexml>nl</sourcexml> element should be dropped in target conversion. Please refer the below markup for more understanding this scenario.</p>
        </section>
...
&lt;/bodytext&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\common_newest\Rosetta_NZ-Newsitem_title_ci.cite_nl-LxAdv-title_lnci-cite.dita  -->
	<xsl:message>Rosetta_NZ-Newsitem_title_ci.cite_nl-LxAdv-title_lnci-cite.xsl requires manual development!</xsl:message> 

	<xsl:template match="title/ci:cite/nl">

		<!--  Original Target XPath:  title/lnci:cite   -->
		<title>
	...
	<xsl:template match="heading/title/ci:cite/nl">
