...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="PH02_Statcode-Namespaces">
  <title>Namespaces <lnpid>id-PH02-33221</lnpid></title>
  <body>
<ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\PH02-Statcode\PH02_Statcode-Namespaces.dita  -->
	<xsl:message>PH02_Statcode-Namespaces.xsl requires manual development!</xsl:message> 
