...
&lt;/primlaw:level&gt;
    ...
    <xsl:variable name="Citation_Language">
        <codes>
            ...
            <code key="Règl. du N.-B." value="English Version"/>
            <code key="RSQ" value="English Version"/>
            <code key="S. Reg." value="English Version"/>
            <code key="R.R.S. c. S-15.1," value="English Version"/>
            <code key="Sask. O.C." value="English Version"/>
            <code key="Y.O.I.C." value="English Version"/>
            <code key="Y.C.O." value="English Version"/>
            <code key="Y.F.S.O." value="English Version"/>
            <code key="Y.M.O." value="English Version"/>
            <code key="Y.S.F.V.O." value="English Version"/>
            <code key="Y.W.C.B.O." value="English Version"/>
        </codes>
    </xsl:variable>
    ...
    <!--<xsl:template match="ci:content" mode="doc-related">
        ...
        <xsl:choose>
            <xsl:when test="$dpsi=$dpsi_restricted/*:codes/*:code/@*:key"/>
            <xsl:otherwise>
    ...
    <xsl:template match="leg:officialnum[not(child::ci:cite)][not(preceding-sibling::leg:num[child::ci:cite])]" mode="doc_related_content_officialnum">
