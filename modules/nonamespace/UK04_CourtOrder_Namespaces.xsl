...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="#all">
  ...
  <title>Namespaces <lnpid>id-UK04-27631</lnpid></title>
  <body>  
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK04_CourtOrder\Namespaces.dita  -->
<!--	<xsl:message>UK04_CourtOrder_Namespaces.xsl requires manual development!</xsl:message> -->
  <xsl:variable name="lexisAdvanceNamespaces" as=" element() ">
    <lexisAdvanceNamespaces>
      ...
      <lexisAdvanceNamespaces>xmlns:courtorder="urn:x-lexisnexis:content:courtorder:sharedservices:1"</lexisAdvanceNamespaces>
      ...
      <lexisAdvanceNamespaces>xmlns:legis="http://www.lexisnexis.com/xmlschemas/content/legal/legislation-info/1/"</lexisAdvanceNamespaces>
      ...
      <lexisAdvanceNamespaces>xmlns:seclaw="http://www.lexisnexis.com/xmlschemas/content/legal/secondary-law/1/"</lexisAdvanceNamespaces>
    </lexisAdvanceNamespaces>
