...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="PH01_Legis-Namespaces">
  <title>Namespaces <lnpid>id-PH01-33420</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\PH01-Legislation\PH01_Legis-Namespaces.dita  -->
	<xsl:message>PH01_Legis-Namespaces.xsl requires manual development!</xsl:message> 
