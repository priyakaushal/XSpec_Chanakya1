...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/"
		id="UK08_OPDOC_alt.rendition-ref.marker">
		<title><sourcexml>docinfo:alt-rendition/link</sourcexml> without text
				<lnpid>id-UK08OR-28821</lnpid></title>
		<body>
...
&lt;/doc:metadata>				
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK08_Quasi\UK08OR_QUASI_OPDOC_To_Regulation\UK08_OPDOC_alt.rendition-ref.marker.dita  -->

	<xsl:template match="docinfo:alt-rendition/link">
		<!-- TODO: plug in -->
		<!--  Original Target XPath:  ref:marker   -->
		<ref:marker>
			<xsl:apply-templates select="../docinfo:alt-renditions/preceding-sibling::docinfo:doc-heading"/>
		</ref:marker>
