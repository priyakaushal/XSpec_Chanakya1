...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:courtrule="http://www.lexisnexis.com/xmlschemas/content/legal/courtrule/1/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita docinfo">
    ...
    <title>Introduction <lnpid>id-IN09-38008</lnpid></title>
    ...
    <body>
       ...
       <title>Root Element</title>
                    ...
                    <p>
                <sourcexml>LEGDOC</sourcexml> become <targetxml>courtrule:courtrule</targetxml>
                which is a root element for rules and attributes are populated as follows: <ul>
                    <li>
                        <p>Identification Criteria for <b>IN09 CourtRule</b> content stream is value
                            of <sourcexml>docinfo:selector</sourcexml> which is
                                <sourcexml>rule</sourcexml>.</p>
                    </li>
                    <li>
                        <sourcexml>LEGDOC</sourcexml> becomes
                            <targetxml>courtrule:courtrule</targetxml>
                        &lt;LEGDOC&gt;
                        <b>becomes</b>
                        &lt;courtrule:courtrule&gt;
                    </li>
                    <li>
                        <sourcexml>LEGDOC[@id]</sourcexml> becomes
                            <targetxml>courtrule:courtrule[@xml:id]</targetxml> provides a unique
                        identifier for this element. &lt;LEGDOC id="ACT_REG_2008-46"&gt;
                        <b>becomes</b>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN09-Courtrules\courtrule-Introduction.dita  -->
	<xsl:message>IN09-Courtrules_courtrule-Introduction.xsl requires manual development!</xsl:message> 
