...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-MY01-16012</lnpid></title>
  <body>
    <ul>
<li>xmlns="http://www.lexisnexis.com/xmlschemas/content/shared/base/1/"</li>
<li>annot="http://www.lexisnexis.com/xmlschemas/content/shared/annotations/1/"</li>
...
<li>xmlns:topic="urn:x-lexisnexis:content:topic:global:1"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY01_Cases\Caselaw_Namespaces.dita  -->
	<xsl:message>MY01_Cases_Caselaw_Namespaces.xsl requires manual development!</xsl:message> 
