...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="IN05_JournalArticles_namespaces">
  <title>Namespaces <lnpid>id-IN05-38808</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN05-Articles\IN05_JournalArticles_namespaces.dita  -->
	<xsl:message>IN05_JournalArticles_namespaces.xsl requires manual development!</xsl:message> 
