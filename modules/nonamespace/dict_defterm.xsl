...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:source_dict="http://www.lexis-nexis.com/glp/dict" xmlns:tei="http://www.tei-c.org/ns/1.0/" version="2.0" exclude-result-prefixes="dita dict">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="dict_defterm">
    <title><sourcexml>defterm</sourcexml> to <targetxml>tei:form/tei:orth</targetxml> <lnpid>id-ST06-31209</lnpid></title>
    <body>
        <section>
          ...
          <ul>
           ...
           <note>Refer to <xref href="dict_subtopic.dita"/> for additional instruction on handling subtopics</note>
...
&lt;/dict:term-entry&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Dictionary\dict_defterm.dita  -->
	<xsl:message>dict_defterm.xsl requires manual development!</xsl:message> 
