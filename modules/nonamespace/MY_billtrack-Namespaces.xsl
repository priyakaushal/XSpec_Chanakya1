...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="MY_billtrack-Namespaces">
  <title>Namespaces <lnpid>id-MY05LB-16824</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY05LB_Bills\MY_billtrack-Namespaces.dita  -->
	<xsl:message>MY_billtrack-Namespaces.xsl requires manual development!</xsl:message> 
