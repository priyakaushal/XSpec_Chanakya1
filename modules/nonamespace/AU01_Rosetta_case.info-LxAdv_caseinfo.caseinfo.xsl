...
<xsl:stylesheet 
  ...
  version="2.0" exclude-result-prefixes="dita case">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="AU01_Rosetta_case.info-LxAdv_caseinfo.caseinfo">
  <title>case:info <lnpid>id-AU01-18224</lnpid></title>
  <body>
