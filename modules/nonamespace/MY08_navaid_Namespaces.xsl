...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-MY08-17623</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY08_navaid\Namespaces.dita  -->
	<xsl:message>MY08_navaid_Namespaces.xsl requires manual development!</xsl:message> 
