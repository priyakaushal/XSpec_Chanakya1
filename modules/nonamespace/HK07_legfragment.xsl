...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="HK07_legfragment">
  <title><sourcexml>legfragment</sourcexml> <lnpid>id-HK07-37414</lnpid></title>
  <body>
    <section>
    ...
    &lt;legfragment&gt;
        &lt;leg:level&gt;
            &lt;leg:level-vrnt leveltype="rule"&gt;
                &lt;leg:levelbody&gt;
                    &lt;leg:level&gt;
                        &lt;leg:level-vrnt leveltype="rul" subdoc="true" toc-caption="1. Citation"&gt;
                            ...
                            &lt;leg:levelbody&gt;
                                &lt;leg:bodytext&gt;
                                    &lt;p&gt;
                                        &lt;text&gt;These rules may be cited as the High Court Fees
                                            Rules.&lt;/text&gt;
                                    &lt;/p&gt;
                                &lt;/leg:bodytext&gt;
                            &lt;/leg:levelbody&gt;
...
&lt;seclaw:bodytext&gt;
    &lt;primlaw:excerpt&gt;
        &lt;primlaw:level leveltype="rule"&gt;
            &lt;primlaw:level includeintoc="true" alternatetoccaption="1. Citation"
                leveltype="rule"&gt;
                &lt;heading inline="true"&gt;
                    &lt;desig&gt;1.&lt;/desig&gt;
                    &lt;title&gt;Citation&lt;/title&gt;
                ...
                &lt;primlaw:bodytext&gt;
                    &lt;p&gt;
                        &lt;text&gt;These rules may be cited as the High Court Fees Rules.&lt;/text&gt;
                    &lt;/p&gt;
                &lt;/primlaw:bodytext&gt;
            &lt;/primlaw:level&gt;
        &lt;/primlaw:level&gt;
...
&lt;/seclaw:bodytext&gt;        
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-HK\HK07_Commentary\HK07_legfragment.dita  -->
    ...
    <xsl:template match="leg:level-vrnt[parent::leg:level]">
   ...
   <!-- <xsl:template name="fragment_leveltype">
        <xsl:attribute name="leveltype">
            <xsl:choose>
                <xsl:when test="./@leveltype">
                    <xsl:value-of select="@leveltype"/>
                </xsl:when>
