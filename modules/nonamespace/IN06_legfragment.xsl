...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:primlaw="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw/1/" version="2.0" exclude-result-prefixes="dita leg">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="IN06_legfragment">
  <title><sourcexml>legfragment</sourcexml> <lnpid>id-IN06-38016</lnpid></title>
  <body>
    <section>
            ...
            &lt;leg:levelbody&gt;
                &lt;leg:comntry&gt;
                    &lt;bodytext searchtype="COMMENTARY"&gt;
                        &lt;p&gt;
                            &lt;text&gt;The giving of reasons is one of the fundamentals...&lt;/text&gt;
                        &lt;/p&gt;
                    &lt;/bodytext&gt;
                &lt;/leg:comntry&gt;
            &lt;/leg:levelbody&gt;
...
&lt;/primlaw:excerpt&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN06-Commentary\IN06_legfragment.dita  -->
	<xsl:message>IN06_legfragment.xsl requires manual development!</xsl:message> 
