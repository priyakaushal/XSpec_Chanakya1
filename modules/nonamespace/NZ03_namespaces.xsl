...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="#all">
  ...
  <title>Namespaces <lnpid>id-NZ03-23009</lnpid></title>
  <body>
    <ul>
      ...
      <li>xsi:schemaLocation="http://www.lexisnexis.com/xmlschemas/content/legal/courtcase/1/ http://www.lexisnexis.com/xmlschemas/content/legal/courtcase/1/sch_courtcase.xsd"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ03_CaseLaw\NZ03_namespaces.dita  -->
	<!--<xsl:message>NZ03_namespaces.xsl requires manual development!</xsl:message> -->
  <!--SS: Done - NZ03_Namespaces.xsl-->
  <xsl:variable name="lexisAdvNamespaces" as="element()">
    <lexisAdvNamespaces>
      ...
      <lexisAdvNamespace>xmlns:xs="http://www.w3.org/2001/XMLSchema"
      </lexisAdvNamespace>
