...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-IN03-39011</lnpid></title>
  <body>
    <ul>
...
<li>xmlns:topic="urn:x-lexisnexis:content:topic:global:1"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN03_Cases\Caselaw_Namespaces.dita  -->
	<xsl:message>Caselaw_Namespaces.xsl requires manual development!</xsl:message> 
