...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita">
    ...
    <title>lnlink <lnpid>id-RU02-32024</lnpid>
    </title>

    <body>
        <p>
            <sourcexml>lnlink</sourcexml> becomes <targetxml>ref:lnlink</targetxml> and attribute
                <sourcexml>lnlink/@service</sourcexml> becomes
                <targetxml>ref:lnlink/@service</targetxml>.</p>
...
&lt;/doc:metadata&gt;</pre>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\RU02\RU02-lnlink.dita  -->
	<xsl:message>RU02-lnlink.xsl requires manual development!</xsl:message> 
	...
	<xsl:template match="lnlink/@service">
		...
		<!--  Original Target XPath:  ref:lnlink/@service   -->
		<ref:lnlink>
