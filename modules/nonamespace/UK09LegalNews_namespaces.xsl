...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK09LegalNews_namespaces">
    <title>Namespaces <lnpid>id-UK09-29021</lnpid></title>
    <body>
      <ul>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK09-LegalNews\UK09LegalNews_namespaces.dita  -->
  <xsl:variable name="lexisAdvNamespaces" as="element()">
    <lexisAdvNamespaces>
      ...
      <lexisAdvNamespace>xmlns:xsltdoc="http://www.lexisnexis.com/xmlstylesheets/documentation/xslt-documentation/1/"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:xs="http://www.w3.org/2001/XMLSchema"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:dita="http://dita.oasis-open.org/architecture/2005/"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:case="http://www.lexis-nexis.com/glp/case"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:comm="http://www.lexis-nexis.com/glp/comm"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:cttr="http://www.lexis-nexis.com/glp/cttr"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:ditaarch="http://dita.oasis-open.org/architecture/2005/"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:error="urn:x-lexisnexis:conversion:global:error:1"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:fn="http://www.w3.org/2005/xpath-functions"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:form="http://www.lexisnexis.com/xmlschemas/content/shared/form/1/"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:frm="http://www.lexis-nexis.com/glp/frm"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:jrnl="http://www.lexis-nexis.com/glp/jrnl"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:lncr="http://www.lexis-nexis.com/lncr"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:lndocmeta="http://www.lexisnexis.com/xmlschemas/content/shared/lndocmeta/1/"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:lnf="urn:x-lexisnexis:conversion:global:functions:1"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:lnv="http://www.lexis-nexis.com/lnv"</lexisAdvNamespace>
      <lexisAdvNamespace>xmlns:lnvxe="http://www.lexis-nexis.com/lnvxe"</lexisAdvNamespace>
      ...
      <lexisAdvNamespace>xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl"</lexisAdvNamespace>
