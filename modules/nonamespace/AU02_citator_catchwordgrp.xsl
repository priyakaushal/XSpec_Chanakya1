...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="catchwordgrp">
    <title>catchwordgrp <lnpid>id-AU02-18410</lnpid></title>
    <body>
      <section>
        <ul>
          <li class="- topic/li ">
            <sourcexml class="+ topic/keyword xml-d/sourcexml ">catchwordgrp</sourcexml> becomes
              <targetxml class="+ topic/keyword xml-d/targetxml "
              >cttr:descriptors/cttr:descriptorsection
              @descriptortype="catchwords-and-digest"</targetxml>
            <note class="- topic/note "> The content in <sourcexml
                class="+ topic/keyword xml-d/sourcexml ">catchwordgrp</sourcexml> and <sourcexml
                class="+ topic/keyword xml-d/sourcexml ">cttr:summary</sourcexml> needs to be
              present in the same <targetxml class="+ topic/keyword xml-d/targetxml "
                >cttr:descriptorsection</targetxml>. Also, please note that consecutive <sourcexml
                class="+ topic/keyword xml-d/sourcexml ">catchwordgrp</sourcexml> elements should be
              grouped into a single <targetxml class="+ topic/keyword xml-d/targetxml "
                >cttr:descriptorsection</targetxml>. However, all content must be converted such
              that the order of elements is maintained whenever possible. Please see the "Maintain
              the Order of Elements Whenever Possible" section for more information. An example
              illustrating this scenario is shown below. </note>
            <ul class="- topic/ul ">
              <li class="- topic/li ">
                <sourcexml class="+ topic/keyword xml-d/sourcexml ">catchwords</sourcexml> becomes
                  <targetxml class="+ topic/keyword xml-d/targetxml ">classify:classification
                  @classscheme="catchwords"</targetxml>
                <ul class="- topic/ul ">
                  <li class="- topic/li ">
                    <sourcexml class="+ topic/keyword xml-d/sourcexml ">catchphrase</sourcexml>
                    becomes <targetxml class="+ topic/keyword xml-d/targetxml "
                      >classify:classitem/classify:classitem-identifier/classify:classname</targetxml>
                    <p class="- topic/p ">Scenario:1 - Single <sourcexml
                        class="+ topic/keyword xml-d/sourcexml ">catchwordgrp</sourcexml> within
                        <sourcexml class="+ topic/keyword xml-d/sourcexml "
                      >cttr:content</sourcexml>.</p>
...
&lt;/cttr:descriptors&gt;
                    ...
                    <p class="- topic/p ">Scenario:2 - Multiple <sourcexml
                        class="+ topic/keyword xml-d/sourcexml ">catchwordgrp</sourcexml> within
                        <sourcexml class="+ topic/keyword xml-d/sourcexml "
                      >cttr:content</sourcexml>.</p>
                    <pre xml:space="preserve" class="- topic/pre "> 
...
&lt;/cttr:descriptors&gt;
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU02_citator\catchwordgrp.dita  -->
