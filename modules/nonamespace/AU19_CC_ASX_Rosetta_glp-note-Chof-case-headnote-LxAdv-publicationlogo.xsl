...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/"
        id="AU19_Rosetta_inlineobject_ChildOf_glp-note-to-publicationlogo">
        <title>
            <targetxml>publicationlogo</targetxml>
            <lnpid>id-AU19CC-21815</lnpid>
        </title>
        <body>
            <section>
                <p> At the occurence of
                        <sourcexml>case:headnote/glp:note/table/tgroup/tbody/row/entry/remotelink/inlineobject[@filename="*"]</sourcexml>
                </p>
                <p>where <sourcexml>inlineobject[@filename="*"]</sourcexml> contains the value(s) <ul>
                ...
                <note>
                    <ul>
                        <li>The <sourcexml>case:headnote</sourcexml>is converted as documented in
                            the instructions for <xref href="AU19_CC_ASX_case.info.dita"
                                >case:headnote/glp:note/case:info</xref>
                        </li>
                        <li>here in this x-path <sourcexml>remotelink</sourcexml> markup will be
                            suppressed from target</li>
                            ...
                            <ul>
                                <li>Create <targetxml>ref:locator</targetxml> and describe as: <ul>
                                        ...
                                        <li>Create <targetxml>ref:locator-params</targetxml> and
                                            describe as <ul>
                                                <li>Create <targetxml>proc:param[@name]</targetxml>
                                                  and <targetxml>proc:param[@value]</targetxml>pairs
                                                  as follows: <ul>
                                        ...
                                        <li>The other attributes of
                                                <sourcexml>inlineobject</sourcexml> are handled as
                                            follows: <ul>
                                                <li><sourcexml>inlineobject/@height</sourcexml>
                                                  becomes
                                                  <targetxml>ref:inlineobject/@height</targetxml>.</li>
                                                <li><sourcexml>inlineobject/@width</sourcexml>
                                                  becomes
            ...
            <example>
                ...
                <codeblock> &lt;case:headnote&gt; &lt;glp:note&gt; &lt;table frame="none"
                    pgwide="1"&gt; &lt;tgroup cols="3" colsep="0" rowsep="0"&gt; &lt;colspec
                    colname="col1" colsep="0" colwidth="45*" rowsep="0"/&gt; &lt;colspec
                    colname="col2" colsep="0" colwidth="10*" rowsep="0"/&gt; &lt;colspec
                    colname="col3" colsep="0" colwidth="45*" rowsep="0"/&gt; &lt;tbody
                    valign="top"&gt; &lt;row rowsep="0"&gt; &lt;entry align="left" colname="col1"
                    colsep="0" rowsep="0" valign="top"/&gt; &lt;entry align="center" colname="col2"
                    colsep="0" rowsep="0" valign="top"&gt; &lt;remotelink href="www.asx.com.au"
                    hrefclass="http" newwindow="YES"&gt; &lt;inlineobject attachment="ln-server"
                    filename="asx_logo.gif" type="image"/&gt; &lt;/remotelink&gt; &lt;/entry&gt;
                    &lt;entry align="right" colname="col3" colsep="0" rowsep="0" valign="top"&gt;
                    &lt;/entry&gt; &lt;/row&gt; &lt;/tbody&gt; &lt;/tgroup&gt; &lt;/table&gt;
                    &lt;/glp:note&gt; ... &lt;/case:headnote&gt; </codeblock>
                <title>Target XML</title>
                <codeblock> &lt;doc:metadata&gt; &lt;pubinfo:pubinfo&gt;
                    &lt;pubinfo:publicationlogo&gt; &lt;logo&gt; &lt;ref:inlineobject
                    role="logo"&gt; &lt;ref:locator&gt; &lt;ref:locator-key&gt; &lt;ref:key-name
                    name="object-key"/&gt; &lt;ref:key-value value="X-asx_logo"/&gt; &lt;!-- X is
                    DPSI Value obtained from Source look the above instruction given --&gt;
                    &lt;/ref:locator-key&gt; &lt;ref:locator-params&gt; &lt;proc:param
                    name="componentseq" value="1"/&gt; &lt;proc:param name="object-type"
                    value="image"/&gt; &lt;proc:param name="object-smi" value="LOGOS"/&gt;
                    &lt;/ref:locator-params&gt; &lt;/ref:locator&gt; &lt;/ref:inlineobject&gt;
                    &lt;/logo&gt; &lt;/pubinfo:publicationlogo&gt; &lt;/pubinfo:pubinfo&gt; ...
                    &lt;/doc:metadata&gt; </codeblock>
            </example>
            <section>
                <title>Changes</title>
                <p>2014-06-16: <ph id="change_20140616_SSX">Updated instruction to remove file
                        extansion from <targetxml>ref:key-value/@value</targetxml> for handling
                        logos images</ph></p>
                <p>2014-05-20: <ph id="change_20140520_SSX">Updated instruction to handle logo
                        Webteam # 259104</ph></p>
                <p>2013-09-18: <ph id="change_20130918_WL">Created <b>Webteam #235768 Logo Link
                            functionality for ASX Regulatory</b></ph>.</p>
            </section>
        </body>
    </dita:topic>

    <!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
    <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU19CC_ASX\AU19_CC_ASX_Rosetta_glp-note-Chof-case-headnote-LxAdv-publicationlogo.dita  -->
    <!--	<xsl:message>AU19_CC_ASX_Rosetta_glp-note-Chof-case-headnote-LxAdv-publicationlogo.xsl requires manual development!</xsl:message> -->
    ...
    <xsl:template match="heading/glp:note[table/tgroup/tbody/row/entry/remotelink/inlineobject[contains(@filename, 'asx-logo.gif') or contains(@filename, 'asx_logo.gif')]] |
        glp:note[table/tgroup/tbody/row/entry/remotelink/inlineobject[contains(@filename, 'asx-logo.gif') or contains(@filename, 'asx_logo.gif')]]"/>
                        ...
                        <ref:locator-key>
                            ...
                            <ref:key-value>
                                ...
                                <xsl:attribute name="value">
                                    <xsl:value-of select="concat($AU19-CC-dpsi, '-', inlineobject/substring-before(@filename, '.gif'))"/>
                                </xsl:attribute>
    ...
    <!--	<xsl:template match="case:headnote/glp:note/table/tgroup/tbody/row/entry/remotelink/inlineobject[@filename=&#34;*&#34;]">
