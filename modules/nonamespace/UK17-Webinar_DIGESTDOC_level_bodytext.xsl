...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:seclaw="http://www.lexisnexis.com/xmlschemas/content/legal/secondary-law/1/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK17-Webinar_DIGESTDOC_level_bodytext">
    <title>bodytext <lnpid>id-UK17-36210</lnpid></title>

    <body>
        <p>If <sourcexml>bodytext</sourcexml> is a child of <sourcexml>level</sourcexml> in source
      document then it should be mapped in target
...
&lt;/seclaw:body&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK17-Webinar\UK17-Webinar_DIGESTDOC_level_bodytext.dita  -->


  <xsl:template match="level/bodytext" priority="25">
    <seclaw:bodytext>
