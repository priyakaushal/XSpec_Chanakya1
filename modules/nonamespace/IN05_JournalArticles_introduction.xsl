...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:newsitem="http://www.lexisnexis.com/xmlschemas/content/news/newsitem/1/" xmlns:nitf="http://iptc.org/std/NITF/2006-10-18/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="IN05_JournalArticles_introduction">
  <title>Introduction <lnpid>id-IN05-38807</lnpid></title>

  <body>
    <p>These instructions describes the conversion of documents from the Rosetta JOURNALDOC DTD to
      the NewLexis NewsItem 4.4 PROD Schema.</p>
...
&lt;newsitem:newsitem xml:lang="en-CA"&gt;
...
&lt;/newsitem:newsitem&gt;
    ...
    <note>The <sourcexml>@searchtype</sourcexml> attribute will be suppressed from conversion except
      for the citation elements.</note>
    <section>
      <title>Note:</title>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN05-Articles\IN05_JournalArticles_introduction.dita  -->
	<xsl:message>IN05_JournalArticles_introduction.xsl requires manual development!</xsl:message> 
