...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-MY09-17810</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY09_Dictionary\dictionary-Namespaces.dita  -->
	<xsl:message>MY09_Dictionary_dictionary-Namespaces.xsl requires manual development!</xsl:message> 
