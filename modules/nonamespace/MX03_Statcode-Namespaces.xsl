...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="MX03_Statcode-Namespaces">
  <title>Namespaces <lnpid>id-MX03-34221</lnpid></title>
  <body>
<ul>
		...
		<li>xmlns:citation="urn:x-lexisnexis:content:citation:global:1"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\MX03-Statcode\MX03_Statcode-Namespaces.dita  -->
	<xsl:message>MX03_Statcode-Namespaces.xsl requires manual development!</xsl:message> 
