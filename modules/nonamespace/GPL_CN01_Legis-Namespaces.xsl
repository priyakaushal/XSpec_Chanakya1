...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="GPL_IN01_Legis-Namespaces">
  <title>Namespaces <lnpid>id-CN01-15213</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\CN01-Legislation\GPL_CN01_Legis-Namespaces.dita  -->
	<xsl:message>GPL_CN01_Legis-Namespaces.xsl requires manual development!</xsl:message> 
