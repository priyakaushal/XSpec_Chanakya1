...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-ST02-26408</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Courtrule\courtrule_Namespaces.dita  -->
	<xsl:message>Courtrule_courtrule_Namespaces.xsl requires manual development!</xsl:message> 
