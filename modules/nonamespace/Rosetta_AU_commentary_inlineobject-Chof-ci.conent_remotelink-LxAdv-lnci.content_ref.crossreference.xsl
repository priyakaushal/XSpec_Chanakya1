...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita ci">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Rosetta_AU_commentary_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference">
    <title><sourcexml>ci:content//remotelink/inlineobject</sourcexml> to <targetxml>lnci:content//ref:crossreference</targetxml> <lnpid>id-CCCC-10231</lnpid></title>
    <body>
        <section>
            <note>remotelink/inlineobject may occur at ci:content or ci:content/citefragment or ci:content/citefragment/ci:span.</note>
        ...
        <example>
            <title>Source XML showing <sourcexml>remotelink/inlineobject</sourcexml> occurring in <sourcexml>ci:content</sourcexml></title>
            <codeblock>
&lt;ci:cite searchtype="CASE-REF"&gt;
    ...
    &lt;/ci:case&gt;
    &lt;ci:content&gt;
        &lt;citefragment searchtype="CASE-NAME-REF"&gt;&lt;emph typestyle="it"&gt;Mabo v Queensland (No 2)&lt;/emph&gt;&lt;/citefragment&gt;
        &lt;citefragment searchtype="CASE-CITE-REF"&gt;&lt;ci:span spanid="CR000001-001"&gt;(1992) 175 CLR 1&lt;/ci:span&gt;&lt;/citefragment&gt; at &lt;ci:span spanid="CR000001-002"&gt;99&lt;/ci:span&gt; per Deane and Gaudron JJ; &lt;citefragment searchtype="CASE-CITE-REF"&gt;&lt;ci:span
                spanid="CR000002-001"&gt;107 ALR 1&lt;/ci:span&gt;&lt;/citefragment&gt;; &lt;citefragment searchtype="CASE-CITE-REF"&gt;&lt;ci:span spanid="CR000003-001"&gt;66 ALJR 408&lt;/ci:span&gt;&lt;/citefragment&gt;; &lt;citefragment searchtype="CASE-CITE-REF"&gt;&lt;ci:span
                spanid="CR000004-001"&gt;BC9202681&lt;/ci:span&gt;&lt;/citefragment&gt;&lt;remotelink dpsi="0018" refpt="34408" remotekey1="DOC-ID" service="DOC-ID"&gt;&lt;inlineobject alttext="Cautionary treatment indicated - Click for CaseBase entry"
...
&lt;lnci:cite&gt;
    &lt;lnci:case&gt;
        ...
        &lt;/lnci:caseref&gt;
    &lt;/lnci:case&gt;
    &lt;lnci:content&gt;&lt;emph typestyle="it"&gt;Mabo v Queensland &amp;#x0028;No 2&amp;#x0029;&lt;/emph&gt;&amp;#x0028;1992&amp;#x0029; 175 CLR 1 at 99 per Deane and Gaudron JJ; 107 ALR 1 ; 66 ALJR 408 ; BC9202681 
        &lt;ref:crossreference crossreferencetype="citatorAlert" referencedresourcesentiment="cautionary" referencedresourcetype="citator"&gt;&lt;ref:content&gt;Cautionary treatment indicated&lt;/ref:content&gt;
            &lt;ref:locator&gt;&lt;ref:locator-key&gt;&lt;ref:key-name name="DOC-ID"/&gt;&lt;ref:key-value value="0018-34408"/&gt;&lt;/ref:locator-key&gt;&lt;/ref:locator&gt;&lt;/ref:crossreference&gt;
    &lt;/lnci:content&gt;
&lt;/lnci:cite&gt;
            </codeblock>
        </example>
        <section>
            <title>Changes :</title>
            <p>2016-11-28: <ph id="change_20161128_csn">Updated to handle remotelink/inlineobject at ci:content or ci:content/citefragment or ci:content/citefragment/ci:span. Webstars 6716788, 6705412.</ph></p>
            <p>2016-08-05: <ph id="change_20160805_hp">Added Note about xml snippets that illustrate
            ...
            <p>Added instructions on how to handle <sourcexml>inlineobject/@alttext="Citation information only - Click for CaseBase entry"</sourcexml> scenario.</p>
        </section>
    </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\common_newest\Rosetta_AU_commentary_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.dita  -->
<!--	<xsl:message>Rosetta_AU_commentary_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.xsl requires manual development!</xsl:message> -->

    <!-- JL USE ../../modules/nonamespace/Rosetta_inlineobject-Chof-ci.conent_remotelink-LxAdv-lnci.content_ref.crossreference.xsl  INSTEAD OF THIS 
        MODULE.  YOU MAY NEED TO ADD YOUR STREAM ID TO THE CONDITIONS IN THAT MODULE, BUT IT ACCOMMODATES THESE CONDITIONS -->
