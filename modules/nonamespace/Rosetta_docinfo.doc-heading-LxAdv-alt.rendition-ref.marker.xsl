...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita docinfo">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK15PG_DIGESTDOC_alt.rendition-ref.marker">
    <title><sourcexml>docinfo:alt-rendition/link</sourcexml> without text <lnpid>id-UK15-30451</lnpid></title>
	    <body>
...
<!-- WPK 2017-11-21
		This logic is located in the Blobstore module:
		/modules/nonamespace/Rosetta_lnlink_service_ATTACHMENT-LxAdv-ref.lnlink_BLOBSTORE.xsl
	this module is for documentation.
	Module was formerly stream specifically named "UK15PG_DIGESTDOC_alt.rendition-ref.marker.xsl".
	-->
