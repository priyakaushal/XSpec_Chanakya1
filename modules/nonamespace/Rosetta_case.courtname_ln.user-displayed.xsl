...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" version="2.0" exclude-result-prefixes="dita case">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Rosetta_case.courtname_ln.user-displayed">
    <title><sourcexml>case.courtname/@ln.user-displayed="false"</sourcexml> <lnpid>id-CCCC-10258</lnpid></title>
    <body>
        <section>
            ...
            <p>When <sourcexml>case:courtname</sourcexml> has attribute <sourcexml>@ln.user-displayed="false"</sourcexml> (i.e. <sourcexml>case:courtname/@ln.user-displayed="false"</sourcexml>),
