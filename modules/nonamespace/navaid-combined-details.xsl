...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:index="urn:x-lexisnexis:content:publicationindex:sharedservices:1" xmlns:navaid="urn:x-lexisnexis:content:navigationaid:sharedservices:1" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita docinfo">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="navaid-combined-details">
      <title>Convert Combined <sourcexml>remotelink</sourcexml> Elements To
          <targetxml>navaid:list</targetxml> <lnpid>id-AU16-21009</lnpid></title>
      <body>
        <p>The subtopics above describe scenarios where there are a series of
            <sourcexml>remotelink</sourcexml> elements within either: <ul>
            <li>a <sourcexml>table</sourcexml> that contains as a single
                <sourcexml>entry</sourcexml> (XPath <sourcexml>table/tbody/row/entry</sourcexml>);
              or </li>
            <li>a <sourcexml>p</sourcexml> that contains a single <sourcexml>text</sourcexml> (Xpath
                <sourcexml>p/text</sourcexml>).</li>
          </ul>
        </p>
        <p>Either way, the series of <sourcexml>remotelink</sourcexml> elements are converted to a
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU16_navaid\navaid-combined-details.dita  -->
	<!--<xsl:message>navaid-combined-details.xsl requires manual development!</xsl:message> -->
