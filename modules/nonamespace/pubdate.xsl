...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:pubinfo="http://www.lexisnexis.com/xmlschemas/content/shared/publication-info/1/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>pubdate <lnpid>id-AR01-34422</lnpid></title>
  <body>
    <section>
      <p><sourcexml>pubdate</sourcexml> becomes
                    ...
                    <li><sourcexml>date</sourcexml> become <targetxml>date-text</targetxml> and the
                        attributes will be moved in the parent
                            <targetxml>pubinfo:pubdate</targetxml> element. <ul>
                ...
                part of <targetxml>date-text</targetxml> element.</p>
      <pre>

&lt;leg:dates&gt;
    &lt;pubdate display-name="Publicación en el B.O."&gt;
        &lt;date year="1956" month="05" day="08"&gt; 08 de Mayo de 1956&lt;/date&gt;
    &lt;/pubdate&gt;
&lt;/leg:dates&gt;
...
&lt;doc:metadata&gt;
    &lt;pubinfo:pubinfo&gt;
        &lt;pubinfo:dates&gt;
            &lt;pubinfo:pubdate day="08" month="05" year="1956"&gt;
                &lt;date-text&gt;Publicación en el B.O. 08 de Mayo de 1956&lt;/date-text&gt;
            &lt;/pubinfo:pubdate&gt;
        &lt;/pubinfo:dates&gt;
    &lt;/pubinfo:pubinfo&gt;
&lt;/doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR01-Legislation\pubdate.dita  -->
	<xsl:message>pubdate.xsl requires manual development!</xsl:message> 
