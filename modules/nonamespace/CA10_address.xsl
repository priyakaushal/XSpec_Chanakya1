...
<xsl:stylesheet xmlns:contact="http://www.lexisnexis.com/xmlschemas/content/shared/contact/1/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:location="http://www.lexisnexis.com/xmlschemas/content/shared/location/1/" xmlns:proc="http://www.lexisnexis.com/xmlschemas/content/shared/process-elements/1/" version="2.0" exclude-result-prefixes="dita">
    ...
    <title>address <lnpid>id-CA10-14622</lnpid></title>
    <body>
        <section>
...
&lt;/location:address&gt;
        ...
        <section>
            <title>Changes</title>
            <p>2016-03-22: <ph id="change_20160322_address_1">Added instructions for mapping <sourcexml>address</sourcexml> to <targetxml>location:address</targetxml>.</ph></p>
        </section>
    </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA10-Treatise_Textbook_Forms\CA10_address.dita  -->
	<!--<xsl:message>CA10_address.xsl requires manual development!</xsl:message>--> 
