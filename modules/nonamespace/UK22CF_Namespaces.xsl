...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
    ...
    <title>Namespaces <lnpid>id-UK22CF-39024</lnpid></title>
    <body>
        <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK22CF\Namespaces.dita  -->
	<xsl:message>UK22CF_Namespaces.xsl requires manual development!</xsl:message> 
