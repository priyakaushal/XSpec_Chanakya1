...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Journaldoc-publication">
    <title>publication <lnpid>id-ST09-32633</lnpid></title>
...
&lt;jrnl:info&gt;
    &lt;publication&gt;Privacy and Data Protection&lt;/publication&gt;
    ...
&lt;/jrnl:info&gt;
...
&lt;doc:metadata&gt;
    &lt;pubinfo:pubinfo&gt;
        &lt;pubinfo:publicationname&gt;Privacy and Data Protection&lt;/pubinfo:publicationname&gt;
        ...
    &lt;/pubinfo:pubinfo&gt;
    ...
&lt;/doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Newsitem\Journaldoc-publication.dita  -->
	<xsl:message>Journaldoc-publication.xsl requires manual development!</xsl:message> 
