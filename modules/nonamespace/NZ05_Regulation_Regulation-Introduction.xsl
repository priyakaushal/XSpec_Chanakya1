...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:regulation="urn:x-lexisnexis:content:regulation:sharedservices:1" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Regulation-Introduction">
       <title>Introduction <lnpid>id-NZ05-23209</lnpid></title>
    <body>
        <p><u>This Conversion Instruction describes the conversion of the <sourcexml>Rosetta LEGDOC
                    DTD</sourcexml> to <targetxml>Regulation Schema (Version 8.3
                PROD)</targetxml>.</u></p>
        <section><title>Root Element</title>
            <p>Identification Criteria for <b>NZ05 Regulation</b> content stream is
                ...
                <targetxml>regulation:regulation</targetxml> when the root element
                    ...
                    <sourcexml>@legtype="regulations"</sourcexml>. This is the root element for the
            ...
            <p>
				...
				<p>Create <targetxml>regulation:regulation[@xml:lang]</targetxml> which is used to specify the
                language that is being used in the content/document. The presence or absence of
                attribute value will not affect delivery product behavior and default value is
                'none'. <pre>
...
&lt;/regulation:regulation&gt;
            ...
            <p>
                <targetxml>regulation:head</targetxml>, <targetxml>regulation:body</targetxml>, and <targetxml>doc:metadata</targetxml> are created as required children of <targetxml>regulation:regulation</targetxml>.
            </p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ05_Regulation\Regulation-Introduction.dita  -->
	...
	<!-- <xsl:template match="@legtype=&#34;regulations&#34;">
