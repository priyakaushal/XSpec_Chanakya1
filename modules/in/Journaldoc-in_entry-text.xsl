...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:in="http://www.lexis-nexis.com/glp/in" xmlns:index="urn:x-lexisnexis:content:publicationindex:sharedservices:1" version="2.0" exclude-result-prefixes="dita in">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Journaldoc-in_entry-text">
  <title>in:entry-text <lnpid>id-ST09-32616</lnpid></title>
...
&lt;/index:index&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Newsitem\Journaldoc-in_entry-text.dita  -->
	<xsl:message>Journaldoc-in_entry-text.xsl requires manual development!</xsl:message> 
