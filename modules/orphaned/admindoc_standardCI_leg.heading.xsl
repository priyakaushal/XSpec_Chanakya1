...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:admindoc="urn:x-lexisnexis:content:administrative-document:sharedservices:1" version="2.0" exclude-result-prefixes="dita leg">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="admindoc_standardCI_leg.heading">
	<title>leg:heading <lnpid>id-ST08-31614</lnpid></title>
	<body>
		<section>
			<ul>
				<li class="- topic/li ">
...
&lt;admindoc:level xml:id="CCL_ASIC.SGM_REL.SUBGROUP_12" leveltype="subchapter" includeintoc="true" alternatetoccaption="ASIC&amp;#x2019;S ROLE"&gt;
	&lt;heading&gt;
...
&lt;/admindoc:level&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Admindoc\admindoc_standardCI_leg.heading.dita  -->
	<xsl:message>admindoc_standardCI_leg.heading.xsl requires manual development!</xsl:message> 
