...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Regulatory-From-Services-Namespaces">
  <title>Namespaces <lnpid>id-NZ12-24819</lnpid></title>
  ...
  <body>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ12_Regulatory_Material_From_Services\Regulatory-From-Services-Namespaces.dita  -->
	<xsl:message>Regulatory-From-Services-Namespaces.xsl requires manual development!</xsl:message> 
