...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Intl-Inst_Namespaces">
  <title>Namespaces <lnpid>id-NZ13-25010</lnpid></title>
  <body>
    <ul>
      <li>xmlns:funddoc="urn:x-lexisnexis:content:fundamentallegaldocument:sharedservices:1"</li>
      <li>xmlns:lnvxe="http://www.lexisnexis.com/xmlschemas/content/shared/lnvxe/1/"</li>
      <li>xmlns:lnv="http://www.lexis-nexis.com/lnv"</li>
      <li>xmlns:ci="http://www.ci.org"</li>
      ...
      <li>xmlns:docinfo="http://www.lexisnexis.com/xmlschemas/content/shared/documentinfo-level-metadata/1/"</li>
      ...
      <li>xmlns:lnsm="http://www.lexis-nexis.com/lnsm"</li>
      ...
      <li>xmlns:lnvni="http://www.lexis-nexis.com/lnvni"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ13_Treaties_From_Services\Namespaces.dita  -->
	<xsl:message>NZ13_Treaties_From_Services_Namespaces.xsl requires manual development!</xsl:message> 
