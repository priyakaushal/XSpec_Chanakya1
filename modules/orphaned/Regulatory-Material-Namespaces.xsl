...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Regulatory-Material-Namespaces">
  <title>Namespaces <lnpid>id-AU15-20821</lnpid></title>
  ...
  <body>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU15_Regulatory_Material\Regulatory-Material-Namespaces.dita  -->
	<xsl:message>Regulatory-Material-Namespaces.xsl requires manual development!</xsl:message> 
