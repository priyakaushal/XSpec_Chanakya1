...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="psl_landingpgs-namespaces">
    <title>Namespaces <lnpid>id-UK13-30007</lnpid></title>
    <body>
      <ul>
        ...
        <li>xmlns:dc="http://purl.org/dc/elements/1.1/"
          xmlns:dcterms="http://purl.org/dc/terms/"</li>
        ...
        <li>xmlns:xml="http://www.w3.org/XML/1998/namespace"</li>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK13_PSL_LandingPages\Namespaces.dita  -->
  <!--<xsl:message>UK13_PSL_LandingPages_Namespaces.xsl requires manual development!</xsl:message> -->
