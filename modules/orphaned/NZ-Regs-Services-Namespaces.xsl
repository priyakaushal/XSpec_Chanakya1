...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="NZ-Regs-Services-Namespaces">
    <title>Namespaces <lnpid>id-NZ10-24421</lnpid></title>
    <body>
      <ul>
        <li>xmlns:baser="http://www.lexisnexis.com/xmlschemas/content/shared/base/1/"</li>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ10_Regulation_From_Services\NZ-Regs-Services-Namespaces.dita  -->
  <!--<xsl:message>NZ-Regs-Services-Namespaces.xsl requires manual development!</xsl:message>-->
