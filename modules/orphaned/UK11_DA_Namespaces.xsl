...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK11_DA_Namespaces">
    <title>Namespaces <lnpid>id-UK11DA-29433</lnpid></title>
    <body>
      <ul>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK11DA-Digest-Abstract\UK11_DA_Namespaces.dita  -->

  <!-- Vikas Rohilla : Added the namespaces   -->
