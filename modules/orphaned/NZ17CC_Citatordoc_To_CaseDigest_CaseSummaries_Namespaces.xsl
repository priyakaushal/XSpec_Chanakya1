...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Namespaces <lnpid>id-NZ17CC-25824</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ17_Case_Summaries\NZ17CC_Citatordoc_To_CaseDigest\CaseSummaries_Namespaces.dita  -->
	<xsl:message>NZ17CC_Citatordoc_To_CaseDigest_CaseSummaries_Namespaces.xsl requires manual development!</xsl:message> 
