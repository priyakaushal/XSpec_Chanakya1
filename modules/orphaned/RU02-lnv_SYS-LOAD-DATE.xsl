...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:lnv="http://www.lexis-nexis.com/lnv" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita lnv">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="RU02-lnv_SYS-LOAD-DATE">
    <title>lnv:SYS-LOAD-DATE <lnpid>id-RU02-32048</lnpid>
    </title>
...
&lt;/doc:sourcedocinfo&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\RU02\RU02-lnv_SYS-LOAD-DATE.dita  -->
	<xsl:message>RU02-lnv_SYS-LOAD-DATE.xsl requires manual development!</xsl:message> 
