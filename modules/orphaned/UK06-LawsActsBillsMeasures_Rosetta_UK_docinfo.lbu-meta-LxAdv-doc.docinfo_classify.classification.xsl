...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:classify="http://www.lexisnexis.com/xmlschemas/content/shared/classification/1/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita docinfo">
    ...
    <title>(UK) <sourcexml>docinfo:lbu-meta</sourcexml> to
        ...
        <lnpid>id-UK06-28048</lnpid></title>
    <body>
        <section>
...
&lt;/doc:hier&gt;	</codeblock>
        ...
        <section>
            ...
            <p>2016-11-09: <ph id="change_20161109_AS">Updated Attribute value for <targetxml>doc:hier/proc:processinginfo[@process="LAToCBuilder"]</targetxml></ph></p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK06-LawsActsBillsMeasures\Rosetta_UK_docinfo.lbu-meta-LxAdv-doc.docinfo_classify.classification.dita  -->
	<xsl:message>UK06-LawsActsBillsMeasures_Rosetta_UK_docinfo.lbu-meta-LxAdv-doc.docinfo_classify.classification.xsl requires manual development!</xsl:message> 
