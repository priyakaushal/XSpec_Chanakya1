...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="admindoc_standardCI_namespaces">
  <title>Namespaces <lnpid>id-ST08-31624</lnpid></title>
  ...
  <body>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-Standard\Admindoc\admindoc_standardCI_namespaces.dita  -->
	<xsl:message>admindoc_standardCI_namespaces.xsl requires manual development!</xsl:message> 
