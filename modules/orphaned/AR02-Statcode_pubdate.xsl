...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:pubinfo="http://www.lexisnexis.com/xmlschemas/content/shared/publication-info/1/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>pubdate <lnpid>id-AR02-35021</lnpid></title>
  <body>
    <section>
...
&lt;leg:dates&gt;
    &lt;pubdate display-name="Publicación en el B.O"&gt;
        &lt;date year="1981" month="03" day="23"&gt; 23/03/1981&lt;/date&gt;
    &lt;/pubdate&gt;
&lt;/leg:dates&gt;
...
&lt;doc:metadata&gt;
    &lt;pubinfo:pubinfo&gt;
        &lt;pubinfo:dates&gt;
            &lt;pubinfo:pubdate year="1981" month="03" day="23"&gt;
                &lt;date-text&gt;Publicación en el B.O 23/03/1981&lt;/date-text&gt;
            &lt;/pubinfo:pubdate&gt;
        &lt;/pubinfo:dates&gt;
    &lt;/pubinfo:pubinfo&gt;
&lt;/doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR02-Statcode\pubdate.dita  -->
	<xsl:message>AR02-Statcode_pubdate.xsl requires manual development!</xsl:message> 
