...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/"
		id="CompCase_Namespaces">
		<title>Namespaces <lnpid>id-UK02-27236</lnpid></title>
		<body>
			<ul>

				<li>xmlns:compcase="urn:x-lexisnexis:content:compositecourtcase:sharedservices:1"</li>
				<li>xmlns:case="http://www.lexis-nexis.com/glp/case"</li>
				<li>xmlns:ci="http://www.lexis-nexis.com/ci"</li>
				<li>xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo"</li>
				<li>xmlns:glp="http://www.lexis-nexis.com/glp"</li>
				<li>xmlns:leg="http://www.lexis-nexis.com/glp/leg"</li>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK02-Comp_Cases\UK02_CompCase_Namespaces.dita  -->
