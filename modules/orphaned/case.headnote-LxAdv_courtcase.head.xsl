...
&lt;/courtcase:courtcase&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA02-Case_Summaries\CA02DS_DIGESTDOC_to_seclaw\case.headnote-LxAdv_courtcase.head.dita  -->
	<xsl:message>case.headnote-LxAdv_courtcase.head.xsl requires manual development!</xsl:message> 
