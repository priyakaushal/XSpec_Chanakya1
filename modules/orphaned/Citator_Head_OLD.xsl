...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:cttr="urn:x-lexisnexis:content:citator:sharedservices:1" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:primlawinfo="http://www.lexisnexis.com/xmlschemas/content/legal/primarylaw-info/1/" version="2.0" exclude-result-prefixes="dita ci cttr leg">
  ...
  <title>Head for Legislative Citator Docs <lnpid>id-UK16-38609</lnpid></title>
   <body>
        ...
        <section>
            ...
            <p>If <sourcexml>cttr:body</sourcexml> contains <sourcexml>leg:info</sourcexml>
                    ...
                    <targetxml>cttr:head/cttr:citedseclaw</targetxml>.</p>
            <p>
                <ul>
                    <li>If <sourcexml>leg:info/leg:officialname</sourcexml> contains
                            <sourcexml>ci:cite</sourcexml> as child map it to
                            <targetxml>cttr:head/cttr:citedseclaw/lnci:cite</targetxml>
                        <note><sourcexml>leg:officialname</sourcexml> with it's child will have
                            their own target markup too, See <sourcexml>leg:officialname</sourcexml>
                            handling for this.</note></li>
                    <li>If <sourcexml> leg:info</sourcexml> contains
                            <sourcexml>leg:statutename/remotelink </sourcexml> map it to
                            <targetxml>cttr:head/cttr:citedseclaw/ref:crossreference</targetxml><note><sourcexml>leg:statutename</sourcexml>
                            with it's child will have their own target markup too, See
                                <sourcexml>leg:statutename</sourcexml> handling for
                        this.</note></li>
                </ul>
            </p>
        </section>
...
&lt;cttr:head&gt;
        &lt;cttr:citedseclaw&gt;
           &lt;lnci:cite status="valid"&gt;
            &lt;lnci:sesslaw&gt;
                &lt;lnci:sesslawinfo&gt;
                    &lt;lnci:sesslawnum num="2011_736s_Title"/&gt;
                &lt;/lnci:sesslawinfo&gt;
                &lt;lnci:sesslawref&gt;
                    &lt;lnci:standardname normpubcode="UK_SI"/&gt;
                &lt;/lnci:sesslawref&gt;
            &lt;/lnci:sesslaw&gt;
                &lt;lnci:content&gt;SI 2011/736&lt;/ci:content&gt;
            &lt;/lnci:cite&gt;
...
&lt;cttr:head&gt;
        ...
        <example>
<lines>Source XML <sourcexml>leg:statutename/remotelink</sourcexml></lines>
            <codeblock>

&lt;cttr:body&gt;
    &lt;leg:info&gt;
      &lt;leg:officialname leg-signal="in-force-commenced-amend" searchtype="PROV-NUM"&gt;
        &lt;emph typestyle="bf"&gt;Section 724&lt;/emph&gt;
      &lt;/leg:officialname&gt;
      &lt;leg:statutename&gt;Income Tax (Trading and Other Income) Act 2005 (c 5)
        &lt;remotelink alttext="See Enactment Overview" dpsi="0HYR" remotekey1="DOC-ID" remotekey2="2005_5a"
          newwindow="NO" service="DOC-ID"&gt; See Enactment Overview&lt;/remotelink&gt;
      &lt;/leg:statutename&gt;
      .....
    &lt;leg:info&gt;
&lt;/cttr:body&gt;
</codeblock>
            <lines>Target XML <sourcexml>leg:statutename/remotelink</sourcexml></lines>
            <codeblock>
            ...
            &lt;ref:crossreference crossreferencetype="seeAlso"&gt;
                ...
                &lt;ref:locator&gt;
                    &lt;ref:locator-key&gt;
                        ...
                        &lt;ref:key-value value="0HYR-2005_5a"/&gt;
                    &lt;/ref:locator-key&gt;
                &lt;/ref:locator&gt;
            &lt;/ref:crossreference&gt;
            &lt;primlawinfo:primlawinfo&gt;
...
&lt;/cttr:head&gt;        
        ...
        <section>
            <title><sourcexml>cttr:body/leg:info/popname</sourcexml> to <targetxml>primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:names/popname</targetxml></title>
            <ul>
                <li>
            <p>
                        <sourcexml>popname</sourcexml> becomes
                            <targetxml>primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:names/popname</targetxml></p></li>
...
&lt;/cttr:head&gt;
        ...
        <section>
            <title><sourcexml>cttr:body/leg:info/leg:officialname</sourcexml> to <targetxml>cttr:head/cttr:citedseclaw/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:names/legisinfo:officialtitle</targetxml></title>
            <ul>
                <li>
            <p>
                <sourcexml>leg:officialname</sourcexml> child of
                    <sourcexml>cttr:body/leg:info</sourcexml> becomes
                    <targetxml>cttr:head/cttr:citedseclaw/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:names/legisinfo:officialtitle</targetxml>
                <ul><li>attribute <sourcexml>leg:officialname/@searchtype</sourcexml> is drop in target.</li>
                    <li>attribute<sourcexml>leg:officialname/@leg-signal</sourcexml>'s value becomes
                                    <targetxml>cttr:citedseclaw/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:statusgroup/legisinfo:status/legisinfo:statustext</targetxml></li></ul>
            </p>
                </li></ul>
        </section>
        <example>
...
&lt;doc:metadata&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK16_LegislativeCitator\Citator_Head_OLD.dita  -->
	<xsl:message>Citator_Head_OLD.xsl requires manual development!</xsl:message> 
	...
	<xsl:template match="leg:info"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:head/cttr:citedseclaw   -->
		<cttr:head>
			<cttr:citedseclaw>
				<xsl:apply-templates select="@* | node()"/>
			</cttr:citedseclaw>
	...
	<xsl:template match="leg:info/leg:officialname"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:head/cttr:citedseclaw/lnci:cite   -->
		<cttr:head>
			<cttr:citedseclaw>
	...
	<xsl:template match="leg:officialname"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:head/cttr:citedseclaw/ref:crossreference   -->
		<cttr:head>
			<cttr:citedseclaw>
				<ref:crossreference xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/">
					<xsl:apply-templates select="@* | node()"/>
				</ref:crossreference>
			</cttr:citedseclaw>
		</cttr:head>
	...
	<xsl:template match="leg:statutename/remotelink "><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="popname/@ln.user-displayed"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:head/cttr:citedseclaw/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:names/legisinfo:officialtitle   -->
		<cttr:head>
			<cttr:citedseclaw>
				<primlawinfo:primlawinfo>
					<legisinfo:legisinfo xmlns:legisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/legislation-info/1/">
	...
	<xsl:template match="leg:officialname/@searchtype"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:citedseclaw/primlawinfo:primlawinfo/legisinfo:legisinfo/legisinfo:statusgroup/legisinfo:status/legisinfo:statustext   -->
		<cttr:citedseclaw>
			<primlawinfo:primlawinfo>
				<legisinfo:legisinfo xmlns:legisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/legislation-info/1/">
					<legisinfo:statusgroup>
