...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita docinfo">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="CA05_dpsi-stream-doc.hierlev-heading-title">
    <title>docinfo:custom-metafield/@name="dpsi" <lnpid>id-CA05-13637</lnpid></title>
    <body>
        <section>
            <p>When <sourcexml>docinfo:custom-metafield name="dpsi"</sourcexml> is contains value as
                per below colum <b>DPSI</b> value then conversion should generate first
            ...
            <pre>
&lt;docinfo:metaitem name="DPSI" value="0UVY"&gt;&lt;/docinfo:metaitem&gt;
...
&lt;docinfo:hier&gt;
...
&lt;/doc:hier&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA05-ActsNew\CA10_dpsi-stream-doc.hierlev-heading-title.dita  -->
	<xsl:message>CA10_dpsi-stream-doc.hierlev-heading-title.xsl requires manual development!</xsl:message> 
