...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" version="2.0" exclude-result-prefixes="dita docinfo">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="CA01_Rosetta_docinfo.custom.metafields">
    <title><sourcexml>docinfo:custom-metafields</sourcexml> to <targetxml>doc:legacy-metadata[@metadatasource="lbu-meta"]</targetxml> <lnpid>id-CA01-12230</lnpid></title>
    <body>
        <section>
            ...
            <p>If <sourcexml>docinfo:custom-metafields</sourcexml> does <b>not</b> have <sourcexml>docinfo:custom-metafield[@searchtype="CITED-COUNT"]</sourcexml> as a child, then <sourcexml>docinfo:custom-metafields</sourcexml> and all its children should be
                suppressed.</p>
        </section>

        <example>
            <title>Source XML (<sourcexml>docinfo:custom-metafields</sourcexml> with <sourcexml>docinfo:custom-metafield[@searchtype="CITED-COUNT"]</sourcexml> as a child)</title>
            <codeblock>
...
&lt;/docinfo:custom-metafields&gt;
            ...
            <title>Target XML (<sourcexml>docinfo:custom-metafields</sourcexml> has <sourcexml>docinfo:custom-metafield[@searchtype="CITED-COUNT"]</sourcexml> as a child)</title>
            <codeblock>
...
&lt;/docinfo:custom-metafields&gt;
        ...
        <section>
            <title>Changes</title>
            <p>2012-12-05: Created. </p>
        </section>
    </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA01-Cases\CA01_Rosetta_docinfo.custom.metafields.dita  -->
	<xsl:message>CA01_Rosetta_docinfo.custom.metafields.xsl requires manual development!</xsl:message> 
