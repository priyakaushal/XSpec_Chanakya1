...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" version="2.0" exclude-result-prefixes="dita leg">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK06_LawsActsBillsMeasures-leg.comntry-source3">
 <title>Source XML 3 : <sourcexml>leg:level/leg:level-vrnt/leg:levelbody/leg:comntry/level</sourcexml></title>
  <body>
    <codeblock>
...
&lt;/leg:body&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK06-LawsActsBillsMeasures\UK06_LawsActsBillsMeasures-leg.comntry-source3.dita  -->
	<xsl:message>UK06_LawsActsBillsMeasures-leg.comntry-source3.xsl requires manual development!</xsl:message> 
