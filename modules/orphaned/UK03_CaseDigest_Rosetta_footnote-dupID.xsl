...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>footnote duplicate IDs <lnpid>id-UK03-27460</lnpid></title>
  <body>
...
&lt;/footnotegroup&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK03_CaseDigest\Rosetta_footnote-dupID.dita  -->
	<xsl:message>UK03_CaseDigest_Rosetta_footnote-dupID.xsl requires manual development!</xsl:message> 
