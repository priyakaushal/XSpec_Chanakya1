...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK11_DN_remotelink-status">
    <title><sourcexml>remotelink/@status</sourcexml>, attribute suppressed <lnpid>id-UK11DN-29625</lnpid></title>
    <body>
        <section>
        ...
        <note>Suppression of <sourcexml>@status</sourcexml> is common practice, as illustrated in
            examples in preceding instruction <sourcexml>remotelink</sourcexml> to
                <targetxml>ref:crossreference</targetxml> (id-CCCC-10465). Data delivered Aug 2014
            for UK11-DN (newsitem) include a significant increase in <sourcexml>@status</sourcexml>
            markup. This section is added for UK11-DN to clarify and reinforce the common practice
...
&lt;/ref:crossreference&gt;
        ...
        <section>
            <title>Changes</title>
            <p>2014-08-16: <ph id="change_20140816_jm">Not a rule change. Clarifies that it is
                    correct to suppress attribute <sourcexml>remotelink[@status]</sourcexml>.
                    Section created in response to increased presence of
                        <sourcexml>@status</sourcexml> in UK11-DN data delivered Aug 2014. Phase-5
                    Issue 171.</ph></p>
        </section>
    </body>
	</dita:topic>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK11DN-Digest-Newsitem\UK11_DN_remotelink-status.dita  -->
	<xsl:message>UK11_DN_remotelink-status.xsl requires manual development!</xsl:message> 
