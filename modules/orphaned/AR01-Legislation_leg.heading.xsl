...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:heading <lnpid>id-AR01-34413</lnpid></title>
  <body>
    <section>
...
&lt;/primlaw:level&gt;              
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR01-Legislation\leg.heading.dita  -->
	<xsl:message>AR01-Legislation_leg.heading.xsl requires manual development!</xsl:message> 
