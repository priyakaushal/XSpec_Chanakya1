...
&lt;/leg:body&gt; 
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK06-LawsActsBillsMeasures\UK06_LawsActsBillsMeasures-leg.categories1-source.dita  -->
	<xsl:message>UK06_LawsActsBillsMeasures-leg.categories1-source.xsl requires manual development!</xsl:message> 
