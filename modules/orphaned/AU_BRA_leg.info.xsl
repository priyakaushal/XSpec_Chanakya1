...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:admindoc="urn:x-lexisnexis:content:administrative-document:sharedservices:1" version="2.0" exclude-result-prefixes="dita leg">
  ...
  <title>leg:info <lnpid>id-AU18-21412</lnpid></title>
  <body>
    <section>
      <ul>
        <li>
...
&lt;/admindoc:body&gt;
          ...
          <note>When <sourcexml>leg:officialname</sourcexml> element has attribute <sourcexml>@ln.user-displayed="false"</sourcexml> without
            any text inside the source markup. It should be suppressed and not converted into the
            output.</note>
        </li>
      </ul>
    </section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU18_BRA_Regulatory\AU_BRA_leg.info.dita  -->
	<xsl:message>AU_BRA_leg.info.xsl requires manual development!</xsl:message> 
