...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="CA_Legis-Namespaces">
    <title>Namespaces <lnpid>id-CA05-13608</lnpid></title>
    <body>
      <ul>
  ...
  <xsl:variable name="lexisAdvNamespaces" as=" element() ">
    <lexisAdvNamespaces>
      ...
      <lexisAdvNamespace>xmlns:xsl="http://www.w3.org/1999/XSL/Transform"</lexisAdvNamespace>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA05-ActsNew\CA_Legis-Namespaces.dita  -->
  <!--<xsl:message>CA_Legis-Namespaces.xsl requires manual development!</xsl:message> -->
