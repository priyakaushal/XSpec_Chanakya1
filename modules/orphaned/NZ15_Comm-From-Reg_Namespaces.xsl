...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Comm-From-Reg_Namespaces">
  <title>Namespaces <lnpid>id-NZ15-25410</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\NZ15_Commentary_From_Regs\Comm-From-Reg_Namespaces.dita  -->
	<!-- <xsl:message>NZ15_Comm-From-Reg_Namespaces.xsl requires manual development!</xsl:message> --> 
