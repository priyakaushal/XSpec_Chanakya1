...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="#all">
  ...
  <title>Namespaces <lnpid>id-AU08-19410</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU08_courtrule\courtrule_Namespaces.dita  -->
  <xsl:variable name="lexisAdvNamespaces" as=" element() ">
    <lexisAdvanceNamespaces>
      ...
      <lexisAdvNamespace>xmlns:index="urn:x-lexisnexis:content:publexisAdvNamespacecationindex:sharedservices:1"</lexisAdvNamespace>
