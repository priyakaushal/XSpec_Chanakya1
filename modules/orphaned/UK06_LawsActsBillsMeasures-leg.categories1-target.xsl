...
&lt;/legis:body&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK06-LawsActsBillsMeasures\UK06_LawsActsBillsMeasures-leg.categories1-target.dita  -->
	<xsl:message>UK06_LawsActsBillsMeasures-leg.categories1-target.xsl requires manual development!</xsl:message> 
