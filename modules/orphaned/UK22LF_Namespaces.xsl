...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK22LF_Namespaces">
  <title>Namespaces <lnpid>id-UK22LF-36014</lnpid></title>
  <body>
    <ul>
  ...
  <!-- JL added the following because they were necessary for footnote module:
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK22LF\Namespaces.dita  -->
