...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/"
    id="CA15JournalArticles_namespaces">
    <title>Namespaces <lnpid>id-CA15-35408</lnpid></title>
    <body>
      <ul>
  ...
  <!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA15-Journal_Articles\CA15JournalArticles_namespaces.dita  -->
  <!--<xsl:message>CA15JournalArticles_namespaces.xsl requires manual development!</xsl:message> -->
