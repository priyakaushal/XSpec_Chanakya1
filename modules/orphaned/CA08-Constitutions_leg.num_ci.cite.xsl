...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:ci="http://www.lexis-nexis.com/glp/ci" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita leg">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="leg.num_ci.cite">
    <title>leg:num/ci:cite <lnpid>id-CA08-14225</lnpid></title>
    <body>
        <section>
            <ul>
                <li><sourcexml>leg:num/ci:cite[@type="cite4thisdoc"]</sourcexml> becomes
                        ...
                        <targetxml>@citetype="reporter"</targetxml> and create child ele    ment
...
&lt;/ref:citations&gt;
                    ...
                    <note>When text appears inside <sourcexml>leg:num</sourcexml>, then conversion
                        need to move the pinpoint information into
                            <targetxml>lnci:content</targetxml>. This applies to CANADA ONLY.</note>
                    <pre>
        ...
        &lt;ci:stat&gt;
            &lt;ci:statinfo spanref="stcspan1"&gt;
                &lt;ci:hier&gt;
                    &lt;ci:hierlev label="year" num="1985"&gt;
                        &lt;ci:hierlev label="appendix" num="II"&gt;
                            &lt;ci:hierlev label="chapter" num="5" /&gt;
                        &lt;/ci:hierlev&gt;
                    &lt;/ci:hierlev&gt;
                &lt;/ci:hier&gt;
            &lt;/ci:statinfo&gt;
            ...
            &lt;/ci:statref&gt;
        &lt;/ci:stat&gt;
        &lt;ci:content&gt;&lt;ci:span spanid="stcspan1"&gt;R.S.C. 1985, Appendix II, No. 5&lt;/ci:span&gt;&lt;/ci:content&gt;
    &lt;/ci:cite&gt;, Long Title
&lt;/leg:num&gt;
...
&lt;ref:citations&gt;
    &lt;ref:cite4thisresource citetype="reporter"&gt;
        &lt;lnci:cite&gt;
            &lt;lnci:stat&gt;
               &lt;lnci:statinfo&gt;
                &lt;lnci:hier&gt;
                    &lt;lnci:hierlev label="year" num="1985"&gt;
                        &lt;lnci:hierlev label="appendix" num="II"&gt;
                            &lt;lnci:hierlev label="chapter" num="5" /&gt;
                        &lt;/lnci:hierlev&gt;
                    &lt;/lnci:hierlev&gt;
                &lt;/lnci:hier&gt;
            &lt;/lnci:statinfo&gt;
            ...
            &lt;/lnci:statref&gt;
            &lt;/lnci:stat&gt;
                &lt;lnci:content&gt;R.S.C. 1985, Appendix II, No. 5, Long Title&lt;/lnci:content&gt;
            &lt;/lnci:cite&gt;
    &lt;/ref:cite4thisresource&gt;
&lt;/ref:citations&gt;
      ...
      <table>
        ...
        <section>
            <title>Changes</title>
            <p>2016-07-07 : <ph id="change_20160707_AS"> Updated the instruction for the given DPSI  
            ...
            <p>2014-04-30: <ph id="change_20140430_SS">Update the instruction for adding the attribute
                <targetxml>@citetype</targetxml> with "<b>reporter</b>" value inside the
                <targetxml>ref:cite4thisresource</targetxml> in target conversion when input
                is having <sourcexml>leg:num/ci:cite@type="cite4thisdoc"</sourcexml>. Webteam #
                255931 . </ph></p>
        </section>
    </body>
	</dita:topic>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA08-Constitutions\leg.num_ci.cite.dita  -->
<!--	<xsl:message>CA08-Constitutions_leg.num_ci.cite.xsl requires manual development!</xsl:message> 
-->
