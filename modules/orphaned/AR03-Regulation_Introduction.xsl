...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:doc="http://www.lexisnexis.com/xmlschemas/content/shared/document-level-metadata/1/" xmlns:regulation="urn:x-lexisnexis:content:regulation:sharedservices:1" version="2.0" exclude-result-prefixes="dita">
  ...
  <title>Introduction <lnpid>id-AR03-34808</lnpid></title>
  ...
  <body>
    ...
    <p>Argentina regulations samples are identified using the root element <sourcexml>LEGDOC</sourcexml>
...
&lt;regulation:regulation xml:lang="es-AR"&gt;
  ...
&lt;/regulation:regulation&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR03-Regulation\Introduction.dita  -->
	<xsl:message>AR03-Regulation_Introduction.xsl requires manual development!</xsl:message> 
