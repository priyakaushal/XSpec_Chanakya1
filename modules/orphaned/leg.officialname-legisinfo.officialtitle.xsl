...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:jurisinfo="http://www.lexisnexis.com/xmlschemas/content/legal/jurisdiction-info/1/" version="2.0" exclude-result-prefixes="dita leg">
    ...
    <title>leg:juris <lnpid>id-CN01-15221</lnpid></title>
  <body>
       <p>       
         <ul>
                <li>When <sourcexml>leg:juris</sourcexml> has Country code: <note>If value for
                                <sourcexml>leg:juris</sourcexml> is "CH" then
                            ...
                            attributes @codescheme="ISO-3166-1" and @countrycode="CN". </note>
                        <pre>
 ...
 <section>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\CN01-Legislation\leg.officialname-legisinfo.officialtitle.dita  -->
	<xsl:message>leg.officialname-legisinfo.officialtitle.xsl requires manual development!</xsl:message> 
