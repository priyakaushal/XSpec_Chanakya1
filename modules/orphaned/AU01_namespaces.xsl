...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="AU01_namespaces">
  <title>Namespaces <lnpid>id-AU01-18208</lnpid></title>
  <body>
    <ul>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU01_CaseLaw\AU01_namespaces.dita  -->
  <xsl:variable name="lexisAdvNamespaces" as=" element() ">
    <lexisAdvNamespaces>
      ...
      <lexisAdvNamespace>xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xml:lang="en-AU" seclawtype="cases"/></lexisAdvNamespace>
    </lexisAdvNamespaces>
  </xsl:variable>
