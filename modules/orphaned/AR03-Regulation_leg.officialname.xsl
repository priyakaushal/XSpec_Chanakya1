...
&lt;/legis:body&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR03-Regulation\leg.officialname.dita  -->
	<xsl:message>AR03-Regulation_leg.officialname.xsl requires manual development!</xsl:message> 
