...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:cttr="urn:x-lexisnexis:content:citator:sharedservices:1" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita case ci cttr docinfo">
  ...
  <title>cttr:annotations @annotationtype="subseqarticles"/cttr:annot <lnpid>id-AU20-22235</lnpid></title>
  <body>
    <section>
      <ul>
        <li class="- topic/li ">
...
&lt;/cttr:citingpub&gt;&lt;/cttr:refitem&gt;                
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU20_Legislative_Citator\subseqarticles_cttr.annot.dita  -->
	<xsl:message>AU20_Legislative_Citator_subseqarticles_cttr.annot.xsl requires manual development!</xsl:message> 
	...
	<xsl:template match="ci:publicationname @normpubcode=&#34;CPNN&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->

		<!--  Original Target XPath:  lnci:publicationname@normpubcode="CPNN"   -->
	...
	<xsl:template match="ci:volume @num=&#34;1&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="ci:page @num=&#34;85&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->

		<!--  Original Target XPath:  lnci:page@num="85"   -->
		<lnci:page>
			<xsl:apply-templates select="@* | node()"/>
		</lnci:page>
	...
	<xsl:template match="case:citetext/ci:cite @searchtype=&#34;BOOK-REF&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
