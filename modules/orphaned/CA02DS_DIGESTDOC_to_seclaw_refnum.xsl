...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:caseinfo="http://www.lexisnexis.com/xmlschemas/content/legal/case-information/1/" version="2.0" exclude-result-prefixes="dita">
   ...
   <title>refnum <lnpid>id-CA02DS-12839</lnpid></title>
   <body>
      <section>
...
&lt;/jurisinfo:courtinfo&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-CAN\CA02-Case_Summaries\CA02DS_DIGESTDOC_to_seclaw\refnum.dita  -->
	<xsl:message>CA02DS_DIGESTDOC_to_seclaw_refnum.xsl requires manual development!</xsl:message> 
