...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:leg="http://www.lexis-nexis.com/glp/leg" xmlns:legis="http://www.lexisnexis.com/xmlschemas/content/legal/legislation/1/" version="2.0" exclude-result-prefixes="dita leg">
    ...
    <title>leg:miscdate <lnpid>id-AR02-35018</lnpid></title>
    <body>
        <section>
...
&lt;leg:dates&gt;
    &lt;leg:miscdate display-name="Buenos Aires"&gt;
        &lt;date year="1983" month="08" day="18"&gt; 18 de Agosto de 1983&lt;/date&gt;
    &lt;/leg:miscdate&gt;
&lt;/leg:dates&gt;
...
&lt;primlawinfo:dates&gt;
    &lt;miscdate datetype="miscdate" year="1983" month="08" day="18"&gt;
        &lt;date-text&gt;Buenos Aires 18 de Agosto de 1983&lt;/date-text&gt;
    &lt;/miscdate&gt;
&lt;/primlawinfo:dates&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-GPL\AR02-Statcode\leg.miscdate.dita  -->
	<xsl:message>AR02-Statcode_leg.miscdate.xsl requires manual development!</xsl:message> 
