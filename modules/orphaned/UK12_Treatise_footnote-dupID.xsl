...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita">
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="UK12_Treatise_footnote-dupID">
  <title>footnote duplicate IDs <lnpid>id-UK12-29812</lnpid></title>
  <body>
...
&lt;/footnotegroup&gt;
    ...
    <section>
      <title>Changes</title>
      <p>2013-07-12: <ph id="change_20130712_jm">Correction for target sample: removed
            <sourcexml>@type="editorial"</sourcexml> from <sourcexml>footnote</sourcexml>.</ph>.</p>
    </section>
  </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK12-Treatise\UK12_Treatise_footnote-dupID.dita  -->
	<xsl:message>UK12_Treatise_footnote-dupID.xsl requires manual development!</xsl:message> 
