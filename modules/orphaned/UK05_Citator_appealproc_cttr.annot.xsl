...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:cttr="urn:x-lexisnexis:content:citator:sharedservices:1" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita case ci cttr docinfo">
  ...
  <title>cttr:annotations @annotationtype="appealproc"/cttr:annot <lnpid>id-UK05-27807</lnpid></title>
  <body>
   <p>
     <ul>
       <li>
          <sourcexml>cttr:annotations @annotationtype="appealproc"/cttr:annot</sourcexml> becomes
            <targetxml>cttr:refsection @reftype="appeal-proceedings"/cttr:refitem</targetxml>.
            <note>The value of the attribute
              <sourcexml>cttr:annotations/@annotationtype="appealproc"</sourcexml> maps to the
            attribute <targetxml>cttr:refsection/@reftype="appeal-proceedings"</targetxml>.</note>
          <p><sourcexml>cttr:annot/@signal</sourcexml> becomes
              <targetxml>cttr:refitem/cttr:appealproceeding/@treatment</targetxml>. 
          
            <note>If there is no
              value for <sourcexml>cttr:annot/@signal</sourcexml>, a value for
              <targetxml>cttr:appealproceeding/@treatment</targetxml> can be determined from the name of
          ...
          <ul>
            <li>
              <sourcexml>cttr:annotations/cttr:annot/case:info</sourcexml> becomes
                <targetxml>cttr:refsection/cttr:refitem/cttr:appealproceeding/cttr:caseinfo</targetxml>. <ul>
                <li>
                  <sourcexml>cttr:annot/case:info/case:casename</sourcexml> becomes
                    <targetxml>cttr:refitem/cttr:appealproceeding/cttr:caseinfo/caseinfo:casename/caseinfo:fullcasename</targetxml>.
...
&lt;/cttr:citations&gt;
                ...
                <li>
                  <sourcexml>cttr:use-group</sourcexml> becomes
                    <targetxml>cttr:appealproceeding/cttr:usagegroup</targetxml> and the child
                  element is described below: <ul>
                    <li>
                      ...
                      and the attributes : <sourcexml>cttr:use/@signal</sourcexml> becomes
                        <targetxml>cttr:usage @usagetype</targetxml>. <pre>
&lt;cttr:annotations annotationtype="appealproc"&gt;
  &lt;cttr:annot signal="negative"&gt;
    &lt;cttr:use-group&gt;
...
&lt;/cttr:refs&gt;
                    ...
                    <li>
                      ...
                      element <targetxml>ref:content</targetxml> and with the attributes
                        <targetxml>ref:crossreference/@crossreferencetype="citatorAlert"</targetxml>
                      and
                        <targetxml>ref:crossreference/@referencedresourcetype="citator"</targetxml>.
                          <p><targetxml>ref:crossreference/@referencedresourcesentiment</targetxml>
                        is determined based on the value of the parent
                        ...
                        <li> Create
                          ...
                          with attributes and children as follows: <ul>
                            <li> If <sourcexml>@remotekey1="DOC-ID"</sourcexml> then <ul>
                                ...
                                <li>
                                  ...
                                  with <sourcexml>@refpt</sourcexml> or
                                    <sourcexml>@remotekey2</sourcexml>, which ever is present (if
                                  both are present, use <sourcexml>@remotekey2</sourcexml>). </li>
                              </ul>
                            </li>
                            <li> If <sourcexml>@remotekey1="REFPTID"</sourcexml> then <ul>
                                ...
                                <li> Create <targetxml>ref:locator/@anchoridref</targetxml> with
                                  value from <sourcexml>@refpt</sourcexml> or
                                    <sourcexml>@remotekey2</sourcexml>, which ever is present (if
                                  both are present, use <sourcexml>@refpt</sourcexml>). </li>
                              </ul>
                            </li>
                          </ul>
                          ...
                          <note><targetxml>ref:locator/@anchoridref</targetxml> that begins with a
                            ...
                            identifier data type formatting as used for
                          ...
                          <note>Please refer to general markup section for more details on
                              ...
                              <sourcexml>inlineobject</sourcexml> conversion instructions.</note>
                        </li>
                      </ul>
                      <pre>
&lt;cttr:annotations annotationtype="appealproc"&gt;                
  &lt;cttr:annot signal="negative"&gt;
    &lt;remotelink dpsi="03W6" remotekey1="REFPTID" service="DOC-ID" refpt="105560"&gt;
      &lt;inlineobject filename="3.gif" type="image" attachment="web-server"/&gt;
    &lt;/remotelink&gt;
  &lt;/cttr:annot&gt;
&lt;/cttr:annotations&gt;
...
&lt;/cttr:refs&gt;
    ...
    <section>
      ...
      <p>2014-01-13: <ph id="change_20140113_brt">Added note to convert
        ...
        <targetxml>cttr:refitem/cttr:appealproceeding/@treatment</targetxml> when <sourcexml>cttr:annot/@signal</sourcexml> is not present.</ph></p>
      ...
      <p>2013-10-22: <ph id="change_20131022_brt">Added instructions to convert
        ...
        <targetxml>cttr:refitem/cttr:appealproceeding/@treatment</targetxml>.</ph></p>
    </section>
  </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-UK\UK05_Citator\appealproc_cttr.annot.dita  -->
	<xsl:message>UK05_Citator_appealproc_cttr.annot.xsl requires manual development!</xsl:message> 
	...
	<xsl:template match="cttr:annotations/@annotationtype=&#34;appealproc&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->

		<!--  Original Target XPath:  cttr:refsection/@reftype="appeal-proceedings"   -->
		<cttr:refsection>
			<xsl:attribute name="reftype">
				<xsl:text>appeal-proceedings</xsl:text>
			</xsl:attribute>
		</cttr:refsection>
	...
	<xsl:template match="cttr:annotations/cttr:annot/case:info"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:refsection/cttr:refitem/cttr:appealproceeding/cttr:caseinfo   -->
		<cttr:refsection>
			<cttr:refitem>
				<cttr:appealproceeding>
					<cttr:caseinfo>
	...
	<xsl:template match="cttr:annot/case:info/case:casename"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:refitem/cttr:appealproceeding/cttr:caseinfo/caseinfo:casename/caseinfo:fullcasename   -->
		<cttr:refitem>
			<cttr:appealproceeding>
				<cttr:caseinfo>
