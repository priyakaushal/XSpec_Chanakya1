...
xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:legis="http://www.lexisnexis.com/xmlschemas/content/legal/legislation/1/" version="2.0" exclude-result-prefixes="dita docinfo ci leg">
...
&lt;/legis:head&gt;
  ...
  <xsl:template match="docinfo:normcite" mode="enactorprov">
    ...
    <xsl:choose>
      <xsl:when test="parent::docinfo/following-sibling::leg:body/leg:info">
