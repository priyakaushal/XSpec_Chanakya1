    ...
    <body>
        <section>
            ...
            <p>Identifies the normalization scheme (e.g. URI, LNI, ISSN, et al.) used for the
                ...
                Capture dpsi value from the LBU manifest file and prepend the value, followed by
...
&lt;dc:source lnmeta:sourcescheme="DataProductSourceIdentifier"&gt;0GNE&lt;/dc:identifier&gt;
    ...
    <!-- **********************************
        ...
        ******So in short use modules\docinfo\Rosetta_docinfo.doc-id-LxAdv-dcidentifier_lnmetaidentifier-scheme.xsl
        it is the exact same is was in here ********
