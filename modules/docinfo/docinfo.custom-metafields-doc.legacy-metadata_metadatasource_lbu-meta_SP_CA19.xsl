...
&lt;/doc:legacy-metadata&gt;
	...
	<xsl:template match="docinfo:custom-metafield[@searchtype]">
		...
		<!--  Original Target XPath:  doc:legacy-metadata[@metadatasource="lbu-meta"]/meta   -->
		<xsl:element name="metaitem" xmlns="http://www.lexisnexis.com/xmlschemas/content/shared/base/1/">
