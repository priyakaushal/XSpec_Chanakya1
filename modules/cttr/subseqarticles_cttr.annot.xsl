...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:cttr="urn:x-lexisnexis:content:citator:sharedservices:1" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita case ci cttr docinfo">
  ...
  <title>cttr:annotations @annotationtype="subseqarticles"/cttr:annot <lnpid>id-MY10-18020</lnpid></title>
  <body>
    <section>
      <ul>
        <li class="- topic/li ">
          <p><sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:annotations
              @annotationtype="subseqarticles"/cttr:annot</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refsection
              @reftype="citing-publications"/cttr:refitem</targetxml>
          </p>
        </li>
        <li class="- topic/li ">
          <p>The attributes of cttr:annot : <sourcexml class="+ topic/keyword xml-d/sourcexml ">@id</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingpub/@xml:id</targetxml> and <sourcexml class="+ topic/keyword xml-d/sourcexml ">@signal</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingpub/@treatment</targetxml>.</p>
        </li>
        <li class="- topic/li ">
          <p>Create attribute <targetxml>cttr:citingpub/@pubtype</targetxml> with value
            'journal-article'.</p>
...
&lt;/cttr:refsection&gt;                
            ...
            <note class="- topic/note ">All xml:id that begin with a number must have an underscore
              added at start, as shown in the above NL example.</note> The children of cttr:annot
            are described below: <ul class="- topic/ul " id="ul_ldc_ekr_vl">
              <li class="- topic/li ">
              ...
              <li class="- topic/li ">
                <ul class="- topic/ul " id="ul_gfc_ekr_vl">
                  <li class="- topic/li "> The content of <sourcexml class="+ topic/keyword xml-d/sourcexml ">case:citations/case:citetext/ci:cite/ci:content/citefragment</sourcexml> is
                    maintained in <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingpub/cttr:citations/lnci:cite/lnci:content</targetxml>. </li>
                  <li class="- topic/li ">
                    <sourcexml class="+ topic/keyword xml-d/sourcexml ">case:citations/case:citetext/ci:cite/ci:lawrev</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingpub/cttr:citations/lnci:cite/lnci:lawrev</targetxml>.
                      <ul class="- topic/ul " id="ul_pfc_ekr_vl">
                      <li class="- topic/li ">
                        <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:cite/ci:lawrev/ci:lawrevref</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:cite/lnci:lawrev/lnci:lawrevref</targetxml>. <ul class="- topic/ul " id="ul_xfc_ekr_vl">
                          <li class="- topic/li ">
                            <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:cite/ci:lawrev/ci:lawrevref/ci:lawrevlocator</sourcexml> becomes
                              ...
                              <ul class="- topic/ul " id="ul_egc_ekr_vl">
                              <li class="- topic/li ">
                                <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:publicationname @normpubcode</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:publicationname
                                  @normpubcode</targetxml>. </li>
                              <li class="- topic/li ">
                                <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:volume
                                  @num="1"</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:volume
                                  @num="1"</targetxml>. </li>
                              <li class="- topic/li ">
...
&lt;cttr:citations&gt;&lt;lnci:cite type="journal-article"&gt;&lt;lnci:content&gt;(2005) 21(3) TPLB 37&lt;/lnci:content&gt;
  &lt;/lnci:cite&gt;&lt;/cttr:citations&gt;
                ...
                <sourcexml class="+ topic/keyword xml-d/sourcexml ">case:citetext/ci:cite
                  @searchtype="BOOK-REF"</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:citingpub/cttr:citations/lnci:cite
                  @type="journal-article"</targetxml>
                <note class="- topic/note "> In some scenarios, the attribute <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:cite @type</targetxml> should be
                  set to “book” instead of “journal-article” whenever the text "ISBN" is in the
                  content of the remotelink element. Please note that the tags <sourcexml class="+ topic/keyword xml-d/sourcexml ">citefragment</sourcexml> and <sourcexml class="+ topic/keyword xml-d/sourcexml ">remotelink</sourcexml> are omitted but
                  the content is maintained in <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:content</targetxml>. An example is shown below: </note>
                <pre xml:space="preserve" class="- topic/pre ">
...
&lt;/cttr:citations&gt;
              ...
              <li class="- topic/li ">
                <sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:use-group</sourcexml>, the
                child element <sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:use</sourcexml> and the attribute <sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:use @signal</sourcexml> are
                suppressed (both tag and content). <note class="- topic/note ">Please note that
                  cttr:use-group, the child element cttr:use and the attribute cttr:use @signal are
                  intentionally suppressed only for cttr:annotations
              ...
              <li class="- topic/li ">
                ...
                element <targetxml>ref:content</targetxml> and with the attribute
                  <targetxml>ref:crossreference @crossreferencetype="citatorAlert"</targetxml>. <ul id="ul_kgc_ekr_vl">
                  <li>
                    <p> Create <targetxml>ref:crossreference/ref:locator/ref:locator-key</targetxml>
                      with attributes and children as follows: <ul id="ul_mhc_ekr_vl">
                        <li>If <sourcexml>@remotekey1="DOC-ID"</sourcexml> then <ul id="ul_whc_ekr_vl">
                            <li>
                        ...
                        <li>If <sourcexml>@remotekey1="REFPTID"</sourcexml> then <ul id="ul_cic_ekr_vl">
                            <li>
                              <targetxml>ref:key-name/@name</targetxml> will have the value
                              "DOC-ID".</li>
...
&lt;/cttr:citingpub&gt;&lt;/cttr:refitem&gt;                
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY10_Citator\subseqarticles_cttr.annot.dita  -->
	<xsl:message>subseqarticles_cttr.annot.xsl requires manual development!</xsl:message> 

	<xsl:template match="cttr:annotations&#xA;              @annotationtype=&#34;subseqarticles&#34;/cttr:annot"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="ci:volume&#xA;                                  @num=&#34;1&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->

		<!--  Original Target XPath:  lnci:volume@num="1"   -->
		<lnci:volume>
			<xsl:apply-templates select="@* | node()"/>
		</lnci:volume>
	...
	<xsl:template match="case:citetext/ci:cite&#xA;                  @searchtype=&#34;BOOK-REF&#34;"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->

		<!--  Original Target XPath:  cttr:citingpub/cttr:citations/lnci:cite@type="journal-article"   -->
		<cttr:citingpub>
			<cttr:citations>
				<lnci:cite>
					<xsl:apply-templates select="@* | node()"/>
