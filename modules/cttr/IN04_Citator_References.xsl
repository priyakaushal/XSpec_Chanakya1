...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" version="2.0" exclude-result-prefixes="dita cttr">
  ...
  <title>References <lnpid>id-IN04-38817</lnpid></title>
  <body>
    <p>
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-IN\IN04-Citator\IN04_Citator_References.dita  -->
	<xsl:message>IN04_Citator_References.xsl requires manual development!</xsl:message> 
