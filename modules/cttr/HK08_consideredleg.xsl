...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	version="2.0" exclude-result-prefixes="dita case ci source_cttr docinfo source_lnci">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="consideredleg">
  <title>cttr:annotations @annotationtype="consideredleg" <lnpid>id-HK08-37617</lnpid></title>
  <body>
    <section>
      <ul>
        <li class="- topic/li ">
...
&lt;/cttr:refitem&gt;
	...
	<xsl:template match="ci:cite[ancestor::case:references]/@searchtype[. = 'LEG-REF']" priority="25">
