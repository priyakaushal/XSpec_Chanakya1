...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:case="http://www.lexis-nexis.com/glp/case" xmlns:ci="http://www.lexis-nexis.com/ci" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr" xmlns:docinfo="http://www.lexis-nexis.com/glp/docinfo" xmlns:cttr="urn:x-lexisnexis:content:citator:sharedservices:1" xmlns:lnci="http://www.lexisnexis.com/xmlschemas/content/shared/citations/1/" xmlns:ref="http://www.lexisnexis.com/xmlschemas/content/shared/reference/1/" version="2.0" exclude-result-prefixes="dita case ci cttr docinfo">
  ...
  <title>cttr:annotations @annotationtype="subseqcases"/cttr:annot <lnpid>id-MY10-18021</lnpid></title>
  <body>
    <section>
          <ul class="- topic/ul ">
            <li class="- topic/li ">
        ...
        <li class="- topic/li ">The attributes of cttr:annot : <sourcexml class="+ topic/keyword xml-d/sourcexml ">@id</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingcase/@xml:id</targetxml> and <sourcexml class="+ topic/keyword xml-d/sourcexml ">@signal</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:refitem/cttr:citingcase/@treatment</targetxml> and the child elements are
...
&lt;/cttr:refsection&gt;                
          ...
          <note class="- topic/note ">All xml:id that begin with a number must have an underscore
            added at start, as shown in the above NL example.</note>
          <ul class="- topic/ul " id="ul_whq_ajr_vl">
            <li class="- topic/li ">
              ...
              <ul class="- topic/ul " id="ul_nkq_ajr_vl">
                <li class="- topic/li ">
...
&lt;/cttr:refsection&gt;                
            ...
            <li class="- topic/li "> The tag <sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:annotations[@annotationtype="subseqcases"]/cttr:annot/case:citations</sourcexml>
              becomes
                <targetxml>cttr:refs/cttr:refsection/cttr:refitem/cttr:citingcase/cttr:caseinfo/cttr:citations</targetxml><ul class="- topic/ul " id="ul_ykq_ajr_vl">
                <li class="- topic/li "> The tag <sourcexml class="+ topic/keyword xml-d/sourcexml ">case:citetext</sourcexml> is omitted but the content is maintained as described
                  below: <ul class="- topic/ul " id="ul_zlq_ajr_vl">
                    <li class="- topic/li ">
                      <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:cite</sourcexml>
                      becomes <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:caseinfo/cttr:citations/lnci:cite</targetxml>. <ul class="- topic/ul " id="ul_ymq_ajr_vl">
                        <li class="- topic/li ">
                          <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:case</sourcexml>
                          becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:case</targetxml>. <ul class="- topic/ul " id="ul_xnq_ajr_vl">
                            <li class="- topic/li ">
                              <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:caseref</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:caseref</targetxml>.
                              The attributes <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:caseref @ID</sourcexml>  and <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:caseref
                                @spanref</sourcexml> should be dropped. The children are described
                              below : <ul class="- topic/ul " id="ul_goq_ajr_vl">
                                <li class="- topic/li ">
                                  <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:reporter
                                    @value</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:reporter
                                    @value</targetxml>. </li>
                                <li class="- topic/li ">
                                  <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:edition</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:edition</targetxml>. <ul class="- topic/ul " id="ul_ooq_ajr_vl">
                                    <li class="- topic/li "> The child element <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:edition/ci:date
                                        @year</sourcexml> becomes <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:edition/lnci:date @year</targetxml>. </li>
                                  </ul>
                                </li>
                                <li class="- topic/li ">
...
&lt;/cttr:caseinfo&gt;                
                        ...
                        <li class="- topic/li ">
                          <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:content</sourcexml>
                          becomes <targetxml class="+ topic/keyword xml-d/targetxml ">/cttr:caseinfo/cttr:citations/lnci:cite/lnci:content</targetxml> and
                          the child element is described below : <ul class="- topic/ul " id="ul_soq_ajr_vl">
                            <li class="- topic/li "> The tags <sourcexml class="+ topic/keyword xml-d/sourcexml ">citefragment</sourcexml>,
                              the attribute <sourcexml class="+ topic/keyword xml-d/sourcexml ">citefragment @searchtype</sourcexml> and its child element
                                <sourcexml class="+ topic/keyword xml-d/sourcexml ">ci:span</sourcexml> are omitted but the content is maintained in
                                <targetxml class="+ topic/keyword xml-d/targetxml ">lnci:content</targetxml>
                            </li>
                          </ul>
                          <pre xml:space="preserve" class="- topic/pre ">
&lt;ci:content&gt;
...
&lt;lnci:content&gt;[2009] FCAFC 166; BC200910812&lt;/lnci:content&gt;
            ...
            <li class="- topic/li ">
              <sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:use-group</sourcexml> becomes
                <targetxml class="+ topic/keyword xml-d/targetxml ">cttr:citingcase/cttr:usagegroup</targetxml> and the child element is described
              below: <ul class="- topic/ul " id="ul_xoq_ajr_vl">
                <li class="- topic/li ">
...
&lt;/cttr:usagegroup&gt;
              ...
              <note> Attributes <targetxml>@negativesortweight</targetxml> and
                ...
                date. Please refer to <xref href="../../common_newest/LxAdv-cttr.usagegroup_AddingSortWeightInformation.dita"/>. </note>
            </li>
            <li class="- topic/li ">
              <sourcexml>remotelink /@service="DOC-ID"</sourcexml> becomes
                ...
                <targetxml>ref:crossreference @crossreferencetype="citatorAlert"</targetxml>. <ul id="ul_cpq_ajr_vl">
                <li>
                  <p> Create <targetxml>ref:crossreference/ref:locator/ref:locator-key</targetxml>
                    with attributes and children as follows: <ul id="ul_dqq_ajr_vl">
                      <li>If <sourcexml>@remotekey1="DOC-ID"</sourcexml> then <ul id="ul_nqq_ajr_vl">
                          <li>
                      ...
                      <li>If <sourcexml>@remotekey1="REFPTID"</sourcexml> then <ul id="ul_tqq_ajr_vl">
                          <li>
                            <targetxml>ref:key-name/@name</targetxml> will have the value
                            "DOC-ID".</li>
...
&lt;/cttr:refitem&gt;                
    ...
    <section>
      <title>Changes</title>
      <p>2014-01-09: <ph id="change_20140109_brt">Modified instruction to drop
            <sourcexml>ci:caseref/@ID</sourcexml>, and removed
            <targetxml>lnci:caseref/@ID</targetxml> from target example.</ph></p>
      <p>2013-10-16: <ph id="change_20131016_brt">Deleted first instruction on how to convert
            <sourcexml>cttr:annotations</sourcexml>. (Covered by new topic).</ph></p>
       </section>
  </body>
	</dita:topic>

	<!--  @@@ This file has been autogenerated.  Remove this comment after manual development complete! @@@  -->
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-MY\MY10_Citator\subseqcases_cttr.annot.dita  -->
	<xsl:message>subseqcases_cttr.annot.xsl requires manual development!</xsl:message> 

	<xsl:template match="cttr:annotations&#xA;            @annotationtype=&#34;subseqcases&#34;/cttr:annot"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="case:courtinfo"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
		...
		<!--  Original Target XPath:  cttr:refs/cttr:refsection/cttr:refitem/cttr:citingcase/cttr:caseinfo/cttr:citations   -->
		<cttr:refs>
			<cttr:refsection>
				<cttr:refitem>
					<cttr:citingcase>
	...
	<xsl:template match="cttr:annotations[@annotationtype=&#34;subseqcases&#34;]/cttr:annot/case:citations"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="ci:reporter&#xA;                                    @value"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
	...
	<xsl:template match="ci:page&#xA;                                    @num"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
