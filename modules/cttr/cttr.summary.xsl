...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:dita="http://dita.oasis-open.org/architecture/2005/" xmlns:source_cttr="http://www.lexis-nexis.com/glp/cttr"
	...
	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="cttr.summary">
		<title>cttr:summary <lnpid>id-AU02-18424</lnpid></title>
		<body>
			<section>
				<ul>
					<li class="- topic/li ">
						<sourcexml class="+ topic/keyword xml-d/sourcexml ">cttr:summary</sourcexml> becomes <targetxml
							class="+ topic/keyword xml-d/targetxml ">cttr:descriptors/cttr:descriptorsection
							@descriptortype="catchwords-and-digest"/casesum:editorialsummary
							@summarysource="lexis-casebase-editorial"</targetxml> and the child element is described below : <ul
							class="- topic/ul ">
							<li class="- topic/li ">
								<sourcexml class="+ topic/keyword xml-d/sourcexml ">p</sourcexml> becomes <targetxml
									class="+ topic/keyword xml-d/targetxml ">p</targetxml> and the child element is described below : <ul
									class="- topic/ul ">
									<li class="- topic/li ">
										<sourcexml class="+ topic/keyword xml-d/sourcexml ">text</sourcexml> becomes <targetxml
											class="+ topic/keyword xml-d/targetxml ">text</targetxml>
									</li>
								</ul>
							</li>
						</ul>
...
&lt;casesum:editorialsummary summarysource="lexis-casebase-editorial"&gt;
  ...
  &lt;/p&gt;
	...
	<!--    Original DITA file location:  DITA\ConversionInstructions\Rosetta\DITA-PAC\AU02_citator\cttr.summary.dita  -->
