...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	version="2.0" exclude-result-prefixes="dita case ci xs ln-data docinfo source_cttr">

	<dita:topic xmlns="http://dita.oasis-open.org/architecture/2005/" id="Citator_Body">
  <title>Body <lnpid>id-HK08-37610</lnpid></title>
  <body>
...
&lt;cttr:body&gt;
    &lt;cttr:refs&gt;
        &lt;cttr:refsection reftype="citing-cases"&gt;
            &lt;heading&gt;
                &lt;title&gt;Cases referring to this article&lt;/title&gt;
            &lt;/heading&gt;
        &lt;/cttr:refsection&gt;
    &lt;/cttr:refs&gt;
&lt;/cttr:body&gt;
          ...
          <ul id="ul_shv_ns5_rv">
            <li>
              ...
              <pre>
&lt;cttr:use-group&gt;
  &lt;cttr:use signal="positive"&gt;Followed&lt;/cttr:use&gt;
&lt;/cttr:use-group&gt;
...
&lt;/cttr:caseinfo&gt;                
            ...
            <li class="- topic/li ">
              <sourcexml>remotelink /@service="DOC-ID"</sourcexml> becomes
                ...
                <targetxml>ref:crossreference @crossreferencetype="citatorAlert"</targetxml>. <ul id="ul_pyx_4v5_rv">
                <li>
...
&lt;cttr:refitem&gt;
  &lt;cttr:citingpub&gt;
    &lt;ref:crossreference crossreferencetype="citatorAlert" referencedresourcesentiment="none" referencedresourcetype="citator"&gt;
      ...
      &lt;/ref:locator&gt;
  &lt;/ref:crossreference&gt;
&lt;/cttr:citingpub&gt;&lt;/cttr:refitem&gt;  </pre></p>
                </li>
              </ul></li>
          </ul>
        </li>
	...
	<xsl:template match="source_cttr:body"><!--  TODO:  correct match pattern to prepend "source_" in front of appropriate ns prefixes!!  -->
